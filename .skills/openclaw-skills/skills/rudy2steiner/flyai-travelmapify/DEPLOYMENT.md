# Deployment Checklist for flyai-travelmapify
...
#### **For OpenClaw Users**
1. Place entire `flyai-travelmapify` directory in `~/.openclaw/workspace/skills/`
2. Use via: `python3 ~/.openclaw/workspace/skills/flyai-travelmapify/flyai-travelmapify.py [options]`
...
3. Run from any directory: `python3 /path/to/flyai-travelmapify/flyai-travelmapify.py [options]`
...
### Version Information
- **Skill Version**: 2.1.5 (updated for portability)
