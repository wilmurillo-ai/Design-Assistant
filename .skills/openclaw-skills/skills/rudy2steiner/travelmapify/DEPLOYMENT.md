# Deployment Checklist for travelmapify
...
#### **For OpenClaw Users**
1. Place entire `travelmapify` directory in `~/.openclaw/workspace/skills/`
2. Use via: `python3 ~/.openclaw/workspace/skills/travelmapify/flyai-travelmapify.py [options]`
...
3. Run from any directory: `python3 /path/to/travelmapify/flyai-travelmapify.py [options]`
