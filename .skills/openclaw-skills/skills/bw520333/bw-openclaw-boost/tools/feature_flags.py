...
配置文件：~/.openclaw/bw-openclaw-boost/config/feature-flags.json
"""
...
class FeatureFlagManager:
    ...
    def _set_defaults(self):
        ...
        defaults = [
            ...
            FeatureFlag("stream_exec", True, "流式执行", "core"),
            FeatureFlag("tool_tracking", True, "工具执行追踪", "core"),
            FeatureFlag("permission_manager", True, "权限管理", "core"),
            FeatureFlag("dream_consolidation", True, "自动记忆整理", "experimental"),
