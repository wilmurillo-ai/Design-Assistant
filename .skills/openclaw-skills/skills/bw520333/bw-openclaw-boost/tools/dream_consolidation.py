...
LOGS_DIR = MEMORY_DIR / "logs"  # 日志扫描目录（只读，不删除）
...
class DreamConsolidator:
    ...
    def consolidate_log(self, log: Dict[str, Any]) -> bool:
        ...
        target_dir = MEMORY_DIR / rule.target_type
...
if __name__ == "__main__":
    ...
    if cmd == "run":
        ...
        print(f"正在整理近 {days} 天的日志...")
        results = consolidator.consolidate_all(days, dry_run=False)
