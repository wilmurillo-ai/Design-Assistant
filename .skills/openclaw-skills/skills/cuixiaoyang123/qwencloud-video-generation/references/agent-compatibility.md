# Agent Compatibility — qwencloud-video-generation
...
|-------|-----------------|---------------|
| qwencloud-video-generation | generate video, animation, text-to-video, image-to-video | `{base}/qwencloud-video-generation/SKILL.md` |
