 ...
 * 计算会话的 token 使用统计
 */
function calculateTokenStats(sessionHistory, modelName) {
 ...
 * 生成上下文状态消息
 */
function generateStatusMessage(stats, modelName) {
 ...
 * Skill 主函数
 */
export default async function contextUsageChecker(params) {
