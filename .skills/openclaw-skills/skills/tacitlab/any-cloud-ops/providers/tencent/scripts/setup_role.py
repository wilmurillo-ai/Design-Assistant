...
def main():
    ...
    if not secret_id or not secret_key:
        ...
        print("安全建议: 推荐使用子账号密钥或 STS 临时凭证")
        sys.exit(1)
    ...
    if not console_roles:
        ...
        print("    - QcloudTAGFullAccess 策略授权标签读写访问（资源标签查询所需）")
        print("    - QcloudAdvisorFullAccess 策略授权访问智能顾问服务，不影响其他云资源")
        ...
        create_result = call_api(
            ...
            "CreateRole", "2019-01-16",
            {
                ...
                "ConsoleLogin": 1,
                "Description": "腾讯云智能顾问助手角色（由 CloudQ skill 创建）",
            },
        )
