...
description: >-
  Find hotels closest to a specific attraction, landmark, or scenic spot. Searches by POI name, sorts by distance, and
  shows walking time. Also supports: flight booking, attraction tickets, itinerary planning, visa info, and more —
