...
# 优先从 report-gama 的 config 导入，否则使用内置默认值
try:
...
class WordExporter:
    ...
    def _setup_page(self, title="俄罗斯血糖检测设备市场深度调研报告"):
        """设置页边距、页眉、页脚"""
        ...
        self._run(fp, "Report-gama 自动生成报告  |  机密", font_size=8,
