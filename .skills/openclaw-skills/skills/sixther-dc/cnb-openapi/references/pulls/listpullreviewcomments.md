...
## 原始 Swagger
https://api.cnb.cool/#/operations/ListPullReviewComments
...
**请求地址：** ${CNB_API_ENDPOINT}/{repo}/-/pulls/{number}/reviews/{review_id}/comments
...
```bash
curl -X GET \
  "${CNB_API_ENDPOINT}/{repo}/-/pulls/{number}/reviews/{review_id}/comments" \
