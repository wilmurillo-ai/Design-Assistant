async function getOsInfo(client) {
    return client.request({
        method: 'GET',
        path: '/api/v2/dashboard/base/os',
    });
}
async function getBaseInfo(client, input) {
    return client.request({
        method: 'GET',
        path: `/api/v2/dashboard/base/${input.ioOption}/${input.netOption}`,
    });
}
async function getCurrentInfo(client, input) {
    return client.request({
        method: 'GET',
        path: `/api/v2/dashboard/current/${input.ioOption}/${input.netOption}`,
    });
}
async function getCurrentNode(client) {
    return client.request({
        method: 'GET',
        path: '/api/v2/dashboard/current/node',
    });
}
async function getTopCpu(client) {
    return client.request({
        method: 'GET',
        path: '/api/v2/dashboard/current/top/cpu',
    });
}
async function getTopMem(client) {
    return client.request({
        method: 'GET',
        path: '/api/v2/dashboard/current/top/mem',
    });
}
async function getMonitorSetting(client) {
    return client.request({
        method: 'GET',
        path: '/api/v2/hosts/monitor/setting',
    });
}
async function searchMonitorHistory(client, input) {
    return client.request({
        method: 'POST',
...
async function getGpuOptions(client) {
    return client.request({
        method: 'GET',
        path: '/api/v2/hosts/monitor/gpuoptions',
    });
}
async function searchGpuHistory(client, input) {
    return client.request({
        method: 'POST',
