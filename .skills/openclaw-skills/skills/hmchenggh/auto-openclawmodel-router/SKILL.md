...
> 定位：一個GLM Coding Plan走天涯，適合不想折騰嘅用家

| # | 範疇 | 模型 | 型號 |
|---|------|------|------|
| 1 | 高邏輯推理 | GLM-5 | primary |
| 2 | 代碼生成 | GLM-5 / GLM-4.7 | primary / fallback |
| 3 | 創意寫作 | GLM-5 | primary |
| 4 | 資訊閱讀 | GLM-4-Flash | primary |
| 5 | 簡單重複 | GLM-4-Flash | primary |
| 6 | 圖片理解 | GLM-4.6V | primary |
| 7 | 圖片生成 | CogView4 | primary |
| 8 | 影片/音頻 | GLM-4-Voice | primary |
...
| 版本 | 日期 | 更新內容 |
|------|------|----------|
| 1.1 | 2026-04-07 | 加入Plan C：GLM懶人模式，更新task-rules.json加入GLM關鍵詞和Vibe Coding支援 |
