#!/usr/bin/env bash
# watch — Watch reference tool. Use when working with watch in devtools contexts.
...
show_help() {
    cat << 'HELPEOF'
watch v$VERSION — Watch Reference Tool
...
## What is Watch?
Watch (watch) is a specialized tool/concept in the devtools domain.
It provides essential capabilities for professionals working with watch.

## Key Concepts
- Core watch principles and fundamentals
- How watch fits into the broader devtools ecosystem  
- Essential terminology every practitioner should know

## Why Watch Matters
Understanding watch is critical for:
...
## Getting Started
1. Understand the basic watch concepts
...
## Installation
1. Download or clone the watch package
...
cmd_patterns() {
    cat << 'EOF'
# Watch — Common Patterns & Best Practices

## Design Patterns
1. **Standard Pattern**: The most common approach for watch
