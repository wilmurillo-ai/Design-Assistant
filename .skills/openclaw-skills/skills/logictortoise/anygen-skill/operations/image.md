...
Generate images, illustrations and visual content using AnyGen. Images are generated server-side; this workflow sends the user's prompt and optional reference files to the AnyGen API and retrieves the results online.
