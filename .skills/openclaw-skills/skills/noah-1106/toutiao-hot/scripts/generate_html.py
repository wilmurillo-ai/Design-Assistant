#!/usr/bin/env python3
"""
Toutiao Hot - Generate HTML Report
今日头条热榜HTML可视化报告
"""
...
def generate_html():
    ...
    # 获取所有数据
    cursor.execute('''
        SELECT rank, title, popularity, link, label, cover, fetch_date
        FROM hot_items
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .header {{
            background: linear-gradient(135deg, #ed4040 0%, #c62828 100%);
            color: white;
            padding: 25px 20px;
            position: sticky;
            top: 0;
        ...
        .stats .highlight {{ color: #ed4040; font-weight: 600; }}
