...
| Field | Type | Description |
|-------|------|-------------|
| `IsQuotedInUsd` | Boolean | Whether price is quoted in USD — use to know when OHLC/Averages are in USD |
...
## Example: Multi-token 1-second stream (this skill's default)
...
## Example: Single token (e.g. Ethereum) with 1-minute candles
