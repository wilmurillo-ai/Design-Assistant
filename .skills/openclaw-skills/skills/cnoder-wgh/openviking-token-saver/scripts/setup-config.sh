...
echo "下一步："
echo "  1. 启动 API 服务器:  nohup ${HOME}/.openviking/venv/bin/openviking-server > ${HOME}/.openviking/server.log 2>&1 &"
echo "  2. 启动 Console:    nohup ${HOME}/.openviking/venv/bin/python3 -m openviking.console.bootstrap --host 127.0.0.1 --port 8020 --openviking-url http://127.0.0.1:1933 > ${HOME}/.openviking/console.log 2>&1 &"
echo "  3. 测试连接:        $PYTHON_BIN $SCRIPT_DIR/viking.py info"
echo "  4. 添加资源:        $PYTHON_BIN $SCRIPT_DIR/viking.py add ./your-docs/"
echo "  5. 打开 Web UI:     http://localhost:8020"
echo ""
