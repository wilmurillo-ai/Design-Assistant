#!/bin/bash
# plugin-upgrader/scripts/upgrade-plugin.sh
#
# 通用 OpenClaw 插件升级脚本
#
# 功能：
...
#
# 参数：
#   <npm-pkg-name>           npm 包名，如 my-org/openclaw-qqbot
...
[ -z "$CONFIG_FILE" ] && CONFIG_FILE="$HOME/.openclaw/openclaw.json"
