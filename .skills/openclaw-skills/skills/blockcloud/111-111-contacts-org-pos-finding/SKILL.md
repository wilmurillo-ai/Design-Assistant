---
name: 111-111-contacts-org-pos-finding
description: 111通讯录组织机构及职位人员信息查询。Use when: (1) 用户提到"通过111通讯录查询"或"111通讯录"并需要查找人员信息
**⚠️ 重要提示：此技能通过查询组织机构及其职位的方式来查找人员，不是直接搜索人名。**
使用前必须先：1) 向用户说明查询方式 2) 要求用户按要求提供输入 3) 获得用户确认后才执行。
---
