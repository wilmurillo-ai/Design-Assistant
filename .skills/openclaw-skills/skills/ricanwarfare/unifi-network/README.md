...
Monitor your UniFi network via the local gateway API from OpenClaw.
...
cat > ~/.openclaw/credentials/unifi.json << 'EOF'
{
...
→ Check your config file exists at `~/.openclaw/credentials/unifi.json`
