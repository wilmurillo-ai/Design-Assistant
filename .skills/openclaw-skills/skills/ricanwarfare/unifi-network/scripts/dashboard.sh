...
# Output file for dashboard (optional - set via environment variable)
OUTPUT_FILE="${UNIFI_OUTPUT_FILE:-}"

# If no output file specified, output to stdout only
...
# Ensure output directory exists if output file is set
