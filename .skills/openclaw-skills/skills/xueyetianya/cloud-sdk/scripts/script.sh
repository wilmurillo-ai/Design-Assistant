#!/usr/bin/env bash
# cloud-sdk - Developer workflow automation tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${CLOUD_SDK_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/cloud-sdk}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "cloud-sdk v$VERSION" ;;
