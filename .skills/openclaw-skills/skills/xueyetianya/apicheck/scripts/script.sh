#!/usr/bin/env bash
# apicheck - Developer workflow automation tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${APICHECK_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/apicheck}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "apicheck v$VERSION" ;;
