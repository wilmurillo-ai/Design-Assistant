#!/usr/bin/env bash
# poem — Poem reference tool. Use when working with poem in devtools contexts.
...
show_help() {
    cat << 'HELPEOF'
poem v$VERSION — Poem Reference Tool
...
## What is Poem?
Poem (poem) is a specialized tool/concept in the devtools domain.
It provides essential capabilities for professionals working with poem.

## Key Concepts
- Core poem principles and fundamentals
- How poem fits into the broader devtools ecosystem  
- Essential terminology every practitioner should know

## Why Poem Matters
Understanding poem is critical for:
...
## Getting Started
1. Understand the basic poem concepts
...
## Installation
1. Download or clone the poem package
...
cmd_patterns() {
    cat << 'EOF'
# Poem — Common Patterns & Best Practices

## Design Patterns
1. **Standard Pattern**: The most common approach for poem
