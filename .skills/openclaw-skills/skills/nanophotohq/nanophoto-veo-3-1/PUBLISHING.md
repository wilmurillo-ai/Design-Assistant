...
- Skill purpose: generate Veo 3.1 videos through the NanoPhoto API.
...
- Only submit prompts and image URLs you are authorized to use.
- For image-based generation types, only provide public image URLs you are comfortable sending to the NanoPhoto service.
- Do not provide private or sensitive images as public URLs.
- This skill does not ask for unrelated credentials.
- This skill does not read messaging credentials or send external notifications.
