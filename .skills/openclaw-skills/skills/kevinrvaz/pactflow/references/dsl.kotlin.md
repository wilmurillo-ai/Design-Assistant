While you already know this, here is a reminder of the Pact-JVM classes and methods you will need to use to create a Pact test in Kotlin (having omitted deprecated and unadvised methods). Pact JVM doesn't provide a Kotlin-specific DSL, so you will need to account for this when creating Kotlin tests:
