---
name: free-video-generator-i
version: "1.0.0"
displayName: "Free Video Generator — Create Videos from Text or Images"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a 30-second promotional video from my text and images — and get ready-to-share videos back in 1-2 minutes. Upload MP4, MOV, JPG, PNG files up to 200MB, and the AI handles AI video creation automatically. Ideal for content creators, marketers, students who want to create videos quickly without cameras or editing software.
...
- "generate a 30-second promotional video from my text and images"
- "generating videos from text prompts or images without recording footage for content creators, marketers, students"
...
# Free Video Generator — Create Videos from Text or Images
...
User prompts referencing free video generator i, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-video-generator-i` |
