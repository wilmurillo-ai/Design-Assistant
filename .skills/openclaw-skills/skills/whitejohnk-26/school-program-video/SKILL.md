---
name: school-program-video
version: "1.0.0"
displayName: "School Program Video — Edit and Export School Program Videos"
description: >
  Turn a 3-minute recording of a school science fair presentation into 1080p polished program videos just by typing what you need. Whether it's editing school event and program recordings into shareable videos or quick social content, drop your raw footage and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `school-program-video` |
