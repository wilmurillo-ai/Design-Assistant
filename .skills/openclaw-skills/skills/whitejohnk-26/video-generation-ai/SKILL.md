...
version: "1.0.0"
displayName: "Video Generation AI — Generate Videos from Text or Images"
description: >
  Turn a short text description of a product demo scene into 1080p AI generated videos just by typing what you need. Whether it's generating short videos from text prompts or images or quick social content, drop your text prompts or images and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-generation-ai` |
