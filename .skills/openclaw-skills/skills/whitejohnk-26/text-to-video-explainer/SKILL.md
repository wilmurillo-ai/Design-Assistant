---
name: text-to-video-explainer
version: "1.0.0"
displayName: "Text to Video Explainer — Turn Scripts into Explainer Videos"
description: >
  convert written text script into animated explainer video with this skill. Works with TXT, DOCX, PDF, SRT files up to 10MB. marketers, educators, startup founders use it for converting written scripts into explainer videos with visuals and narration — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
