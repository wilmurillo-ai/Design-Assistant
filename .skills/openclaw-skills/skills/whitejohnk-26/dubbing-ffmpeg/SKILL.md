...
name: dubbing-ffmpeg
version: "1.0.0"
displayName: "Dubbing FFmpeg — Dub and Export Localized Videos"
description: >
  Turn a 3-minute MP4 video in English into 1080p dubbed MP4 videos just by typing what you need. Whether it's replacing original audio with dubbed voice in another language or quick social content, drop your video files and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
