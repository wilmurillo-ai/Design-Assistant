---
name: free-video-generation-api-key
version: "1.0.0"
displayName: "Free Video Generation API Key — Generate Videos via API Free"
description: >
  generate text prompts into AI generated videos with this skill. Works with MP4, MOV, WebM, GIF files up to 500MB. developers and indie hackers use it for generating videos programmatically via API without paying for a key — processing takes 30-90 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-video-generation-api-key` |
