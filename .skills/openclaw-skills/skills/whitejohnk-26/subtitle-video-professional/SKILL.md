...
version: "1.0.0"
displayName: "Subtitle Video Professional — Add Captions and Export Videos"
description: >
  add video files into captioned video files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators, marketers, educators use it for adding professional subtitles to videos for YouTube, social media, or business content — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `subtitle-video-professional` |
