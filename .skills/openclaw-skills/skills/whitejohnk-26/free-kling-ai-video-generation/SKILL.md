---
name: free-kling-ai-video-generation
version: "1.0.0"
displayName: "Free Kling AI Video Generation — Generate AI Videos From Prompts"
description: >
  generate text prompts or images into AI-generated video clips with this skill. Works with JPG, PNG, WEBP, MP4 files up to 20MB. content creators, social media users, indie filmmakers use it for generating short AI video clips from text or image prompts for free — processing takes 1-3 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-kling-ai-video-generation` |
