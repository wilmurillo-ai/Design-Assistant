---
name: text-to-video-deepai
version: "1.0.0"
displayName: "Text to Video DeepAI — Generate Videos from Text Prompts"
description: >
  Turn a two-sentence description of a sunset over a mountain lake into 720p AI generated video just by typing what you need. Whether it's generating short videos from written text descriptions or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
