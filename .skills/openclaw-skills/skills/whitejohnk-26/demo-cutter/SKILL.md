...
name: demo-cutter
version: "1.0.0"
displayName: "Demo Cutter — Trim Demo Videos to Clips"
description: >
  Turn a 10-minute product demo recording into 1080p trimmed demo clips just by typing what you need. Whether it's cutting long product demos down to tight, shareable highlight clips or quick social content, drop your raw demo footage and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
