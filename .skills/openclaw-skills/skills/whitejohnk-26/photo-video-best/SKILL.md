---
name: photo-video-best
version: "1.0.0"
displayName: "Photo Video Best — Turn Photos Into Polished Videos"
description: >
  Turn ten vacation photos in JPG format into 1080p polished photo videos just by typing what you need. Whether it's turning photo collections into shareable videos or quick social content, drop your photos and images and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
# Photo Video Best — Turn Photos Into Polished Videos
...
Tip: fewer than 20 photos process the fastest and keep the video tight.

## Matching Input to Actions

User prompts referencing photo video best, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `photo-video-best` |
