...
name: video-subtitle
version: "1.0.0"
displayName: "Video Subtitle — Generate and Embed Video Captions"
description: >
  Get captioned video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "add subtitles in English and Spanish to my video", and download 1080p MP4 when it's done. Built for YouTubers and content creators who move fast and need accurate captions without manual transcription.
