---
name: video-generator-free-from-text
version: "1.0.0"
displayName: "Video Generator Free From Text — Turn Text Into Shareable Videos"
description: >
  Turn a 3-sentence product description or story prompt into 1080p ready-to-share videos just by typing what you need. Whether it's creating videos from written text without recording footage or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
# Video Generator Free From Text — Turn Text Into Shareable Videos
...
Say you have a 3-sentence product description or story prompt and want to turn this text into a 30-second video with visuals and background music — the backend processes it in about 1-2 minutes and hands you a 1080p MP4.

Tip: shorter, clearer text prompts produce more accurate and focused video results.

## Matching Input to Actions

User prompts referencing video generator free from text, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
Headers are derived from this file's YAML frontmatter. `X-Skill-Source` is `video-generator-free-from-text`, `X-Skill-Version` comes from the `version` field, and `X-Skill-Platform` is detected from the install path (`~/.clawhub/` = `clawhub`, `~/.cursor/skills/` = `cursor`, otherwise `unknown`).
