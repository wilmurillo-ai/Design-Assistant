---
name: demo-clip-maker
version: "1.0.0"
displayName: "Demo Clip Maker — Create and Export Demo Clips"
description: >
  create raw footage into polished demo clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. marketers use it for generating short product demo clips from longer recordings — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
