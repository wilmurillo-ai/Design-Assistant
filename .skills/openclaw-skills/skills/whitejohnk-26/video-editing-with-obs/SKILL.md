---
name: video-editing-with-obs
version: "1.0.0"
displayName: "Video Editing with OBS — Edit and Export OBS Recordings"
description: >
  Skip the learning curve of professional editing software. Describe what you want — cut dead air, add transitions, and export a clean highlight reel — and get edited screen recordings back in 1-2 minutes. Upload MP4, MKV, MOV, AVI files up to 500MB, and the AI handles AI video editing automatically. Ideal for streamers and content creators who want to clean up raw OBS recordings without learning complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-obs` |
