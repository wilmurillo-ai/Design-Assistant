---
name: ai-image-to-video-ltx
version: "1.0.0"
displayName: "AI Image to Video LTX — Animate Images into Video Clips"
description: >
  Get animated video clips ready to post, without touching a single slider. Upload your still images (JPG, PNG, WEBP, BMP, up to 20MB), say something like "animate this image into a 5-second video clip using LTX", and download 1080p MP4 when it's done. Built for content creators, marketers, social media managers who move fast and want to bring still images to life without manual animation skills.
