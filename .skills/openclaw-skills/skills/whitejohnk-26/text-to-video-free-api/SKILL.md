---
name: text-to-video-free-api
version: "1.0.0"
displayName: "Text to Video Free API — Generate Videos from Text"
description: >
  Get ready-to-share videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, JSON, CSV, up to 500MB), say something like "convert this text description into a 30-second video with visuals and music", and download 1080p MP4 when it's done. Built for developers and marketers who move fast and want to automate video creation from text without paid API plans.
