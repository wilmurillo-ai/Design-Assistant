---
name: ai-voiceover-for
version: "1.0.0"
displayName: "AI Voiceover For — Add AI Voice to Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add a natural AI voiceover in English for my product walkthrough video — and get voiced-over videos back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI voiceover generation automatically. Ideal for content creators, marketers, educators who need professional-sounding narration without recording their own voice.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-voiceover-for` |
