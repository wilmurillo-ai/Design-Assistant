...
version: "1.0.0"
displayName: "Shorts Repurposer — Convert Long Videos Into Shorts"
description: >
  Get vertical short clips ready to post, without touching a single slider. Upload your long-form videos (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut this into 3 vertical shorts under 60 seconds each with captions", and download 1080p MP4 when it's done. Built for content creators and YouTubers who move fast and want to repurpose existing long content into short clips without manual editing.
