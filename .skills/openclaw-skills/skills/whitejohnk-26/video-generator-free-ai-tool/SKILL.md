...
version: "1.0.0"
displayName: "Video Generator Free AI Tool — Generate Videos from Text Free"
description: >
  generate text or images into ready-to-share videos with this skill. Works with MP4, MOV, JPG, PNG files up to 200MB. content creators and marketers use it for generating videos from text prompts or images without editing skills — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
# Video Generator Free AI Tool — Generate Videos from Text Free
...
One thing worth knowing — shorter text prompts with clear instructions produce more accurate results.

## Matching Input to Actions

User prompts referencing video generator free ai tool, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-generator-free-ai-tool` |
