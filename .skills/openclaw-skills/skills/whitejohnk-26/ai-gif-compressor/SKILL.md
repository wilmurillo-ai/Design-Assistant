---
name: ai-gif-compressor
version: "1.0.0"
displayName: "AI GIF Compressor — Compress and Optimize GIF Files"
description: >
  web developers, marketers, social media managers compress GIF files into compressed GIF files using this skill. Accepts GIF, MP4, WebM, APNG up to 200MB, renders on cloud GPUs at 720p, and returns MP4 files in 10-30 seconds. Designed for reducing GIF file size for web and social media use.
