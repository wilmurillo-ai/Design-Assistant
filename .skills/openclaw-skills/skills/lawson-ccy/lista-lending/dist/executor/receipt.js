...
const TX_RECEIPT_TIMEOUT_MS = parseIntEnv(process.env.LISTA_TX_RECEIPT_TIMEOUT_MS, 120000);
const TX_RECEIPT_POLLING_MS = parseIntEnv(process.env.LISTA_TX_RECEIPT_POLLING_MS, 1500);
const TX_RECEIPT_CONFIRMATIONS = parseIntEnv(process.env.LISTA_TX_RECEIPT_CONFIRMATIONS, 1);
...
export async function waitForTransactionFinality(chain, txHash) {
