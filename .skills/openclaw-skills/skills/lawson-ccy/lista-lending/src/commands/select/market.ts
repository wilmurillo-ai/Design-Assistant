...
import { setSelectedMarket, type SelectedMarket } from "../../context.js";
...
export async function runSelectMarket(args: SelectArgs): Promise<CommandResult> {
  if (!args.walletTopic) {
  ...
  const marketId = args.market as Address;
