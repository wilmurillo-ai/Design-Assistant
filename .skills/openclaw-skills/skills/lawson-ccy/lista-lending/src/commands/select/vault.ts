...
import { setSelectedVault, type SelectedVault } from "../../context.js";
...
export async function runSelectVault(args: SelectArgs): Promise<CommandResult> {
  if (!args.walletTopic) {
  ...
  const vaultAddress = args.vault as Address;
