...
示例:
  ...
  cos = COSManager()
  cos.create_bucket(bucket_name='okx-data', storage_class='STANDARD')
  cos.upload_file('okx-data.cos.ap-singapore.myqcloud.com', '/tmp/data.parquet', 'tick/data.parquet')
  "
  ...
  from cos_manager import COSManager
  cos = COSManager()
  cos.put_lifecycle('okx-data.cos.ap-singapore.myqcloud.com', [
      {
          'id': 'rule1',
          'prefix': 'tick/',
          'transitions': [
