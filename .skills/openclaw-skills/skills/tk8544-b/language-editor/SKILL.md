...
version: "1.0.0"
displayName: "Language Editor — Translate and Dub Videos Instantly"
description: >
  Get translated dubbed videos ready to post, without touching a single slider. Upload your video with audio (MP4, MOV, AVI, WebM, up to 500MB), say something like "translate the spoken audio into French and sync the new voiceover to the video", and download 1080p MP4 when it's done. Built for content creators and educators who move fast and need to reach audiences who speak different languages without re-recording.
