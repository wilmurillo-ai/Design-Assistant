...
version: "1.0.0"
displayName: "Video Editor Filters — Apply Filters and Export Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — apply a cinematic color grade filter and smooth skin tone across the whole clip — and get filtered video clips back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI filter application automatically. Ideal for content creators who want polished visual effects without manual color grading skills.
