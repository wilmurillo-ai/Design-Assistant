---
name: highlight-editor-photo
version: "1.0.0"
displayName: "Highlight Editor Photo — Turn Photos Into Highlight Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn these photos into a highlight reel with music and transitions — and get photo highlight video back in 30-60 seconds. Upload JPG, PNG, HEIC, WEBP files up to 200MB, and the AI handles AI highlight video creation automatically. Ideal for social media creators who want to create slideshow videos from photos without manual editing.
