---
name: best-video-download
version: "1.0.0"
displayName: "Best Video Download — Download and Save Videos Locally"
description: >
  Turn a YouTube video URL at 1080p into 1080p downloaded MP4 files just by typing what you need. Whether it's downloading online videos for offline use or quick social content, drop your online video links and describe the result you want. No timeline dragging, no export settings — 20-40 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `best-video-download` |
