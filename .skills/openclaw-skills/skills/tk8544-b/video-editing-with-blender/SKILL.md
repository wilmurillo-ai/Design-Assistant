---
name: video-editing-with-blender
version: "1.0.0"
displayName: "Video Editing with Blender — Edit and Export Blender Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — cut dead footage, add smooth transitions, and sync audio in Blender style — and get edited video files back in 1-2 minutes. Upload MP4, MOV, AVI, MKV files up to 500MB, and the AI handles AI-assisted video editing automatically. Ideal for indie filmmakers and motion graphics creators who want professional video edits without manually learning Blender's VSE interface.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-blender` |
