...
name: free-video-to
version: "1.0.0"
displayName: "Free Video To — Convert and Export Video Files"
description: >
  Get converted video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "convert this video to a short clip with captions and music", and download 1080p MP4 when it's done. Built for content creators who move fast and want to convert and repurpose videos quickly without editing software.
