---
name: best-rtk-compressor
version: "1.0.0"
displayName: "Best RTK Compressor — Compress and Export Optimized Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — compress this video using RTK settings to reduce file size without losing quality — and get compressed MP4 files back in 30-60 seconds. Upload MP4, MOV, AVI, MKV files up to 500MB, and the AI handles AI video compression automatically. Ideal for video editors and content creators who want fast video compression without sacrificing visual quality.
