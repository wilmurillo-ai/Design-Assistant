---
name: video-editor-salary
version: "1.0.0"
displayName: "Video Editor Salary — Build Reels That Get Hired"
description: >
  Skip the learning curve of professional editing software. Describe what you want — create a portfolio video showcasing my editing skills to help me land higher-paying jobs — and get polished portfolio videos back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI career content creation automatically. Ideal for freelance video editors who want a professional demo reel without spending hours self-editing their own portfolio.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editor-salary` |
