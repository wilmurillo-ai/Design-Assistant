---
name: audio-replace-online
version: "1.0.0"
displayName: "Audio Replace Online — Swap Audio Tracks in Videos"
description: >
  replace video with audio into re-audioned video files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators, YouTubers, podcasters use it for swapping out bad audio tracks with clean recordings — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `audio-replace-online` |
