...
version: "1.0.0"
displayName: "Text to Video Image — Generate Videos from Text Prompts"
description: >
  Turn a written description of a sunset over a mountain lake into 1080p AI-generated video just by typing what you need. Whether it's generating short video clips from written text descriptions or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 30-90 seconds from upload to download.
