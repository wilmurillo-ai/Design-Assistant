---
name: ai-video-editor-mobile
version: "1.0.0"
displayName: "AI Video Editor Mobile — Edit Phone Videos for Social Media"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the shaky parts, add transitions, and export as a Reel — and get edited mobile clips back in 30-60 seconds. Upload MP4, MOV, 3GP, WebM files up to 500MB, and the AI handles AI mobile video editing automatically. Ideal for TikTok and Reels creators who want fast edits from phone footage without a desktop editor.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-editor-mobile` |
