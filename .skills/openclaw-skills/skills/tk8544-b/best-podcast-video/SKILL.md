---
name: best-podcast-video
version: "1.0.0"
displayName: "Best Podcast Video — Convert Podcast Audio to Video"
description: >
  convert audio or video files into polished podcast videos with this skill. Works with MP3, MP4, WAV, MOV files up to 500MB. podcasters use it for converting podcast audio into shareable video content — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `best-podcast-video` |
