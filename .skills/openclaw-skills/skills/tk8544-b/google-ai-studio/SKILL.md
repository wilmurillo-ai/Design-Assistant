...
version: "1.0.0"
displayName: "Google AI Studio — Generate and Edit AI Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — use Gemini AI to summarize this video and generate a short highlight reel — and get AI-processed video clips back in 30-90 seconds. Upload MP4, MOV, WebM, AVI files up to 500MB, and the AI handles AI content generation automatically. Ideal for developers and content creators who want to leverage Google AI models for video processing without complex setup.
