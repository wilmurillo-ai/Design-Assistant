---
name: green-screen-video-maker-free
version: "1.0.0"
displayName: "Green Screen Video Maker Free — Remove Backgrounds and Export Videos"
description: >
  replace video clips into background-replaced videos with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. YouTubers, TikTok creators, streamers use it for removing green screen backgrounds and replacing them with custom scenes — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `green-screen-video-maker-free` |
