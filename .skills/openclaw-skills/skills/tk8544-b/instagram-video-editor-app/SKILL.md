---
name: instagram-video-editor-app
version: "1.0.0"
displayName: "Instagram Video Editor App — Edit and Export Instagram Videos"
description: >
  Turn a 30-second vertical phone recording into 1080p Instagram-ready clips just by typing what you need. Whether it's editing and formatting videos for Instagram posts, Reels, and Stories or quick social content, drop your video clips and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `instagram-video-editor-app` |
