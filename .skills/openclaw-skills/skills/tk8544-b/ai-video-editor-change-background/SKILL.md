---
name: ai-video-editor-change-background
version: "1.0.0"
displayName: "AI Video Editor Change Background — Replace Video Backgrounds with AI"
description: >
  Skip the learning curve of professional editing software. Describe what you want — remove my background and replace it with a clean office scene — and get background-swapped video back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI background replacement automatically. Ideal for content creators who want a clean professional background without a green screen.
