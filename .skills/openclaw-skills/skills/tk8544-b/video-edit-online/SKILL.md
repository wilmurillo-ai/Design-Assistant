...
version: "1.0.0"
displayName: "Video Edit Online — Edit and Export Videos Online"
description: >
  edit raw video footage into edited MP4 clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators and marketers use it for editing raw footage into polished videos without desktop software — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-edit-online` |
