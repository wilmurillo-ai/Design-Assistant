---
name: free-maker-editor
version: "1.0.0"
displayName: "Free Maker Editor — Create and Edit Videos Free"
description: >
  Get polished edited videos ready to post, without touching a single slider. Upload your raw video clips (MP4, MOV, AVI, WebM, up to 500MB), say something like "trim the footage, add transitions, and export a clean final video", and download 1080p MP4 when it's done. Built for content creators who move fast and want to make and edit videos quickly without paying for expensive tools.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-maker-editor` |
