---
name: ai-video-editor-gaming
version: "1.0.0"
displayName: "AI Video Editor Gaming — Edit Gaming Clips into Highlights"
description: >
  Get edited gaming clips ready to post, without touching a single slider. Upload your raw gaming footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut the highlights, add kill cam transitions, and sync background music to the action", and download 1080p MP4 when it's done. Built for gaming content creators who move fast and want fast highlight edits without learning complex editing software.
