...
name: hydra-ai
version: "1.0.0"
displayName: "Hydra AI — Generate Multiple Videos From One"
description: >
  Turn a 2-minute raw interview recording into 1080p multi-version edited clips just by typing what you need. Whether it's generating multiple edited video versions from a single source clip or quick social content, drop your video clips and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
