---
name: ai-tool-for-videos
version: "1.0.0"
displayName: "AI Tool for Videos — Edit and Export Videos with AI"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the silent pauses, add captions, and export as a clean MP4 — and get edited video files back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video editing automatically. Ideal for content creators and marketers who want quick video edits without learning complex software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-tool-for-videos` |
