...
# Animation Video — Create Animated Videos from Scripts
...
Say you have a 10-slide storyboard with scene descriptions and want to turn my script into an animated explainer video with characters and background music — the backend processes it in about 1-3 minutes and hands you a 1080p MP4.
...
The backend processes faster when you're specific. Instead of "make it look better", try "turn my script into an animated explainer video with characters and background music" — concrete instructions get better results.
...
**Quick edit**: Upload → "turn my script into an animated explainer video with characters and background music" → Download MP4. Takes 1-3 minutes for a 30-second clip.
