---
name: ai-editor-generator
version: "1.0.0"
displayName: "AI Editor Generator — Generate and Export Edited Videos"
description: >
...
# AI Editor Generator — Generate and Export Edited Videos
...
User prompts referencing ai editor generator, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `ai-editor-generator`
