...
version: "1.0.0"
displayName: "Video Editing AI API — Edit and Export Videos via API"
description: >
  edit raw video footage into edited MP4 files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. developers and marketers use it for automating video edits via API integration — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-ai-api` |
