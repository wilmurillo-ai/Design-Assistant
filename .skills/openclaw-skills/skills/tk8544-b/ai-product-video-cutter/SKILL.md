---
name: ai-product-video-cutter
version: "1.0.0"
displayName: "AI Product Video Cutter — Cut Product Videos into Clips"
description: >
  Get trimmed product clips ready to post, without touching a single slider. Upload your raw product footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut the best 30-second highlight clips from my product video", and download 1080p MP4 when it's done. Built for e-commerce marketers who move fast and want to quickly trim product footage without manual editing skills.
