...
version: "1.0.0"
displayName: "Text to Video JSON — Convert Text Scripts to Video"
description: >
  Skip the learning curve of professional editing software. Describe what you want — convert this text into a 30-second video with visuals and voiceover — and get rendered video files back in 1-2 minutes. Upload TXT, JSON, DOCX, CSV files up to 500MB, and the AI handles AI video creation automatically. Ideal for developers and content creators who want to automate video creation from text data or scripts without manual editing.
