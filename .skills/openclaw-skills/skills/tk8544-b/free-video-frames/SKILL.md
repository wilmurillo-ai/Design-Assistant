---
name: free-video-frames
version: "1.0.0"
displayName: "Free Video Frames — Extract and Export Video Frames"
description: >
  extract video clips into exported frame images with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. YouTubers, video editors, content creators use it for pulling individual frames from videos for thumbnails or editing — processing takes 20-40 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-video-frames` |
