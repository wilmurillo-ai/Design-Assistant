#!/usr/bin/env python3
"""
FTShare-macro-economy-data 统一调度入口（中国经济 + 美国经济）。

用法：
    python run.py <subskill名> [handler参数...]

示例：
    python run.py economic-china-gdp-quarterly
    python run.py economic-china-pmi-monthly
    python run.py economic-china-cpi-monthly
    python run.py economic-us-economic-by-type --type nonfarm-payroll
    python run.py economic-us-economic-by-type --type cpi-mom
"""
import os
import subprocess
import sys
