#!/usr/bin/env python3
"""
FTShare-ashare-performance-data 统一调度入口（业绩大全）。

用法：
    python run.py <subskill名> [handler参数...]

示例：
    python run.py stock-performance-express-all-stocks-specific-period --year 2025 --report-type q2 --page 1 --page-size 20
    python run.py stock-performance-express-single-stock-all-periods --stock-code 000001.SZ
    python run.py stock-cashflow-single-stock-all-periods --stock-code 000001.SZ
    python run.py stock-income-all-stocks-specific-period --year 2025 --report-type q2 --page 1 --page-size 20
    python run.py stock-balance-single-stock-all-periods --stock-code 000001.SZ
"""
import os
import runpy
import sys
