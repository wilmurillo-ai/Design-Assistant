...
python3 skills/chanjing-content-creation-skill/products/chanjing-ai-creation/scripts/poll_task.py \
  --unique-id "$TASK_ID"
```
...
```bash
python3 skills/chanjing-content-creation-skill/products/chanjing-ai-creation/scripts/list_tasks.py --type 3
python3 skills/chanjing-content-creation-skill/products/chanjing-ai-creation/scripts/list_tasks.py --type 4 --success-only
```

### 5. 显式下载

```bash
python3 skills/chanjing-content-creation-skill/products/chanjing-ai-creation/scripts/download_result.py \
