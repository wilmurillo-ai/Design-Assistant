# Agents Mail API Reference (v0.4.6)
...
**Security:** Store your API key as an environment variable (`{your_api_key}`), not in plaintext files. The API key is shown only once at registration.
