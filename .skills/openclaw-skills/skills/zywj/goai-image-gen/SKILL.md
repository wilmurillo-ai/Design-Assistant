---
name: goai-image-gen
description: Generate AI images via GoAI API. Use when the user asks to create, generate, draw, edit, render, or make images, pictures, illustrations, posters, avatars, photos, or concept art, including Chinese requests like 生成图片, 生成一张图, 画图, 画一张图, 出图, 做图, 修图, 改图.
version: 0.3.0
