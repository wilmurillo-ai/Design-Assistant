...
Search the web using SkillBoss API Hub. Supports web search, news,
...
class WebSearch:
    """Web search using SkillBoss API Hub."""
    ...
    def search_text(
        ...
        try:
            ...
            result = pilot({"type": "search", "inputs": inputs, "prefer": "balanced"})
...
def main():
    if not SKILLBOSS_API_KEY:
        ...
        print("Export your key with: export SKILLBOSS_API_KEY=your_key", file=sys.stderr)
        sys.exit(1)

    parser = argparse.ArgumentParser(
        description="Search the web using SkillBoss API Hub",
