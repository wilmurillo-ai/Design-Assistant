...
|---|---|---|
| Скилл-коробка | SKILL.md + config + docs. Ставится за 15 мин в Claude/OpenClaw | **договорная** |
| Агент под ключ | Коробка + Telegram-бот + интеграция Bitrix24/amoCRM + настройка | **договорная** |
| Приложение | client-owned support portal + UI + DB + full integration | **договорная** | ## Before / After | Было | Стало |
|---|---|
...
- Условия передачи обсуждаются отдельно. Окупается за **7-10 дней**. **Умеренный сценарий:**
- Снижение оттока на 5 клиентов/мес × средний LTV 15 000 руб = **75 000 руб/мес** **Суммарный ROI:** экономия 25-100К/мес; коммерческие условия — **договорные** --- # AI-Поддержка PRO — Цифровой Отдел Поддержки Клиентов Это не FAQ-бот. Это полноценный отдел поддержки на AI. Обрабатывает обращения от
