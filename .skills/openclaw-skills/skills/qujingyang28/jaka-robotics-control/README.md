...
**获取方式：**
1. 访问 JAKA 官网：https://www.jaka.com/docs/guide/SDK/introduction.html
2. 下载 SDK V2.3.1+
3. 复制 `jkrc.pyd` 和 `jakaAPI.dll` 到技能目录

### 安装步骤

```bash
# 1. 通过 ClawHub 安装技能
npx clawhub@latest install jaka-robotics-control

# 2. 复制 SDK 文件到技能目录
# 将 jakaAPI.dll 和 jkrc.pyd 复制到：
# C:\Users\你的用户名\.openclaw\workspace\skills\jaka-robotics-control\
