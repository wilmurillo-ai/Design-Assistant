...
import {
  ...
  searchFactsHybrid,
  storeFact
} from "./chunk-CIYBIABX.js";
import "./chunk-5GUD3MLZ.js";

// src/cli.ts
import { parseArgs } from "util";
import { readFileSync } from "fs";
var DEFAULT_DB = `${process.env.HOME ?? "~"}/.zouroboros/memory.db`;
var DEFAULT_CONFIG = {
  enabled: true,
  ...
  switch (subcommand) {
    ...
    case "store": {
      ...
      const result = await storeFact({
        ...
        importance: values.importance ? parseFloat(values.importance) : void 0
      }, config);
      printJson(result);
      break;
    }
