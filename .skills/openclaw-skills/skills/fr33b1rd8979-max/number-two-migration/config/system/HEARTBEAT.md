...
### 技能生态系统检查
- [ ] **核心架构技能** - proactive-agent, self-improving 是否正常运行？
- [ ] **内容优化技能** - humanize-zh 是否自动应用于所有中文回复？
- [ ] **信息处理技能** - ai-news-collectors, qmd 配置状态如何？
- [ ] **可视化技能** - desktop-pet, lobster-pet 是否就绪？
- [ ] **开发集成技能** - create-agent, star-office-integration 功能正常？
- [ ] **社区技能** - moltbook-skill API配置状态？

### 技能健康检查清单
1. **自动触发验证** - 各技能是否按规则正确触发？
2. **API配置状态** - 检查所有必需API配置
3. **依赖环境** - 验证Node.js、Python等依赖
4. **性能监控** - 技能执行效率和资源使用
5. **错误日志** - 检查技能执行错误
6. **使用统计** - 各技能使用频率和效果
