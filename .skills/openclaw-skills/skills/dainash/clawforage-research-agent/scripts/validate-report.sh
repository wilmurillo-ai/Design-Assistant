#!/bin/bash
# validate-report.sh — Validate a domain research report
...
check_section "Domain Research Report"
check_section "Key Developments"
check_section "Entity Map"
check_section "Connections"
check_section "Outlook"
