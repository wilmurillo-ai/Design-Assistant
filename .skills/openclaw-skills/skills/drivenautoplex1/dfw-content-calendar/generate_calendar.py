            ...
            "posts": [
                {
                    ...
                    "hook": "Most first-time buyers in DFW are waiting for the perfect moment. There isn't one.",
                    ...
                    "hashtags": ["#DFWRealEstate", "#FirstTimeHomeBuyer", "#DFWHomes", "#HomeOwnership"],
                    "char_count": 521,
                    "hook_b": None
                },
                {
                    ...
                    "hook": "My client Sarah said she'd never be able to afford a home in Frisco. She closed last month.",
                    ...
                    "cta": "If you're renting in DFW right now, DM me your zip — I'll show you the side-by-side.",
                    "hashtags": ["#DFWRealEstate", "#FriscoTX", "#RentVsBuy", "#ClientWin"],
                    "char_count": 498,
                    "hook_b": None
                },
                {
                    ...
                    "body": "Conventional loans go as low as 3% down. FHA is 3.5%. VA is zero for eligible veterans. Down payment assistance programs exist in most DFW counties. The 20% rule made sense in 1985. Today it's a myth that keeps qualified buyers renting longer than they need to. Know what you actually need before you assume.",
                    "cta": "Want the real breakdown for your situation? Drop your city below.",
                    "hashtags": ["#Homebuying", "#DFWRealEstate", "#FirstTimeHomeBuyer", "#Mortgage"],
                    "char_count": 489,
                    "hook_b": None
                },
                {
                    ...
                    "hook": "The most underrated neighborhood in DFW right now: Little Elm.",
                    "body": "Lake access, new construction, sub-$350K entry points, and it's 30 minutes from Legacy West. Most buyers overlook it because they don't know it. The ones who looked at it 2 years ago are now sitting on $60K+ in equity. Local knowledge is the edge that no algorithm gives you.",
                    "cta": "Comment 'LITTLE ELM' and I'll send you what's currently listed there under $375K.",
                    "hashtags": ["#LittleElmTX", "#DFWRealEstate", "#HiddenGem", "#DFWSuburbs"],
                    "char_count": 461,
                    "hook_b": None
                },
                {
                ...
                },
                {
                    ...
                    "hook": "If you've been browsing DFW homes for more than 3 months, something's stopping you.",
                    ...
                    "hashtags": ["#DFWRealEstate", "#TakeAction", "#HomeBuying", "#DFW"],
                    "char_count": 502,
                    "hook_b": None
                },
                {
                    ...
                    "content_type": "social_proof",
                    "hook": "Weekend reading: the question I get asked most by first-time buyers in DFW.",
                    ...
                    "cta": "What's your #1 question about buying in DFW? Drop it below — I read every comment.",
                    "hashtags": ["#FirstTimeHomeBuyer", "#DFWRealEstate", "#WeekendReads", "#RealEstateTips"],
                    "char_count": 517,
                    "hook_b": None
                }
            ]
...
def main():
    ...
    parser.add_argument("--niche", help="Your brand/industry (e.g. 'DFW real estate agent')")
