...
name: minimax-image
description: |
  Generate images using MiniMax's image-01 model.
...
# MiniMax Image - AI Image Generation Skill

## Overview

This skill generates images using MiniMax's image generation model (`image-01`). It enables seamless image creation during any Claude Code session - whether you're building frontend UIs, creating documentation, or need visual representations of concepts.
...
2. Calls MiniMax API with image generation configuration
...
# With custom size
python scripts/generate_image.py --size 1K "High resolution landscape" "./wallpaper.png"

# With aspect ratio
python scripts/generate_image.py --aspect 16:9 "Wide landscape" "./landscape.png"
```

## Requirements

- `MINIMAX_API_KEY` environment variable must be set (your MiniMax Coding Plan API key)
