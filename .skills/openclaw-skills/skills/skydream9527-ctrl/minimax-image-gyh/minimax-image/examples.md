# MiniMax Image Skill - Usage Examples
...
Claude will run:
python scripts/generate_image.py --size 1K --aspect 1:1 "Minimalist weather app icon, stylized sun partially behind a cloud, warm orange and blue gradient, rounded square suitable for iOS/Android" "./assets/icons/weather-icon.png"
```
...
Claude will run:
python scripts/generate_image.py --size 2K --aspect 4:3 "Seamless tileable subtle geometric pattern, very light gray on white, minimalist, suitable for website background" "./assets/bg-pattern.png"
```
...
Claude will run:
python scripts/generate_image.py --size 2K --aspect 16:9 "Modern product launch banner 1200x675, bold typography space for text overlay, dynamic abstract tech background, vibrant gradients purple to blue" "./marketing/twitter-banner.png"
```
...
Claude will run:
python scripts/generate_image.py --size 2K --aspect 16:9 "Blog header image about artificial intelligence, abstract neural network visualization, glowing nodes and connections, dark background with blue accent lights, futuristic and professional" "./blog/images/ai-header.png"
```
...
# Wide aspect ratio
python scripts/generate_image.py --aspect 16:9 "Cinematic landscape" "./cinematic.png"

# Portrait aspect ratio
python scripts/generate_image.py --aspect 9:16 "Mobile wallpaper" "./phone-wallpaper.png"
```
...
### Advanced Tips
6. **Specify Lighting**: "golden hour lighting", "soft diffused light", "dramatic shadows"
7. **Define Composition**: "close-up", "wide angle", "from above", "centered"
8. **Include Texture**: "natural skin texture", "fabric weave visible", "metal sheen"
9. **Add Depth**: "shallow depth of field", "soft bokeh", "sharp focus throughout"
