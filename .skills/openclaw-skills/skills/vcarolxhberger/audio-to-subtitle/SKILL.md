...
version: "1.0.0"
displayName: "Audio to Subtitle — Convert Audio into Captioned Videos"
description: >
  Turn a 3-minute podcast audio clip into 1080p captioned videos just by typing what you need. Whether it's adding subtitles to audio recordings or videos or quick social content, drop your audio files and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
