...
version: "1.0.0"
displayName: "AI Subtitle Extractor — Extract and Embed Video Subtitles"
description: >
  Turn a 10-minute YouTube tutorial video into 1080p captioned video files just by typing what you need. Whether it's extracting and embedding subtitles from existing videos or quick social content, drop your video files and describe the result you want. No timeline dragging, no export settings — 30-90 seconds from upload to download.
