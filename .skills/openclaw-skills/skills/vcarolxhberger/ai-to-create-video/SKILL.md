---
name: ai-to-create-video
version: "1.0.0"
displayName: "AI to Create Video — Generate Videos from Images or Text"
description: >
  create text prompts or images into AI generated videos with this ai-to-create-video skill. Works with MP4, MOV, JPG, PNG files up to 500MB. marketers, content creators, small business owners use it for generating videos from images or text prompts — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-to-create-video` |
