...
version: "1.0.0"
displayName: "Character Generator — Generate Characters for Video Clips"
description: >
  Get animated character clips ready to post, without touching a single slider. Upload your text prompts (MP4, MOV, PNG, JPEG, up to 200MB), say something like "generate a unique animated character from my description and export it as a video clip", and download 1080p MP4 when it's done. Built for content creators, game designers, storytellers who move fast and want to create original characters without drawing or 3D modeling skills.
