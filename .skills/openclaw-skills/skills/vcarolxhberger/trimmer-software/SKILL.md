---
name: trimmer-software
version: "1.0.0"
displayName: "Trimmer Software — Trim and Export Clean Videos"
description: >
  Turn a 10-minute raw interview recording into 1080p trimmed video clips just by typing what you need. Whether it's cutting down long recordings into clean shorter clips or quick social content, drop your video clips and describe the result you want. No timeline dragging, no export settings — 20-40 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `trimmer-software` |
