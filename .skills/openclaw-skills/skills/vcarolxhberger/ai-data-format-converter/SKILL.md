---
name: ai-data-format-converter
version: "1.0.0"
displayName: "AI Data Format Converter — Convert and Export Data Formats"
description: >
  Skip the learning curve of professional editing software. Describe what you want — convert this CSV to JSON and wrap it in a video data visualization export — and get converted format files back in 20-40 seconds. Upload CSV, JSON, XML, MP4 files up to 200MB, and the AI handles AI format conversion automatically. Ideal for developers, data analysts, video producers who need to reformat data files quickly without writing custom scripts.
