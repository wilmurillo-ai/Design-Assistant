---
name: video-script-yijia
version: "1.0.0"
displayName: "Video Script Yijia — Generate Video Scripts with AI"
description: >
  Get ready-to-use scripts ready to post, without touching a single slider. Upload your text or brief (MP4, MOV, TXT, DOCX, up to 200MB), say something like "write a video script for a 90-second explainer about our new fitness app", and download 1080p MP4 when it's done. Built for content creators, marketers who move fast and need a structured video script quickly without writing from scratch.
