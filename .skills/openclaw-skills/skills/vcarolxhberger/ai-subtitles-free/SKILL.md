...
version: "1.0.0"
displayName: "AI Subtitles Free — Generate and Embed Video Captions"
description: >
  Turn a 3-minute YouTube video in MP4 format into 1080p captioned video files just by typing what you need. Whether it's adding subtitles to videos automatically using AI or quick social content, drop your video files and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
