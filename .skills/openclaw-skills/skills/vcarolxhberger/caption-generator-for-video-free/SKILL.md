---
name: caption-generator-for-video-free
version: "1.0.0"
displayName: "Caption Generator for Video Free — Generate and Burn In Captions"
description: >
  Get captioned video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "add captions in English and Spanish to my video", and download 1080p MP4 when it's done. Built for content creators who move fast and need captions quickly without paying for transcription software.
