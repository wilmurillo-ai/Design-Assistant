---
name: subtitle-generator-hinglish
version: "1.0.0"
displayName: "Subtitle Generator Hinglish — Generate Hinglish Captions for Videos"
description: >
  generate video files into Hinglish captioned videos with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. Indian content creators use it for adding Hinglish subtitles to Hindi-English mixed videos — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `subtitle-generator-hinglish` |
