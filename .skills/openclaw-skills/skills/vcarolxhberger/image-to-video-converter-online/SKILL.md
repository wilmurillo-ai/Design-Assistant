---
name: image-to-video-converter-online
version: "1.0.0"
displayName: "Image to Video Converter Online — Convert Photos into Shareable Videos"
description: >
  convert images into animated video clips with this skill. Works with JPG, PNG, WEBP, GIF files up to 200MB. marketers, social media creators, small business owners use it for turning photo collections into shareable videos — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `image-to-video-converter-online` |
