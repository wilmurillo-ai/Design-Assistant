---
name: highlight-editor-unlimited
version: "1.0.0"
displayName: "Highlight Editor Unlimited — Extract and Export Video Highlights"
description: >
  create raw video footage into highlight reel clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. sports creators, vloggers, event videographers use it for generating short highlight reels from long video recordings — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
- "generating short highlight reels from long video recordings for sports creators, vloggers, event videographers"
...
# Highlight Editor Unlimited — Extract and Export Video Highlights
...
User prompts referencing highlight editor unlimited, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `highlight-editor-unlimited`
