...
version: "1.0.0"
displayName: "Text to Voice Generator — Convert Text into Voiceover Videos"
description: >
  convert written text into voiced video files with this text-to-voice-generator skill. Works with TXT, DOCX, PDF, SRT files up to 200MB. content creators, marketers, educators use it for converting written scripts into voiceover videos — processing takes 20-40 seconds on cloud GPUs and you get 1080p MP4 files.
