---
name: free-text-editing
version: "1.0.0"
displayName: "Free Text Editing — Edit Videos by Editing Text"
description: >
  Skip the learning curve of professional editing software. Describe what you want — delete the rambling section between 1:10 and 1:45 by removing those lines from the transcript — and get edited video clips back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI text-based editing automatically. Ideal for content creators and podcasters who want to trim and restructure videos without learning timeline-based editors.
