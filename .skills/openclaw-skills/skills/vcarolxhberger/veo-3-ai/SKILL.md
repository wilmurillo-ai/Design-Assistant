...
name: veo-3-ai
version: "1.0.0"
displayName: "Veo 3 AI — Generate Videos from Text Prompts"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text prompts (MP4, MOV, WebM, GIF, up to 500MB), say something like "generate a 10-second clip of a sunset over the ocean with waves crashing", and download 1080p MP4 when it's done. Built for content creators who move fast and want to create videos without filming or editing skills.
