---
name: ai-video-editor-davinci-resolve
version: "1.0.0"
displayName: "AI Video Editor DaVinci Resolve — Edit and Export Polished Videos"
description: >
  Get edited video files ready to post, without touching a single slider. Upload your raw video footage (MP4, MOV, AVI, MKV, up to 500MB), say something like "cut out silences, add transitions, and color grade the footage automatically", and download 4K MP4 when it's done. Built for video editors and filmmakers who move fast and want AI to handle cuts, transitions, and color grading instead of manual DaVinci Resolve workflows.
