...
name: video-motion
version: "1.0.0"
displayName: "Video Motion — Add Motion Effects to Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add smooth motion blur and dynamic camera movement to my static footage — and get motion-enhanced videos back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI motion enhancement automatically. Ideal for content creators who want cinematic motion effects without complex editing software.
