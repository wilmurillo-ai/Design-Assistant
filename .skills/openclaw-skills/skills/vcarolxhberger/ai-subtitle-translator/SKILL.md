...
version: "1.0.0"
displayName: "AI Subtitle Translator — Translate Subtitles Into Any Language"
description: >
  Get subtitled translated videos ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "translate subtitles from Spanish to English and French", and download 1080p MP4 when it's done. Built for YouTubers, content creators, educators who move fast and need accurate subtitles in multiple languages without manual transcription.
