...
version: "1.0.0"
displayName: "WeChat Video Online — Edit and Export WeChat Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the video, add subtitles, and export for sharing on WeChat — and get share-ready MP4 back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video editing automatically. Ideal for WeChat users and content creators who need a quick online tool to edit and format videos for WeChat without desktop software.
