...
version: "1.0.0"
displayName: "Browser Video Generation — Create and Export Videos Online"
description: >
  Get ready-to-share videos ready to post, without touching a single slider. Upload your text prompts (MP4, MOV, WebM, GIF, up to 500MB), say something like "generate a 30-second explainer video from this script", and download 1080p MP4 when it's done. Built for marketers who move fast and want to create videos instantly without downloading editing software.
