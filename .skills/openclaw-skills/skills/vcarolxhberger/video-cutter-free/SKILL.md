...
version: "1.0.0"
displayName: "Video Cutter Free — Cut and Export Video Clips"
description: >
  Get trimmed video clips ready to post, without touching a single slider. Upload your video clips (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut out the first 2 minutes and trim the ending at 7:30", and download 1080p MP4 when it's done. Built for content creators who move fast and want to cut videos quickly without installing or paying for editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-cutter-free` |
