---
name: ai-video-generation-online
version: "1.0.0"
displayName: "AI Video Generation Online — Generate Videos from Text or Images"
description: >
  generate text or images into AI generated videos with this skill. Works with MP4, MOV, JPG, PNG files up to 200MB. marketers, content creators, small business owners use it for generating videos from text prompts or images without filming anything — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-generation-online` |
