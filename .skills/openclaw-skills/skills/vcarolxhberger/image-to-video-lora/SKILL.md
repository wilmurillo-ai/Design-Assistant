---
name: image-to-video-lora
version: "1.0.0"
displayName: "Image to Video LoRA — Animate images with LoRA styles"
description: >
  Turn a single portrait photo or product image into 1080p animated video clips just by typing what you need. Whether it's turning still images into short animated videos using custom LoRA models or quick social content, drop your images and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
