---
name: image-compressor-pro-online
version: "1.0.0"
displayName: "Image Compressor Pro Online — Compress and Export Optimized Images"
description: >
  Get compressed image files ready to post, without touching a single slider. Upload your images (JPG, PNG, WebP, HEIC, up to 200MB), say something like "compress this image to under 500KB without losing visible quality", and download 1080p MP4 when it's done. Built for web designers, marketers, bloggers who move fast and want smaller image files without manual editing tools.
