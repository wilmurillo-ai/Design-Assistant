---
name: ai-screen-recording-editor
version: "1.0.0"
displayName: "AI Screen Recording Editor — Edit and Export Screen Recordings"
description: >
  edit screen recordings into edited screen recordings with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. educators, developers, content creators use it for cleaning up and polishing screen recordings for tutorials or demos — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-screen-recording-editor` |
