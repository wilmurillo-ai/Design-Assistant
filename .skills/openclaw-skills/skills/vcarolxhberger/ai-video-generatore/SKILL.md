---
name: ai-video-generatore
version: "1.0.0"
displayName: "AI Video Generatore — Generate Videos from Text or Images"
description: >
  Get generated MP4 videos ready to post, without touching a single slider. Upload your text or images (MP4, MOV, JPG, PNG, up to 500MB), say something like "generate a 30-second video from this text with background music and captions", and download 1080p MP4 when it's done. Built for content creators, marketers who move fast and want to create videos quickly without filming or editing skills.
