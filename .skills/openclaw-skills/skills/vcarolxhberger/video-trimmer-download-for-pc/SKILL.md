---
name: video-trimmer-download-for-pc
version: "1.0.0"
displayName: "Video Trimmer Download for PC — Trim and Export Video Clips"
description: >
  Turn a 10-minute raw screen recording into 1080p trimmed video clips just by typing what you need. Whether it's cutting unwanted sections from long video recordings or quick social content, drop your video clips and describe the result you want. No timeline dragging, no export settings — 20-40 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-trimmer-download-for-pc` |
