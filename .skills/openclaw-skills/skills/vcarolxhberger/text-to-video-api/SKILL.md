...
version: "1.0.0"
displayName: "Text to Video API — Generate Videos from Text Scripts"
description: >
  Turn a 200-word product description script into 1080p generated video files just by typing what you need. Whether it's generating videos programmatically from text scripts via API or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-api` |
