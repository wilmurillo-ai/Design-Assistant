---
name: text-to-video-notegpt
version: "1.0.0"
displayName: "Text to Video NoteGPT — Convert Notes into Shareable Videos"
description: >
  Get AI-generated videos ready to post, without touching a single slider. Upload your text or notes (TXT, DOCX, PDF, MD, up to 50MB), say something like "convert my notes into a short explainer video with visuals and narration", and download 1080p MP4 when it's done. Built for students, content creators, educators who move fast and want to turn written content into video without recording or editing manually.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-notegpt` |
