---
name: add-subtitle-to-video-online
version: "1.0.0"
displayName: "Add Subtitle to Video Online — Generate and Embed Video Captions"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add captions in English and Spanish — and get captioned video files back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI subtitle generation automatically. Ideal for YouTubers and content creators who need captions in multiple languages without manual transcription.
