---
name: youtube-video-editor-transitions
version: "1.0.0"
displayName: "YouTube Video Editor Transitions — Add Transitions and Export Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add smooth transitions between all clips and export for YouTube — and get transition-edited video back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI transition editing automatically. Ideal for YouTubers who want polished transitions without learning complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `youtube-video-editor-transitions` |
