...
async function testCaptureFixed() {
  console.log('测试截图 - 修复版\n');
  
  const outputDir = 'C:\\Users\\Administrator\\Desktop\\二下(第31节)_修复版';
  ...
  for (let i = 0; i < studentList.length; i++) {
    ...
    console.log(`  当前位置: top=${currentPos.top.toFixed(1)}`);
...
testCaptureFixed().catch(console.error);
