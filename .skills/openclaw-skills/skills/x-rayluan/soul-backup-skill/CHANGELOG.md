...
### Changed
- SKILL.md now explicitly documents config backup policy:
  - `openclaw.json` is backed up as `openclaw.sanitized.json`
  - sensitive fields are redacted
  - restore behavior clarified

## [1.2.0] - 2026-03-05

### Added
- README section: One-Command Disaster Recovery for broken `openclaw.json`
- Explicit recovery acceptance criteria: verify assistant can reply to `hello`
