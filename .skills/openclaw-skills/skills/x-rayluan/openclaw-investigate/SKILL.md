...
description: |
  Systematic debug and root cause investigation framework (investigate-analyze-hypothesize-verify) that only fixes root causes. Suitable for bug debugging, abnormal behavior analysis, and service error troubleshooting with verifiable conclusions.
