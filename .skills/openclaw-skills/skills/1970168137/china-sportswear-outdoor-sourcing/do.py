"""
china-sportswear-outdoor-sourcing - OpenClaw skill for China sportswear and outdoor equipment industry intelligence
...
def get_industry_overview() -> Dict:
    """Return overview of China's sportswear and outdoor industry scale and targets."""
    return SPORTSWEAR_DATA.get("industry_overview", {})

def get_supply_chain_structure() -> Dict:
    """Return the complete sportswear/outdoor supply chain structure."""
    return SPORTSWEAR_DATA.get("supply_chain_structure", {})
...
def get_regional_clusters(region: Optional[str] = None) -> Union[List[Dict], Dict]:
    ...
    """
    clusters = SPORTSWEAR_DATA.get("regional_clusters", [])
...
def get_subsector_info(subsector: str) -> Dict:
    """Return detailed information about a specific sportswear/outdoor subsector."""
    subsectors = SPORTSWEAR_DATA.get("subsector_details", {})
    ...
    keyword_mapping = {
        "apparel": "athletic_apparel",
        "clothing": "athletic_apparel",
        "leggings": "athletic_apparel",
        "shirt": "athletic_apparel",
        "jacket": "outerwear",
        "coat": "outerwear",
        "down": "outerwear",
        "shoe": "footwear",
        ...
        "boot": "footwear",
        "tent": "outdoor_gear",
        "backpack": "outdoor_gear",
        "sleeping bag": "outdoor_gear",
        "camping": "outdoor_gear",
        "hat": "accessories",
        "glove": "accessories",
        "sock": "accessories"
    }
...
def get_sourcing_guide() -> Dict:
    ...
    guide = SPORTSWEAR_DATA.get("sourcing_guide", {})
...
def get_glossary(term: Optional[str] = None) -> Union[Dict, str]:
    ...
    glossary = SPORTSWEAR_DATA.get("glossary", {})
...
def search_data(query: str) -> List[Dict]:
    ...
    for cluster in SPORTSWEAR_DATA.get("regional_clusters", []):
    ...
    for subsector_name, subsector_data in SPORTSWEAR_DATA.get("subsector_details", {}).items():
...
def get_metadata() -> Dict:
    ...
    return SPORTSWEAR_DATA.get("metadata", {})

# --- If run directly, provide interactive example ---
if __name__ == "__main__":
    print("🏃 China Sportswear & Outdoor Sourcing Skill (CLI Test Mode)")
    print("=" * 60)
    ...
    print('  get_subsector_info("athletic_apparel")')