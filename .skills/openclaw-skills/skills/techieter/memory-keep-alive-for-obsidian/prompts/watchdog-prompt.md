...
1. Check existing files inside `VAULT_PATH/Tasks/` to determine what the agent is currently working on. Do not access files outside the vault.
...
Key files: <relevant file paths within the vault>
