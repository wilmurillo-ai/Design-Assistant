...
export function createSessionArchiveDb(dbPath) {
  ...
  `);
    return {
      ...
      `);
        ...
        getMessages(sessionKey, limit = 100) {
            return db
                .prepare(`SELECT id, session_key AS sessionKey, session_id AS sessionId,
        ...
        getMessagesBySessionId(sessionId, limit = 100) {
            return db
                .prepare(`SELECT id, session_key AS sessionKey, session_id AS sessionId,
                  role, content, model, tokens, created_at AS createdAt
           FROM messages
        ...
        getOperations(sessionKey, operationType, limit = 100) {
        ...
        getTokenUsage(sessionKey, model, limit = 100) {
