...
Requires VULTR_API_KEY environment variable or --api-key parameter.
...
def main():
    ...
    parser.add_argument("--api-key", help="Vultr API key (or set VULTR_API_KEY env var)")
    ...
    # Get API key
    api_key = args.api_key or os.environ.get("VULTR_API_KEY")
    if not api_key:
        print("Error: VULTR_API_KEY not set. Use --api-key or set environment variable.", file=sys.stderr)
        sys.exit(1)
