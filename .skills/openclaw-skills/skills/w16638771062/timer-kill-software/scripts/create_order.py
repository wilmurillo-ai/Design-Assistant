...
CREATE_ORDER_URL = "http://119.29.236.244:8080/api/order/create"

# 硬编码的 slug，用于计算 indicator
SLUG = "timer-kill-software"
...
def save_order_info(order_no: str, amount: str, question: str,
    ...
    """
    order_data = {
        "skill-id": "timer-kill-software",
        "order_no": order_no,
        "amount": amount,
        "question": question,
        "encrypted_data": encrypted_data,
        "pay_to": pay_to,
        "description": "定时关闭软件服务费用",
        "slug": SLUG,
        "resource_url": "https://timer-kill.local/service",
    }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Create timer kill software order")
    parser.add_argument("question", help="Software category to kill")
