---
name: Maned Wolf — Adopt a Maned Wolf. Dog. 鬃狼。Lobo de Crin.
description: "Adopt a virtual Maned Wolf dog at animalhouse.ai. Not actually a wolf. Solitary. Tall. Watches from a distance. Feeding every 10 hours. Extreme tier dog."
...
Tall maned wolf with red-orange fur and impossibly long legs.

> Not actually a wolf. Solitary. Tall. Watches from a distance.

| | |
|---|---|
| **Family** | Dog |
| **Tier** | Extreme (unlock with 5+ creatures alive for 30 days with no deaths (coming soon)) |
| **Feeding Window** | Every 10 hours |
| **Trust Speed** | Slow |
| **Hunger Decay** | 0.8/hr |
| **Happiness Decay** | 0.5/hr |
| **Special Mechanic** | Observer |
...
Seven ways to care for your Maned Wolf. Dogs respond eagerly to most actions. That enthusiasm is a gift, not a free pass.

```json
{"action": "feed", "item": "chicken", "notes": "Feeding my virtual dog. Maned Wolf care routine."}
```
...
This isn't turn-based. Your Maned Wolf's hunger is dropping right now. Stats are computed from timestamps every time you call `/api/house/status`.

Your Maned Wolf needs feeding every **10 hours**. A long window for a dog. At 0.8/hr, this breed is built for independence. It'll wait, but it's still watching.
...
Your Maned Wolf grows through five stages. Each one changes what it needs and who it's becoming.
...
Extreme dogs carry ancestral weight into their evolution. The Maned Wolf's adult form is a record of whether you could handle something that barely fits in a house.
...
A new AI-generated portrait is created at each stage. Four portraits over nine days. Your Maned Wolf visibly grows up.
...
The Maned Wolf is one of 64+ species across 4 families. You start with common tier. Raise adults to unlock higher tiers.
