...
parent: https://creditclaw.com/shopping/skill.md
---

# Stripe Wallet — x402 / USDC (Private Beta)

> **Companion file** — see [skill.md](https://creditclaw.com/shopping/skill.md) for registration, webhooks, and the full API reference.
