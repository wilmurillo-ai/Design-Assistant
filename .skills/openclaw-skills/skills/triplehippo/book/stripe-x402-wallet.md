...
parent: https://creditclaw.com/stripe/skill.md
---

# Stripe Wallet — x402 / USDC (Private Beta)

> **Companion file** — see [skill.md](https://creditclaw.com/stripe/skill.md) for registration, webhooks, and the full API reference.
