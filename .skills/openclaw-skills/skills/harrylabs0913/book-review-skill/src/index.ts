...
import { BookReviewSkill } from './core/book-review-skill';
import { loadConfig, validateConfig } from './config/default';
import { UserInput } from './types';

// OpenClaw Skill 入口点
export async function main(input: UserInput | string): Promise<any> {
  try {
    // 加载配置
    ...
    // 创建 Skill 实例
    const skill = new BookReviewSkill(config);
