...
var require_lunr = __commonJS({
  "node_modules/lunr/lunr.js"(exports2, module2) {
    (function() {
...
var require_iterate = __commonJS({
  "node_modules/asynckit/lib/iterate.js"(exports2, module2) {
    ...
    function iterate2(list, iterator2, state, callback) {
  ...
  "node_modules/asynckit/parallel.js"(exports2, module2) {
    ...
    function parallel(list, iterator2, callback) {
      ...
      while (state.index < (state["keyedList"] || list).length) {
        iterate2(list, iterator2, state, function(error, result) {
          if (error) {
...
var require_serialOrdered = __commonJS({
  "node_modules/asynckit/serialOrdered.js"(exports2, module2) {
    ...
    function serialOrdered(list, iterator2, sortMethod, callback) {
      ...
      iterate2(list, iterator2, state, function iteratorHandler(error, result) {
        if (error) {
          callback(error, result);
          return;
        }
        ...
        if (state.index < (state["keyedList"] || list).length) {
          iterate2(list, iterator2, state, iteratorHandler);
          return;
        }
        callback(null, state.results);
      });
...
var require_package = __commonJS({
  "package.json"(exports2, module2) {
    module2.exports = {
      name: "openclaw-skill-book-review",
      version: "1.0.0",
      description: "\u5C06\u8BFB\u4E66\u5FC3\u5F97\u6269\u5C55\u6210\u6709\u6DF1\u5EA6\u7684\u70B9\u8BC4\uFF0C\u57FA\u4E8E\u7528\u6237\u7B14\u8BB0\u5E93\u63D0\u4F9B\u4E2A\u6027\u5316\u5F15\u7528",
      main: "dist/index.js",
      types: "dist/index.d.ts",
      scripts: {
        build: "tsc && esbuild src/index.ts --bundle --platform=node --outfile=dist/bundle.js",
        dev: "tsc --watch",
        test: "jest",
      ...
      author: "Digital Partners Team (\u73CD\u73E0, \u8D1D\u5C14, \u54C8\u5229, \u559C\u7F8A\u7F8A)",
      license: "MIT",
      repository: {
        type: "git",
        url: "https://github.com/yourusername/openclaw-skill-book-review.git"
      },
      bugs: {
        url: "https://github.com/yourusername/openclaw-skill-book-review/issues"
      },
      homepage: "https://github.com/yourusername/openclaw-skill-book-review#readme",
      dependencies: {
        openclaw: "^2026.3.0",
        nodejieba: "^2.6.0",
        lunr: "^2.3.9",
      ...
      openclaw: {
        skill: true,
        name: "book-review",
        description: "Expand reading insights into detailed reviews with personalized references from your notes",
        version: "1.0.0",
...
// src/parser/insight-parser.ts
var InsightParser = class {
  constructor() {
  }
  async parse(text) {
  ...
  extractEnglishKeywords(text) {
    const words = text.toLowerCase().replace(/[^\w\s]/g, " ").split(/\s+/).filter((word) => word.length > 2 && !this.isStopWord(word));
  ...
  identifyThemes(keywords) {
    ...
    for (const [theme, themeKeywords] of Object.entries(themeMap)) {
      const matchCount = themeKeywords.filter(
        (keyword) => keywordSet.has(keyword.toLowerCase())
      ).length;
...
var NoteSearcher = class {
  ...
  async ensureIndexUpdated() {
    const now = Date.now();
    const shouldUpdate = !this.index || now - this.lastIndexTime > this.indexUpdateInterval * 1e3;
    if (shouldUpdate) {
  ...
  async buildIndex() {
    ...
    for (const filePath of noteFiles) {
      try {
        const document2 = await this.processNoteFile(filePath);
        if (document2) {
  ...
  async collectNoteFiles() {
    ...
    for (const notePath of this.notePaths) {
      ...
      for (const pattern of patterns) {
        const fullPattern = path2.join(resolvedPath, pattern);
  ...
  filterResults(results) {
    return results.filter((result) => result.score >= this.minRelevanceScore).slice(0, this.maxResults * 2).sort((a, b) => b.score - a.score);
  }
  ...
  resolvePath(inputPath) {
    if (inputPath.startsWith("~/")) {
      return path2.join(process.env.HOME || "", inputPath.substring(2));
    }
...
// src/generation/review-generator.ts
var ReviewGenerator = class {
  ...
  maxTokens;
  apiKey;
  constructor(aiProvider = "deepseek", model = "deepseek-chat", temperature = 0.7, maxTokens = 1e3) {
...
Expanded review:`;
  ...
  extractReferences(text, notes) {
    const references = [];
    notes.forEach((note) => {
      if (text.includes(note.title) || note.excerpt.length > 20 && text.includes(note.excerpt.substring(0, 20))) {
...
`;
    output += `*\u751F\u6210\u65F6\u95F4: ${(/* @__PURE__ */ new Date()).toLocaleString("zh-CN", { timeZone: "Asia/Shanghai" })}*
`;
    return output;
  }
  formatPlain(review) {
...
<body>
    ...
    <div class="metadata">
        ...
        <p>\u751F\u6210\u65F6\u95F4: ${(/* @__PURE__ */ new Date()).toLocaleString("zh-CN", { timeZone: "Asia/Shanghai" })}</p>
    </div>
</body>
</html>`;
    return output;
...
---
\u751F\u6210\u65F6\u95F4\uFF1A${(/* @__PURE__ */ new Date()).toLocaleString("zh-CN", { timeZone: "Asia/Shanghai" })}`;
  }
  formatForSharing(review) {
    const { original, expanded } = review;
    const preview = expanded.length > 200 ? expanded.substring(0, 200) + "..." : expanded;
    return `\u{1F4D6} \u521A\u521A\u6269\u5C55\u4E86\u4E00\u6761\u8BFB\u4E66\u5FC3\u5F97\uFF1A
...
// src/core/book-review-skill.ts
var BookReviewSkill = class {
  parser;
  searcher;
  generator;
  formatter;
...
*\u9519\u8BEF\u65F6\u95F4: ${(/* @__PURE__ */ new Date()).toLocaleString("zh-CN", { timeZone: "Asia/Shanghai" })}*
`;
    return {
...
function loadConfig() {
  ...
  if (notePathsEnv) {
    config.search.notePaths = notePathsEnv.split(",").map((path3) => path3.trim());
  }
