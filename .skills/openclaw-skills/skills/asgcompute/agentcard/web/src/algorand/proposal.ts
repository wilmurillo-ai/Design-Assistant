  ...
  <div class="mb-6 flex justify-between items-start gap-4">
    <div>
      ...
      <p class="text-[14px] text-gray-600 max-w-2xl leading-snug mt-1">
        Enable autonomous AI agents to spend safely and programmatically. ASG Card provides instant virtual cards for agent-driven payments — funded via the x402 protocol, settled in USDC on Algorand, and secured by x402.
      </p>
    </div>
  ...
  <div class="border-t border-gray-100 pt-5 flex-grow">
    ...
    <div class="grid md:grid-cols-2 gap-x-8 gap-y-4 items-start">
      <div class="flex gap-2 text-[13px] text-gray-700">
        ...
        <div class="leading-snug"><b>Co-Development & Sandbox:</b> Integrate ASG Card with the x402 Algorand infrastructure. Validate the x402 USDC flow.</div>
      </div>
      <div class="flex gap-2 text-[13px] text-gray-700">
