...
Use this when Peter specifically wants the manually confirmed Contango set weighted for execution convenience.
...
The final answer should help Peter decide where to put money, not just identify the highest APY row on Pendle.
