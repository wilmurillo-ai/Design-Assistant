...
name: instance-setup
description: >
  Configure the Multi-Agent Brand Studio instance for a specific owner. Sets owner name,
...
- During initial Multi-Agent Brand Studio setup (called automatically by onboarding)
...
Bot: Let's configure your Multi-Agent Brand Studio instance.
