...
# scaffold.sh — Multi-Agent Brand Studio skill scaffolding
...
Examples:
  scaffold.sh --skill-dir /path/to/multi-agent-brand-studio
  scaffold.sh --base-dir /custom/openclaw --skill-dir /path/to/multi-agent-brand-studio
EOF
  exit 0
}
