...
The Multi-Agent Brand Studio system uses a strict **star topology** with persistent A2A (Agent-to-Agent) sessions. The Leader agent is the sole hub; all other agents are spokes. No spoke-to-spoke communication exists.
