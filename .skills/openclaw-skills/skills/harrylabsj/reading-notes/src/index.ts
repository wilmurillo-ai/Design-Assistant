 ...
 */
export const expandReadingNotes = async (
  options: ReadingNotesOptions
): Promise<string> => {
 ...
 */
export const generateNotePrompts = async (
  insight: string
): Promise<string[]> => {
  const prompts = [
 ...
 */
export const readingNotesSkill: Skill = {
  name: 'reading-notes',
