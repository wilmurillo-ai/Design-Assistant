---
name: best-free-video-generation-tools
version: "1.0.0"
displayName: "Best Free Video Generation Tools — Generate Videos from Text or Images"
description: >
  Turn a short text description like 'a sunset over the ocean with calm waves' into 1080p AI-generated videos just by typing what you need. Whether it's generating short videos from text prompts or images without a camera or quick social content, drop your text prompts or images and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `best-free-video-generation-tools` |
