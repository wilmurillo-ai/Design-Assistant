---
name: best-caption-generator
version: "1.0.0"
displayName: "Best Caption Generator — Auto-Generate Captions for Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add captions in English and Spanish with auto-sync — and get captioned video files back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI caption generation automatically. Ideal for YouTubers and content creators who need accurate captions quickly without manual transcription.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `best-caption-generator` |
