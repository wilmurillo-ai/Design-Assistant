...
version: "1.0.0"
displayName: "Video Editing With Laptop — Edit and Export Laptop Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the pauses, add transitions, and export a clean final cut — and get polished edited clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video editing automatically. Ideal for students, freelancers, content creators who want quick edits without learning Premiere or Final Cut.
...
# Video Editing With Laptop — Edit and Export Laptop Videos
...
Here's a typical use: you send a a 3-minute screen recording from a MacBook, ask for trim the pauses, add transitions, and export a clean final cut, and about 1-2 minutes later you've got a MP4 file ready to download. The whole thing runs at 1080p by default.

One thing worth knowing — shorter clips under 2 minutes process significantly faster.

## Matching Input to Actions

User prompts referencing video editing with laptop, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-laptop` |
