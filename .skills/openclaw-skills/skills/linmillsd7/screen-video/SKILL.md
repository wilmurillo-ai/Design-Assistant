...
name: screen-video
version: "1.0.0"
displayName: "Screen Video — Edit and Export Screen Recordings"
description: >
  Get polished screen videos ready to post, without touching a single slider. Upload your screen recordings (MP4, MOV, AVI, WebM, up to 500MB), say something like "trim the pauses, add captions, and highlight cursor clicks", and download 1080p MP4 when it's done. Built for educators, developers, content creators who move fast and want to clean up screen recordings without complex editing software.
