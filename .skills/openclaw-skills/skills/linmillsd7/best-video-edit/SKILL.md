---
name: best-video-edit
version: "1.0.0"
displayName: "Best Video Edit — Edit and Export Polished Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the pauses, add transitions, and sync background music — and get polished edited clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video editing automatically. Ideal for content creators and marketers who want professional edits without learning complex software.
...
# Best Video Edit — Edit and Export Polished Videos
...
User prompts referencing best video edit, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `best-video-edit` |
