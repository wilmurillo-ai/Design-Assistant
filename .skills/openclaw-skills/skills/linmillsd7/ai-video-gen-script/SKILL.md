---
name: ai-video-gen-script
version: "1.0.0"
displayName: "AI Video Gen Script — Generate Videos From Scripts"
description: >
  Turn a 200-word product launch script into 1080p script-based videos just by typing what you need. Whether it's generating videos automatically from written scripts or quick social content, drop your text script and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
