---
name: youtube-video-editor-job
version: "1.0.0"
displayName: "YouTube Video Editor — Edit and Export YouTube Videos"
description: >
  Get polished YouTube videos ready to post, without touching a single slider. Upload your raw video footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut dead air, add transitions, and export for YouTube upload", and download 1080p MP4 when it's done. Built for YouTubers who move fast and want fast professional edits without hiring a video editor.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `youtube-video-editor-job` |
