...
version: "1.0.0"
displayName: "Subtitle Video Online — Add Subtitles to Videos Online"
description: >
  Turn a 3-minute tutorial video in MP4 into 1080p captioned video files just by typing what you need. Whether it's adding subtitles to videos online without software or quick social content, drop your video files and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `subtitle-video-online` |
