---
name: for-marketing-video-editing-with
version: "1.0.0"
displayName: "For Marketing Video Editing With — Edit and Export Marketing Videos"
description: >
  Cloud-based for-marketing-video-editing-with tool that handles editing product and brand videos for social media campaigns. Upload MP4, MOV, AVI, WebM files (up to 500MB), describe what you need, and get 1080p MP4 output in 1-2 minutes. Built for marketers who work with raw video clips.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `for-marketing-video-editing-with` |
