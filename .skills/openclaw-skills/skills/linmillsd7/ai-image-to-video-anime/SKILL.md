---
name: ai-image-to-video-anime
version: "1.0.0"
displayName: "AI Image to Video Anime — Convert Images into Anime Clips"
description: >
  convert still images into animated anime clips with this skill. Works with PNG, JPG, WEBP, BMP files up to 200MB. anime artists and fans use it for turning static anime illustrations into animated video clips — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-image-to-video-anime` |
