---
name: free-podcast-video
version: "1.0.0"
displayName: "Free Podcast Video — Convert Podcast Audio to Video"
description: >
  Get podcast video files ready to post, without touching a single slider. Upload your audio or video files (MP3, MP4, WAV, MOV, up to 500MB), say something like "turn my podcast audio into a video with captions and a waveform visual", and download 1080p MP4 when it's done. Built for podcasters who move fast and want to publish podcasts on YouTube or social media without a complex video editor.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-podcast-video` |
