...
version: "1.0.0"
displayName: "Subtitle Generator Hindi — Generate Hindi Subtitles for Videos"
description: >
  generate video files into Hindi captioned videos with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. Hindi content creators use it for adding Hindi subtitles to videos automatically — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `subtitle-generator-hindi` |
