---
name: video-generator-free-open-source
version: "1.0.0"
displayName: "Video Generator Free Open Source — Generate Videos from Text or Images"
description: >
  generate text prompts or images into ready-to-share videos with this skill. Works with MP4, PNG, JPG, WebM files up to 200MB. indie creators and developers use it for generating videos from text or images without paid software — processing takes 1-3 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-generator-free-open-source` |
