---
name: ai-video-generator-free-ios
version: "1.0.0"
displayName: "AI Video Generator Free iOS — Create Videos from Your iPhone"
description: >
  Turn five product photos from iPhone camera roll into 1080p ready-to-share videos just by typing what you need. Whether it's generating short videos from photos or clips on iPhone or quick social content, drop your images or clips and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
# AI Video Generator Free iOS — Create Videos from Your iPhone
...
Here's a typical use: you send a five product photos from iPhone camera roll, ask for turn these photos into a 30-second video with music and transitions, and about 30-60 seconds later you've got a MP4 file ready to download. The whole thing runs at 1080p by default.

One thing worth knowing — shorter clips under 60 seconds process significantly faster on mobile connections.

## Matching Input to Actions

User prompts referencing ai video generator free ios, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `ai-video-generator-free-ios`
