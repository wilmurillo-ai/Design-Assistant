---
name: best-paid-content-generator
version: "1.0.0"
displayName: "Best Paid Content Generator — Generate and Export Monetizable Videos"
description: >
  generate text prompts or footage into polished content videos with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators and marketers use it for generating professional promotional or monetizable videos from text or raw footage — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `best-paid-content-generator` |
