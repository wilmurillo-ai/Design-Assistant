...
version: "1.0.0"
displayName: "Video Editing with OpenClaw — Edit and Export Polished Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — cut the silent pauses, add transitions, and export a clean final cut — and get edited MP4 clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI-assisted video editing automatically. Ideal for content creators and video editors who want fast AI-powered edits without complex software like Premiere or DaVinci.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-openclaw` |
