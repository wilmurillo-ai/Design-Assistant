...
version: "1.0.0"
displayName: "Text to Video Gemini — Generate Videos from Text Prompts"
description: >
  generate text prompts into AI generated videos with this skill. Works with TXT, DOCX, PDF, plain text files up to 500MB. content creators use it for generating short videos from written text descriptions — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
