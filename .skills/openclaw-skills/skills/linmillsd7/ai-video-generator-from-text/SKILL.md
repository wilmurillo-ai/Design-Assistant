---
name: ai-video-generator-from-text
version: "1.0.0"
displayName: "AI Video Generator from Text — Turn Text into Shareable Videos"
description: >
  Cloud-based ai-video-generator-from-text tool that handles generating videos from written scripts or descriptions. Upload TXT, DOCX, PDF, copied text files (up to 500MB), describe what you need, and get 1080p MP4 output in 1-2 minutes. Built for marketers who work with text prompts.
