---
name: free-video-generator-from-script
version: "1.0.0"
displayName: "Free Video Generator from Script — Turn Scripts into Shareable Videos"
description: >
  Get script-based videos ready to post, without touching a single slider. Upload your written script (TXT, DOCX, PDF, plain text, up to 500MB), say something like "turn my script into a video with voiceover and matching visuals", and download 1080p MP4 when it's done. Built for marketers, content creators, educators who move fast and want to produce videos without filming or editing manually.
