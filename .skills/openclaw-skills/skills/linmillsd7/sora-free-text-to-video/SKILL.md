---
name: sora-free-text-to-video
version: "1.0.0"
displayName: "Sora Free Text to Video — Generate Videos From Text Prompts"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, plain text, up to 500MB), say something like "generate a 10-second video of a city street at night with neon lights reflecting on wet pavement", and download 1080p MP4 when it's done. Built for content creators, marketers, social media managers who move fast and want to create videos without cameras, actors, or editing skills.
