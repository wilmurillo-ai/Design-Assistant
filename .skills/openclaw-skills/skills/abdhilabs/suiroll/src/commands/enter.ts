...
import {
  ...
  verifyIdentityToken,
  getAgentFromCredentials,
  formatAgentInfo,
  type MoltbookAgent,
} from '../utils/moltbook.js';
 ...
 */
async function authenticateAgent(): Promise<{ apiKey: string; agent: MoltbookAgent }> {
 ...
 */
export function enterCommand(program: Command): void {
  program
    .command('enter')
    ...
    .action(async (options: {
      ...
      let agentInfo: { apiKey: string; agent: MoltbookAgent };
      let agentId: string;
