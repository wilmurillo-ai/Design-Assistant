...
description: "Analyze Instagram profiles and posts with engagement metrics, view counts, follower ratios, and Reels analytics. Use when: user wants to analyze Instagram data, check engagement rates, or extract Reels information."
homepage: https://clawhub.com
metadata: { "openclaw": { "emoji": "📊", "requires": { "bins": ["python3", "chromium"] } } }
---
