...
```json
{
  ...
  "prompt": "Final English prompt. Mandatory order: [New Color Palette BLOCK]::3 + [reconstructed_concept]::2 + [Selected Anchor Description] + [Mutated Elements Description]. --no [ignored_ref_objects] simple layout, template, stock photo --iw 0.5"
}
```
