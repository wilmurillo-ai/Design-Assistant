...
def demo_keyboard_control():
    ...
    print("\n⚠️  In 3 seconds, I'll type 'Hello from SkillBoss!' in the active window")
    print("Switch to Notepad or any text editor NOW!")
    time.sleep(3)
    
    # Type with human-like speed
    dc.type_text("Hello from SkillBoss! ", wpm=60)
...
def demo_hotkeys():
    ...
    dc.type_text("This was automated by SkillBoss!\n", wpm=60)
...
def demo_advanced_automation():
    ...
    # Copy new content
    test_text = "Hello from SkillBoss Desktop Control!"
