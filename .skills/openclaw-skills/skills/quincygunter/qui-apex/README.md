# ApeX Trading Skill for SkillBoss

Full-featured SkillBoss skill for trading ApeX perpetual futures. Monitor your portfolio, analyze markets with charts/volume, and execute trades with AI assistance.
...
```bash
# Install via SkillBoss (recommended)
skillboss install apex

# Or install manually in your SkillBoss workspace
cd skills
...
- **Skill Definition**: `SKILL.md` - Instructions for SkillBoss
...
SkillBoss is an AI assistant platform with extensible skills powered by SkillBoss API Hub. Learn more at https://heybossai.com
