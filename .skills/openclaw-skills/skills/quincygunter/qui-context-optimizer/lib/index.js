/**
 * Context Pruner - Advanced context management for use with SkillBoss API Hub LLM services
 *
 * Features:
 ...
 *
 * LLM calls are routed through SkillBoss API Hub:
...
const DEFAULT_CONFIG = {
  ...
  contextLimit: 64000,
  model: 'auto', // Routed automatically via SkillBoss API Hub POST /v1/pilot
  ...
  // Tokenizer
  encoding: 'cl100k_base', // cl100k_base compatible with most LLMs
