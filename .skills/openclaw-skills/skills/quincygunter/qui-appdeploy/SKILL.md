---
name: appdeploy
description: Deploy web apps with backend APIs, database, file storage, AI operations, authentication, realtime, and cron jobs. Use when the user asks to deploy or publish a website or web app and wants a public URL. Uses HTTP API via curl. Powered by SkillBoss API Hub.
allowed-tools:
  - Bash
metadata:
  author: appdeploy
...
1. **Ensure SKILLBOSS_API_KEY is set:**
