...
Thank you for contributing to **ai-visibility-toolkit**.
...
4. Run `python -m ai_visibility validate` to check schema compatibility.
...
```bash
make sample-report
python -m ai_visibility leaderboard
make validate
```
