...
name: free-text-to
version: "1.0.0"
displayName: "Free Text to Video — Convert Text into Video Clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn this text into a 30-second promotional video with visuals and music — and get generated video clips back in 1-2 minutes. Upload TXT, DOCX, PDF, copied text files up to 500MB, and the AI handles AI video creation automatically. Ideal for marketers who want to create videos without filming or editing skills.
...
- "generating videos from written descriptions or scripts for marketers"
...
# Free Text to Video — Convert Text into Video Clips
...
One thing worth knowing — shorter, specific prompts produce more accurate video results than vague long paragraphs.

## Matching Input to Actions

User prompts referencing free text to, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
