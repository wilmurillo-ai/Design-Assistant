...
version: "1.0.0"
displayName: "Snapchat Video Maker — Create Snapchat Spotlight and Story Videos with AI"
description: >
  Snapchat Video Maker — Create Snapchat Spotlight and Story Videos with AI.
  ...
  format demands a production style that feels native — raw energy, quick cuts, AR
  overlays, text that looks handwritten — and your polished Instagram assets stick
...
# Snapchat Video Maker — Describe the Snap, Reach Gen Z

No AR studio. No youth marketing agency. No trend-chasing required. Just tell the AI what you want and it happens. "Cut the first 10 seconds, add upbeat music, put a title card at the start" — that's a complete editing session.
