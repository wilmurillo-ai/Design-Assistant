...
version: 1.1.2
displayName: "AI Video Editing for TikTok — Create and Edit TikTok Videos with AI Chat"
description: >
  AI Video Editing for TikTok — Create and Edit TikTok Videos with AI Chat.
  ...
  happens through chat — no timeline dragging, no export settings to memorize.
