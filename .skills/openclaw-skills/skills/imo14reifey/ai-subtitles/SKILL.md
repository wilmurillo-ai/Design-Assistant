...
name: ai-subtitles
version: "1.0.0"
displayName: "AI Subtitles — Generate and Embed Video Captions"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add subtitles in English and Spanish automatically — and get captioned video files back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI subtitle generation automatically. Ideal for YouTubers, content creators, marketers who need accurate captions without manual transcription.
...
# AI Subtitles — Generate and Embed Video Captions
...
A quick example: upload a 3-minute tutorial video in MP4, type "add subtitles in English and Spanish automatically", and you'll get a 1080p MP4 back in roughly 30-60 seconds. All rendering happens server-side.

Worth noting: shorter clips under 5 minutes generate subtitles significantly faster.

## Matching Input to Actions

User prompts referencing ai subtitles, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
