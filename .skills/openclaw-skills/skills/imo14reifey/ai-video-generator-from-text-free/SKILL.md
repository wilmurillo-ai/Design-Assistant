---
name: ai-video-generator-from-text-free
version: "1.0.0"
displayName: "AI Video Generator from Text Free — Generate Videos from Text"
description: >
  generate text prompts into text-based videos with this ai-video-generator-from-text-free skill. Works with TXT, DOCX, PDF, plain text files up to 500MB. marketers, content creators, students use it for generating videos from written scripts or descriptions — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
# AI Video Generator from Text Free — Generate Videos from Text
...
Here's a typical use: you send a a 100-word product description, ask for turn this text into a 30-second explainer video with visuals and voiceover, and about 1-2 minutes later you've got a MP4 file ready to download. The whole thing runs at 1080p by default.

One thing worth knowing — shorter, clearer text prompts produce more accurate video results.

## Matching Input to Actions

User prompts referencing ai video generator from text free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-generator-from-text-free` |
