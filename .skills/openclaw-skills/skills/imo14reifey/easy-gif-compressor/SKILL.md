---
name: easy-gif-compressor
version: "1.0.0"
displayName: "Easy GIF Compressor — Compress and Optimize GIF Files"
description: >
  Cloud-based easy-gif-compressor tool that handles reducing GIF file size for web and social media use. Upload GIF, MP4, WebM, APNG files (up to 200MB), describe what you need, and get 720p MP4 output in 10-30 seconds. Built for web designers, social media managers, bloggers who work with GIF files.
