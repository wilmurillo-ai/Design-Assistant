#!/usr/bin/env python3
"""
Unit tests for agents/agent_nlp.py
...
# ── Tests for agents/agent_nlp.py ──────────────────────────────────────────────────────

class TestAgentNlp:
    """Test suite for agent_nlp."""
    ...
    def test_is_processed(self, mock_sql, mock_ollama):
        ...
        Test: is_processed()
        Source line: 72
        Docstring: Check if a file has already been processed (exists in KnowledgeIndex).
        """
    ...
    def test_get_unprocessed_files(self, mock_sql, mock_ollama):
        ...
        Source line: 78
        Docstring: Find all unprocessed PDF/text files in NLP source dirs.
        """
    ...
    def test_extract_text_from_pdf(self, mock_sql, mock_ollama):
        ...
        Source line: 104
        Docstring: Extract text from a PDF using PyPDF2.
        """
    ...
    def test_chunk_text(self, mock_sql, mock_ollama):
        ...
        Test: chunk_text()
        Source line: 130
        Docstring: Split text into overlapping chunks of ~CHUNK_SIZE words.
...
Returns:
    ...
    def test_process_file(self, mock_sql, mock_ollama):
        ...
        Test: process_file()
        Source line: 153
        Docstring: Process a single file: extract, chunk, summarize, store.
        """
    ...
    def test_run_training_session(self, mock_sql, mock_ollama):
        ...
        Source line: 253
        Docstring: Process the next unprocessed file.
        """
    ...
    def test_review_knowledge_base(self, mock_sql, mock_ollama):
        ...
        Source line: 269
        Docstring: Audit the NLP knowledge base.
        """
    ...
    def test_schedule_daily_training(self, mock_sql, mock_ollama):
        ...
        Source line: 284
        Docstring: Queue a training task if none pending today.
        """
