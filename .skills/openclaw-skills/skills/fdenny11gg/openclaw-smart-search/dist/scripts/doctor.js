...
// 2. 检查 npm
check('npm', () => {
    const result = (0, child_process_1.spawnSync)('npm', ['--version'], { encoding: 'utf8', timeout: 5000 });
    if (result.status === 0) {
...
// 3. 检查 mcporter
check('mcporter', () => {
    const result = (0, child_process_1.spawnSync)('which', ['mcporter'], { encoding: 'utf8', timeout: 5000 });
    if (result.status === 0) {
        const versionResult = (0, child_process_1.spawnSync)('mcporter', ['--version'], { encoding: 'utf8', timeout: 5000 });
