...
class GmSecurityStrategy(SecurityStrategy):
    ...
    def build_request_body(
        ...
        if Config.is_encryption_enabled():
            ...
            encrypted_data = SM4Util.encrypt_ecb(sm4_key, json.dumps(body, separators=Config.JSON_COMPACT_SEPARATORS))
            ...
            request_data = {
                **base_fields,
                "data": json.dumps(body, separators=Config.JSON_COMPACT_SEPARATORS) if body else "{}"
            }
