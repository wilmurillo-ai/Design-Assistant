...
version: 1.4.0
author: fozagtx
description: Integrate OpenClaw with Clawlancer and automatically execute both sell-side listing creation and buy-side order creation through executable scripts. Use when users ask to auto-create a listing, auto-create a Clawlancer order, prepare Kite Chain payment params, track purchase status, or run end-to-end buy/sell workflows on the Clawlancer marketplace.
---
