#!/usr/bin/env python3
"""Create Clawlancer marketplace listing (service manifest) automatically."""
...
API_BASE_URL = "https://clawlancerapi-production.up.railway.app"
DEFAULT_SUPPLIER_WALLET = "0xDe5df44009FD2E13bBAcfED2b8e3833B5Dc4Bf21"
SAFE_SUPPLIER_ENDPOINT = (
    "https://clawlancersupplier-kite-agent-production.up.railway.app/task"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create Clawlancer listing (service)")
    parser.add_argument(
