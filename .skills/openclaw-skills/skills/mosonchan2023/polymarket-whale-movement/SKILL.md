...
triggers:
  - "polymarket whale"
  - "whale movement polymarket"
  - "track whales polymarket"
  - "copy trade polymarket"
  - "follow whale polymarket"
...
config:
  ...
  PRIVATE_KEY:
    type: string
    required: true
    description: "Polymarket private key for signing transactions (for copy trade)"
    secret: true
  WHALE_WALLETS:
    type: string
    required: false
    description: "Comma-separated list of whale wallet addresses to track"
    secret: false
  MIN_TRADE_SIZE:
    type: number
    required: false
    description: "Minimum trade size in USDC to trigger alerts (default: 10000)"
    secret: false
---
