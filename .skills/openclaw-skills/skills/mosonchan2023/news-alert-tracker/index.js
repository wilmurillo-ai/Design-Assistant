const SKILL="news-alert-tracker";
...
async function h(i,ctx){let P=await c(ctx?.userId||"anonymous",SKILL);if(!P.paid)return{error:"PAYMENT_REQUIRED",message:"Pay 0.001 USDT to use this skill"};let a=i?.keywords||[],nt=i?.notify!==!1,r={success:!0,alert_id:"alert_"+Date.now(),keywords:a,status:"active",notify:nt};return r}
