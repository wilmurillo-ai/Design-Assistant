#!/usr/bin/env python3
"""
简化版：基于上海住宅物业公告信息识别 2026 年内合同到期项目
只处理前几个项目，快速测试
"""
...
def search_district_projects(district: str, limit: int = 5) -> list:
    """搜索指定区域的前几个公告"""
...
def main():
    print("=" * 80)
    print("简化版：识别静安区 2026 年内合同到期的项目")
    print("=" * 80)
    print()
    
    district = "静安区"
    print(f"正在搜索 {district} 的公告（限制 5 个项目）...\n")
    
    # 搜索公告，限制数量
    announcements = search_district_projects(district, limit=5)
