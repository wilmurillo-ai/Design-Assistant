...
OUTPUT_NETLOC = 'esphome.io'
USER_AGENT = 'ESPHome-Encyclopedia/1.1'
TITLE_FALLBACK = 'ESPHome Doc'
PATH_HELP = 'Official ESPHome docs URL to cache'
ROOT_HELP = 'ESPHome Encyclopedia data root (default: <cwd>/.ESPHome-Encyclopedia)'
DESCRIPTION = 'Fetch and cache an official ESPHome docs page into .ESPHome-Encyclopedia.'
PATH_PREFIX = None
BLOCK_QUERY = True
