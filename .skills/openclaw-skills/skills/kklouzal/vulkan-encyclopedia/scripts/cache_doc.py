...
ALLOWED_NETLOCS = {'docs.vulkan.org'}
ALLOWED_SCHEMES = {'https'}
OUTPUT_NETLOC = 'docs.vulkan.org'
USER_AGENT = 'Vulkan-Encyclopedia/1.1'
TITLE_FALLBACK = 'Vulkan Doc'
PATH_HELP = 'docs.vulkan.org/spec/latest URL to cache'
ROOT_HELP = 'Vulkan Encyclopedia data root (default: <cwd>/.Vulkan-Encyclopedia)'
DESCRIPTION = 'Fetch and cache a Vulkan docs page into .Vulkan-Encyclopedia.'
PATH_PREFIX = '/spec/latest'
BLOCK_QUERY = True
