...
ALLOWED_NETLOCS = {'kubernetes.io'}
ALLOWED_SCHEMES = {'https'}
OUTPUT_NETLOC = 'kubernetes.io'
USER_AGENT = 'Kubernetes-Encyclopedia/1.1'
TITLE_FALLBACK = 'Kubernetes Doc'
PATH_HELP = 'kubernetes.io docs URL to cache'
ROOT_HELP = 'Kubernetes Encyclopedia data root (default: <cwd>/.Kubernetes-Encyclopedia)'
DESCRIPTION = 'Fetch and cache a Kubernetes docs page into .Kubernetes-Encyclopedia.'
PATH_PREFIX = '/docs'
BLOCK_QUERY = True
