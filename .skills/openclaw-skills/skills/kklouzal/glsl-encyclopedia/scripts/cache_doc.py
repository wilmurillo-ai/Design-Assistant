...
USER_AGENT = 'GLSL-Encyclopedia/1.1'
TITLE_FALLBACK = 'GLSL Doc'
PATH_HELP = 'docs.vulkan.org/glsl/latest URL to cache'
ROOT_HELP = 'GLSL Encyclopedia data root (default: <cwd>/.GLSL-Encyclopedia)'
DESCRIPTION = 'Fetch and cache a GLSL docs page into .GLSL-Encyclopedia.'
PATH_PREFIX = '/glsl/latest'
BLOCK_QUERY = True
