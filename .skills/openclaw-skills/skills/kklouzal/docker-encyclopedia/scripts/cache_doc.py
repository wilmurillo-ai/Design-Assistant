...
OUTPUT_NETLOC = 'docs.docker.com'
USER_AGENT = 'Docker-Encyclopedia/1.1'
TITLE_FALLBACK = 'Docker Doc'
PATH_HELP = 'docs.docker.com URL to cache'
ROOT_HELP = 'Docker Encyclopedia data root (default: <cwd>/.Docker-Encyclopedia)'
DESCRIPTION = 'Fetch and cache a Docker docs page into .Docker-Encyclopedia.'
PATH_PREFIX = None
BLOCK_QUERY = True
