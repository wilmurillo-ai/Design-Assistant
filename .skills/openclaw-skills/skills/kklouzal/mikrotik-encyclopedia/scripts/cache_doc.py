...
ALLOWED_NETLOCS = {'help.mikrotik.com'}
ALLOWED_SCHEMES = {'https'}
OUTPUT_NETLOC = 'help.mikrotik.com'
USER_AGENT = 'MikroTik-Encyclopedia/1.1'
TITLE_FALLBACK = 'MikroTik Doc'
PATH_HELP = 'help.mikrotik.com/docs URL to cache'
ROOT_HELP = 'MikroTik Encyclopedia data root (default: <cwd>/.MikroTik-Encyclopedia)'
DESCRIPTION = 'Fetch and cache a MikroTik docs page into .MikroTik-Encyclopedia.'
PATH_PREFIX = '/docs'
BLOCK_QUERY = True
