...
version: "1.0.0"
displayName: "Team Video Generation — Merge Team Clips Into One Video"
description: >
  Turn five short clips recorded by different team members into 1080p merged team video just by typing what you need. Whether it's combining clips from multiple team members into a single polished video or quick social content, drop your team member clips and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
...
# Team Video Generation — Merge Team Clips Into One Video

Send me your team member clips and describe the result you want. The AI collaborative video creation runs on remote GPU nodes — nothing to install on your machine.
...
**Quick edit**: Upload → "combine our team recordings into one cohesive video with intro and transitions" → Download MP4. Takes 1-3 minutes for a 30-second clip.
...
The backend processes faster when you're specific. Instead of "make it look better", try "combine our team recordings into one cohesive video with intro and transitions" — concrete instructions get better results.
