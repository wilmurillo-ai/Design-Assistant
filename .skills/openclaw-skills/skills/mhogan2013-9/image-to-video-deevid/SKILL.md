---
name: image-to-video-deevid
version: "1.0.0"
displayName: "Image to Video - Deevid — Convert Images into Video Clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn this image into a 5-second animated video clip — and get animated video clips back in 30-60 seconds. Upload JPG, PNG, WEBP, HEIC files up to 200MB, and the AI handles AI video creation automatically. Ideal for content creators, marketers, social media managers who want to bring static images to life without animation skills.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `image-to-video-deevid` |
