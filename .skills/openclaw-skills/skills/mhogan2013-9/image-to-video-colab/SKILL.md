---
name: image-to-video-colab
version: "1.0.0"
displayName: "Image to Video Colab — Convert Images into Video Clips"
description: >
  Get animated video clips ready to post, without touching a single slider. Upload your still images (JPG, PNG, WEBP, GIF, up to 200MB), say something like "animate these images into a smooth video with transitions", and download 1080p MP4 when it's done. Built for content creators and marketers who move fast and want to create videos from photos without complex software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `image-to-video-colab` |
