...
name: ai-song-maker
version: "1.0.0"
displayName: "AI Song Maker — Generate Songs from Text Prompts"
description: >
  Cloud-based ai-song-maker tool that handles generating original songs from text prompts. Upload MP3, WAV, MP4, AAC files (up to 200MB), describe what you need, and get 1080p MP4 output in 1-2 minutes. Built for content creators who work with text or melody.
