...
version: "1.0.0"
displayName: "Infinite Talk AI — Generate looping talking avatar videos"
description: >
  Get talking avatar videos ready to post, without touching a single slider. Upload your images or video (MP4, MOV, JPG, PNG, up to 200MB), say something like "make this photo talk using my voiceover and loop the animation infinitely", and download 1080p MP4 when it's done. Built for content creators, marketers, educators who move fast and want to create lifelike talking head videos without recording on camera.
