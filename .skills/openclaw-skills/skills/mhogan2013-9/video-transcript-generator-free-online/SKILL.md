...
version: "1.0.0"
displayName: "Video Transcript Generator Free Online — Generate Text From Any Video"
description: >
  convert video files into text transcript file with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. students, content creators, journalists use it for extracting spoken text from videos automatically — processing takes 30-90 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-transcript-generator-free-online` |
