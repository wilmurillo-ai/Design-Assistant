---
name: hugging-face-free-video-generation
version: "1.0.0"
displayName: "Hugging Face Free Video Generation — Generate AI Videos From Text"
description: >
  Turn a short text description like 'a fox running through a snowy forest' into 720p AI generated clips just by typing what you need. Whether it's generating short video clips from text prompts for free using Hugging Face models or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
