...
version: "1.0.0"
displayName: "Video Editor Freelance — Edit and Deliver Client Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — cut the pauses, add lower-third titles, and export a clean final cut — and get polished edited clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video editing automatically. Ideal for freelance video editors who want to turn around client edits faster without spending hours in Premiere or DaVinci.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editor-freelance` |
