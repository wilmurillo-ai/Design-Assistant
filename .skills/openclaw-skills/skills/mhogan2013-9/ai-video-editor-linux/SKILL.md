---
name: ai-video-editor-linux
version: "1.0.0"
displayName: "AI Video Editor Linux — Edit and Export Videos Online"
description: >
  Get edited MP4 clips ready to post, without touching a single slider. Upload your raw video footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "trim silences, add transitions, and export a clean final cut", and download 1080p MP4 when it's done. Built for Linux users and open-source creators who move fast and want browser-based AI editing without installing software on Linux.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-editor-linux` |
