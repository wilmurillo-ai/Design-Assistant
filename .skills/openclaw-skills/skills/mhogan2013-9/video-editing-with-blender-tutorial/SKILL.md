---
name: video-editing-with-blender-tutorial
version: "1.0.0"
displayName: "Video Editing with Blender Tutorial — Edit Blender Recordings into Tutorials"
description: >
  edit video clips into edited tutorial videos with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. 3D artists and Blender learners use it for turning Blender screen recordings into structured video tutorials — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-blender-tutorial` |
