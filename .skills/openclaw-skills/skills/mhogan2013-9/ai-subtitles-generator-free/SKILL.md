---
name: ai-subtitles-generator-free
version: "1.0.0"
displayName: "AI Subtitles Generator Free — Auto-Generate and Embed Subtitles"
description: >
  Turn a 3-minute YouTube tutorial video into 1080p captioned video files just by typing what you need. Whether it's adding auto-generated subtitles to videos or quick social content, drop your video files and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
# AI Subtitles Generator Free — Auto-Generate and Embed Subtitles
...
Say you have a 3-minute YouTube tutorial video and want to generate subtitles in English and add them to my video — the backend processes it in about 30-60 seconds and hands you a 1080p MP4.

Tip: shorter clips under 5 minutes generate subtitles significantly faster.

## Matching Input to Actions

User prompts referencing ai subtitles generator free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `ai-subtitles-generator-free`
