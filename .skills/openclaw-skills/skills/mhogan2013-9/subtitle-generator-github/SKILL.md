...
version: "1.0.0"
displayName: "Subtitle Generator — Generate and Embed Video Subtitles"
description: >
...
# Subtitle Generator — Generate and Embed Video Subtitles
...
One thing worth knowing — shorter clips under 2 minutes produce subtitles fastest and most accurately.
...
**Quick edit**: Upload → "generate accurate subtitles and export as a captioned video" → Download MP4. Takes 30-60 seconds for a 30-second clip.
...
The backend processes faster when you're specific. Instead of "make it look better", try "generate accurate subtitles and export as a captioned video" — concrete instructions get better results.
