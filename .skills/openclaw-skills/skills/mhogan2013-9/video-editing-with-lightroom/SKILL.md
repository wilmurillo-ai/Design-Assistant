---
name: video-editing-with-lightroom
version: "1.0.0"
displayName: "Video Editing with Lightroom — Color Grade and Export Videos"
description: >
  edit video clips into color graded videos with this skill. Works with MP4, MOV, AVI, MKV files up to 500MB. photographers and content creators use it for applying Lightroom-style color grading and tone adjustments to video footage — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-lightroom` |
