---
name: jupiter-ai-text-to-video
version: "1.0.0"
displayName: "Jupiter AI Text to Video — Generate Videos from Text Prompts"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, plain text, up to 500MB), say something like "turn this script into a 30-second cinematic video with background music", and download 1080p MP4 when it's done. Built for marketers, content creators, social media managers who move fast and want to create videos without cameras, actors, or editing software.
