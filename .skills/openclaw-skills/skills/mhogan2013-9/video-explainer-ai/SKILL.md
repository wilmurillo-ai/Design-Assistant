...
version: "1.0.0"
displayName: "Video Explainer AI — Generate Explainer Videos from Scripts"
description: >
  Turn a 300-word product explanation script into 1080p narrated explainer videos just by typing what you need. Whether it's creating explainer videos from scripts or topics using AI or quick social content, drop your topic or script and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
