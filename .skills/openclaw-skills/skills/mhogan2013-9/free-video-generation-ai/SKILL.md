...
version: "1.0.0"
displayName: "Free Video Generation AI — Generate Videos from Text Prompts"
description: >
  generate text prompts into AI generated videos with this free-video-generation-ai skill. Works with MP4, MOV, WebM, GIF files up to 500MB. content creators use it for generating short videos from text prompts without a camera — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
# Free Video Generation AI — Generate Videos from Text Prompts
...
The backend processes faster when you're specific. Instead of "make it look better", try "generate a 30-second video clip of a city timelapse from my text prompt" — concrete instructions get better results.
...
**Quick edit**: Upload → "generate a 30-second video clip of a city timelapse from my text prompt" → Download MP4. Takes 1-2 minutes for a 30-second clip.
