...
version: "1.0.0"
displayName: "To Maker Generator — Convert Clips Into Finished Videos"
description: >
  Turn a 60-second raw clip or series of short recordings into 1080p finished video files just by typing what you need. Whether it's converting raw clips into polished videos automatically or quick social content, drop your raw video clips and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `to-maker-generator` |
