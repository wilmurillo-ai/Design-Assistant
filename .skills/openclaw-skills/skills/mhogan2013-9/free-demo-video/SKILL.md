---
name: free-demo-video
version: "1.0.0"
displayName: "Free Demo Video — Create and Export Demo Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the intro, add captions, and export a clean demo video — and get polished demo video back in 30-60 seconds. Upload MP4, MOV, WebM, AVI files up to 500MB, and the AI handles AI demo creation automatically. Ideal for marketers who want a quick demo video without hiring an editor or learning complex tools.
