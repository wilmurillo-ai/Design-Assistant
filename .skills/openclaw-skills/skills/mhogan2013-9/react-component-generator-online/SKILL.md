...
version: "1.0.0"
displayName: "React Component Generator Online — Generate React Components From Text"
description: >
  Get coded component videos ready to post, without touching a single slider. Upload your component description text (MP4, MOV, AVI, WebM, up to 200MB), say something like "generate a React button component with hover states and TypeScript props", and download 1080p MP4 when it's done. Built for frontend developers who move fast and want to scaffold React components quickly without writing boilerplate manually.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `react-component-generator-online` |
