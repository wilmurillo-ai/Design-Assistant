---
name: video-compressor-github
version: "1.0.0"
displayName: "Video Compressor — Compress and Export Smaller Videos"
description: >
  Get compressed MP4 files ready to post, without touching a single slider. Upload your large video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "compress this video to under 50MB without losing too much quality", and download 1080p MP4 when it's done. Built for developers, content creators, students who move fast and want to shrink video files quickly without coding a script.
