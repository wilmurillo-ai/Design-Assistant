---
name: deepseek-text-tovideo
version: "1.0.0"
displayName: "DeepSeek Text to Video — Generate Videos From Text Prompts"
description: >
  Turn a two-sentence scene description into 1080p AI generated videos just by typing what you need. Whether it's generating videos from written text descriptions or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
