---
name: objectremover-video
version: "1.0.0"
displayName: "Object Remover Video — Remove Objects from Video Clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — remove the car parked in the background from the entire video — and get clean edited clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI object removal automatically. Ideal for content creators who want to remove distracting elements without complex video editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `objectremover-video` |
