...
version: "1.0.0"
displayName: "Music Generator Free — Generate Free AI Music Tracks"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a free background music track for my video with an upbeat, energetic vibe — and get AI music tracks back in 20-40 seconds. Upload MP4, MOV, MP3, WAV files up to 200MB, and the AI handles AI music generation automatically. Ideal for content creators, YouTubers, TikTok creators who need royalty-free background music without paying for a subscription.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `music-generator-free` |
