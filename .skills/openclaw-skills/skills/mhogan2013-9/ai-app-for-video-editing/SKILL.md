---
name: ai-app-for-video-editing
version: "1.0.0"
displayName: "AI App for Video Editing — Edit and Export Polished Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the pauses, add background music, and export as a short reel — and get edited video clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI-powered video editing automatically. Ideal for content creators and marketers who want quick edits without learning complex software like Premiere.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-app-for-video-editing` |
