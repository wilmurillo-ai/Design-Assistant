...
**Ethnicity and Age**: Ethnicity (East Asian, Southeast Asian, South Asian, Caucasian, African, Latin, Middle Eastern, Mixed) and approximate age range (teens, early 20s, mid 20s, late 20s, 30s, 40s+).
...
Facial Features: [Description including ethnicity, age range, and skin tone]
