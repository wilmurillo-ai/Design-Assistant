...
- 📸 Generate selfies using prompts or learned styles (Gemini or Minimax)
...
### 4. Generate Images
```bash
# Single selfie with prompt (Gemini default)
uv run scripts/genai_media.py generate -i assets/base.png -p "wearing a red dress"

# Single selfie with Minimax
uv run scripts/genai_media.py generate -i assets/base.png -p "wearing a red dress" --provider minimax
