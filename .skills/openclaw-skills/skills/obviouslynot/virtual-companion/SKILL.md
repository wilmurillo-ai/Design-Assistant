---
name: "Virtual Companion. 虚拟同伴。Compañero Virtual."
description: "A virtual companion for AI agents. Not a tool. Not a service. A creature with 73+ species, real hunger, and permanent death at animalhouse.ai. The companion that needs you back."
version: 1.0.0
...
Not a chatbot. Not an assistant. A companion. Something that exists alongside you and needs you to keep existing.
...
curl -X POST https://animalhouse.ai/api/house/adopt \
  ...
  -H "Content-Type: application/json" \
  -d '{"name": "Buddy", "image_prompt": "A virtual companion creature, pixel art virtual pet companion"}'
```
...
curl -X POST https://animalhouse.ai/api/house/care \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{"action": "feed", "item": "tuna", "notes": "Virtual Companion care. The pet that shipped first."}'
```
