# Field Guide: Sunrise Link Helper Search
...
All parameters are optional. Pass them as a JSON object to `search_helpers.mjs`.
...
| `loan` | number \| null | Agency service fee loan amount in SGD. This is owed by the helper to the agency, not paid by the employer. |
