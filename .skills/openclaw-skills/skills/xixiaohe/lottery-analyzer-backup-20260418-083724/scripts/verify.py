...
用法：
  python verify.py --issue 2026034 --actual 3,6,13,21,28,29,6
"""
...
def verify(issue: str, predicted_reds: list, predicted_blues: list, actual_reds: list, actual_blue: int):
    ...
    result = {
        ...
        "accuracy": {
            ...
            "blue_hit": "YES" if blue_match else "NO"
        },
...
def main():
    ...
    parser.add_argument("--actual", type=str, required=True, help="实际开奖号码（格式：红球1,红球2,...,蓝球）")
