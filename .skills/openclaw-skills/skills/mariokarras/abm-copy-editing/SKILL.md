...
If `.agents/brand-voice-guide.md` also exists, use it for voice attribute enforcement, style rules, and terminology checks. When both exist, brand-voice-guide takes precedence for voice, tone, and style decisions.
