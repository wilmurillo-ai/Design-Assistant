...
If `.agents/brand-voice-guide.md` also exists, read it for voice attributes, tone guidance, and brand voice guidelines. When both exist, brand-voice-guide takes precedence for voice, tone, and style decisions.
