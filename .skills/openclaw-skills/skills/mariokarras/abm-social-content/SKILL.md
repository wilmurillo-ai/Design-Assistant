...
If `.agents/brand-voice-guide.md` also exists, read it for voice attributes, tone guidance, and platform-specific style rules. When both exist, brand-voice-guide takes precedence for voice, tone, and style decisions.
