import { getStation, type Campus, type ZhuhaiStationKey } from "./routes.js";
import type { ApiResponse, LineListData, LineListRequest } from "./types.js";
...
export async function fetchLineList(params: {
  ...
  const json = (await response.json()) as ApiResponse<LineListData>;
