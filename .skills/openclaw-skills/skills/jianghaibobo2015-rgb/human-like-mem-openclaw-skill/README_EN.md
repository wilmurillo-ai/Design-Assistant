...
```bash
cd ~/.openclaw/workspace/skills/human-like-memory
...
```bash
bash ~/.openclaw/workspace/skills/human-like-memory/scripts/setup.sh
```
...
1. Visit [https://human-like.me](https://human-like.me)
...
| `HUMAN_LIKE_MEM_BASE_URL` | No | `https://human-like.me` | API endpoint |
