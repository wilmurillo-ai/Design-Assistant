...
DEFAULT_CLASSIFICATION = {
    "基础体验和基建": [
        {"name": "Claw 基础设施", "repo_keywords": ["claw", "workspace"], "mr_keywords": ["backup", "备份", "恢复", "供应商", "腾讯云", "火山", "tencent", "volc", "创建机器"], "label_keywords": []},
        ...
        {"name": "权限与配置", "repo_keywords": ["auth", "config", "secret"], "mr_keywords": ["权限", "配置", "download", "proxy", "rewrite"], "label_keywords": []},
        {"name": "客户端体验", "repo_keywords": ["client", "mobile", "ios", "android", "frontend"], "mr_keywords": ["ui", "ux", "交互", "体验"], "label_keywords": []},
    ],
    "用户和商业化": [
        {"name": "账号与登录", "repo_keywords": ["account", "auth", "passport"], "mr_keywords": ["账号", "邮箱", "登录", "注册", "验证", "vest"], "label_keywords": []},
        {"name": "订阅与计费", "repo_keywords": ["billing", "payment", "subscription"], "mr_keywords": ["billing", "计费", "订阅", "套餐", "支付", "rate limit", "按量"], "label_keywords": []},
        {"name": "管理后台", "repo_keywords": ["admin", "console"], "mr_keywords": ["admin", "后台", "管理台", "审批", "restartinstance", "recreatebot", "bot"], "label_keywords": []},
    ...
    "Chat 核心链路": [
        ...
        {"name": "Agent 与插件", "repo_keywords": ["agent", "plugin", "mcp"], "mr_keywords": ["agent", "plugin", "插件", "tool", "工具", "wecom", "企业微信", "快捷指令", "技能", "workflow", "claw"], "label_keywords": []},
...
REPO_CATEGORY_OVERRIDES = {
    "billing": ("用户和商业化", "订阅与计费"),
    "payment": ("用户和商业化", "订阅与计费"),
    "growth": ("用户和商业化", "用户运营"),
    "marketing": ("用户和商业化", "用户运营"),
    "retention": ("用户和商业化", "用户运营"),
    "account": ("用户和商业化", "账号与登录"),
    "auth": ("用户和商业化", "账号与登录"),
    "admin": ("用户和商业化", "管理后台"),
    "console": ("用户和商业化", "管理后台"),
    "chat": ("Chat 核心链路", "会话管理"),
    "conversation": ("Chat 核心链路", "会话管理"),
    "message": ("Chat 核心链路", "消息收发"),
    "memory": ("Chat 核心链路", "上下文与记忆"),
    "agent": ("Chat 核心链路", "Agent 与插件"),
    "mcp": ("Chat 核心链路", "Agent 与插件"),
    "llm": ("Chat 核心链路", "模型与推理"),
    "model": ("Chat 核心链路", "模型与推理"),
    "infra": ("基础体验和基建", "Claw 基础设施"),
    "ci": ("基础体验和基建", "Claw 基础设施"),
    "monitor": ("基础体验和基建", "稳定性与监控"),
    "otel": ("基础体验和基建", "稳定性与监控"),
    "security": ("基础体验和基建", "权限与配置"),
    "config": ("基础体验和基建", "权限与配置"),
    "frontend": ("基础体验和基建", "客户端体验"),
    "mobile": ("基础体验和基建", "客户端体验"),
    "cdn": ("基础体验和基建", "CDN/网络"),
}
...
def load_rule_config(root_dir: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "default_category": {"category": "基础体验和基建", "subcategory": "Claw 基础设施"},
        "repo_rules": [],
        "keyword_rules": [],
    }
...
def classification_score_from_matrix(mr: dict[str, Any], classification: dict[str, list[dict[str, Any]]]) -> tuple[str, str, str, int]:
    ...
    if not best or best[0] <= 0:
        return "基础体验和基建", "Claw 基础设施", "fallback", 0
