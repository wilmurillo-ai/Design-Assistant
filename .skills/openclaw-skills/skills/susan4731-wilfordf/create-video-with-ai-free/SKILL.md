---
name: create-video-with-ai-free
version: "1.0.0"
displayName: "Create Video with AI Free — Generate Videos from Your Content"
description: >
  Cloud-based create-video-with-ai-free tool that handles generating videos from images or clips without editing software. Upload MP4, MOV, JPG, PNG files (up to 500MB), describe what you need, and get 1080p MP4 output in 1-2 minutes. Built for content creators and small business owners who work with images or clips.
...
# Create Video with AI Free — Generate Videos from Your Content
...
A quick example: upload five product photos and a logo file, type "turn these images into a 30-second promo video with music and text", and you'll get a 1080p MP4 back in roughly 1-2 minutes. All rendering happens server-side.

Worth noting: using fewer than ten images speeds up generation noticeably.

## Matching Input to Actions

User prompts referencing create video with ai free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `create-video-with-ai-free`
