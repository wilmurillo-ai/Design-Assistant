...
version: "1.0.0"
displayName: "Screen Recording Editor Online — Edit and Export Screen Recordings"
description: >
  Get edited screen recordings ready to post, without touching a single slider. Upload your screen recording files (MP4, MOV, WebM, AVI, up to 500MB), say something like "trim the pauses, add captions, and insert a title card at the start", and download 1080p MP4 when it's done. Built for educators, developers, and content creators who move fast and want to clean up screen recordings without learning complex editing software.
