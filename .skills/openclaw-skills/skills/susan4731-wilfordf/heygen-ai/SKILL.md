...
name: heygen-ai
version: "1.0.0"
displayName: "HeyGen AI — Create AI Avatar Presenter Videos"
description: >
  marketers generate text or images into AI avatar videos using this skill. Accepts MP4, MOV, JPG, PNG up to 500MB, renders on cloud GPUs at 1080p, and returns MP4 files in 1-2 minutes. Designed for creating spokesperson videos without filming.
