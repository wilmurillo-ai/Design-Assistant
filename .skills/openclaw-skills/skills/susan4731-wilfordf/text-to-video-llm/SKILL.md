---
name: text-to-video-llm
version: "1.0.0"
displayName: "Text to Video LLM — Generate Videos from Text Prompts"
description: >
  generate text prompts into AI generated videos with this skill. Works with TXT, DOCX, PDF, plain text files up to 500MB. marketers, content creators, developers use it for generating videos from written text descriptions — processing takes 1-3 minutes on cloud GPUs and you get 1080p MP4 files.
...
# Text to Video LLM — Generate Videos from Text Prompts
...
Say you have a two-sentence scene description and want to generate a 30-second video of a sunset over a city skyline with cinematic camera movement — the backend processes it in about 1-3 minutes and hands you a 1080p MP4.

Tip: shorter, more specific prompts produce more accurate and consistent results.

## Matching Input to Actions

User prompts referencing text to video llm, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `text-to-video-llm`
