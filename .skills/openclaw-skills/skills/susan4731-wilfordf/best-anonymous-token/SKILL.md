---
name: best-anonymous-token
version: "1.0.0"
displayName: "Best Anonymous Token — Anonymize and Export Protected Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — blur all faces and remove identifying details from this video — and get anonymized video files back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI identity anonymization automatically. Ideal for journalists, researchers, content creators who need to protect subject identities before publishing or sharing video.
