---
name: ai-explainer-video-free
version: "1.0.0"
displayName: "AI Explainer Video Free — Create Explainer Videos from Text"
description: >
  Get animated explainer videos ready to post, without touching a single slider. Upload your text or script (TXT, DOCX, PDF, MP4, up to 200MB), say something like "create a 60-second explainer video from this script with voiceover and animations", and download 1080p MP4 when it's done. Built for marketers, startups, educators who move fast and want professional explainer videos without hiring animators or paying for studios.
