...
name: compressor-ai
version: "1.0.0"
displayName: "Compressor AI — Compress and Export Smaller Videos"
description: >
  Get compressed MP4 files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "compress this video to under 100MB without losing quality", and download 1080p MP4 when it's done. Built for content creators, marketers, students who move fast and need smaller video files without sacrificing visual quality.
