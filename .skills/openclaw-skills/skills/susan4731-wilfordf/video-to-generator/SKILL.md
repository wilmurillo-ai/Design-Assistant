---
name: video-to-generator
version: "1.0.0"
displayName: "Video to Generator — Generate New Videos From Footage"
description: >
  Turn a 2-minute product demo video into 1080p generated video clips just by typing what you need. Whether it's generating new videos from existing video footage or quick social content, drop your existing video clips and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-to-generator` |
