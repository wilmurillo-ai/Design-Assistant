---
name: free-maker-editing
version: "1.0.0"
displayName: "Free Maker Editing — Edit and Export Videos Free"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the pauses, add background music, and export as MP4 — and get edited MP4 clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles free AI video editing automatically. Ideal for content creators who want quick edits without paying for professional tools.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-maker-editing` |
