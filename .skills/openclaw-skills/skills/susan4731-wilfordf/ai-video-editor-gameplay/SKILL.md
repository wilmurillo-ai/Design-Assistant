...
version: "1.0.0"
displayName: "AI Video Editor Gameplay — Edit and Export Gameplay Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — cut out the slow parts, add highlight transitions, and sync clips to the beat — and get edited gameplay clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI gameplay editing automatically. Ideal for gaming content creators who want fast highlight edits without learning complex video software.
