...
name: ai-demo-video
version: "1.0.0"
displayName: "AI Demo Video — Create and Export Demo Videos"
description: >
  create product footage into polished demo videos with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. marketers use it for turning raw screen recordings into product demo videos — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
