---
name: youtube-video-editor-fiverr
version: "1.0.0"
displayName: "YouTube Video Editor — Edit and Export YouTube Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim dead air, add transitions, and sync background music to cuts — and get polished YouTube videos back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video editing automatically. Ideal for YouTubers who want quick professional edits without hiring or learning complex software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `youtube-video-editor-fiverr` |
