---
name: media-copywriter-generator
version: "1.0.0"
displayName: "Media Copywriter Generator — Generate Copy for Videos"
description: >
  generate video clips or images into copy-enhanced videos with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. marketers use it for generating ad copy and captions for marketing videos — processing takes 20-40 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `media-copywriter-generator` |
