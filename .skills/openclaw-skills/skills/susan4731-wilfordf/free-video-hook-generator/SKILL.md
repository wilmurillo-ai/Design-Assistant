---
name: free-video-hook-generator
version: "1.0.0"
displayName: "Free Video Hook Generator — Generate Hooks for Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate 5 attention-grabbing opening hooks for my fitness tutorial video — and get hook-ready video clips back in 20-40 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI hook generation automatically. Ideal for TikTok creators, YouTubers, marketers who want scroll-stopping intros without writing skills or editing experience.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-video-hook-generator` |
