---
name: video-editing-with-best
version: "1.0.0"
displayName: "Video Editing With Best — Edit and Export Polished Videos"
description: >
  Cloud-based video-editing-with-best tool that handles editing raw footage into professional-looking videos quickly. Upload MP4, MOV, AVI, WebM files (up to 500MB), describe what you need, and get 1080p MP4 output in 1-2 minutes. Built for content creators and marketers who work with raw video footage.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-best` |
