---
name: photo-video-maker-fast
version: "1.0.0"
displayName: "Photo Video Maker Fast — Turn Photos Into Shareable Videos"
description: >
  turn photos and images into polished slideshow video with this photo-video-maker-fast skill. Works with JPG, PNG, HEIC, WEBP files up to 200MB. social media creators and casual users use it for turning photo collections into shareable videos quickly — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
# Photo Video Maker Fast — Turn Photos Into Shareable Videos
...
One thing worth knowing — fewer photos per video means faster processing and tighter pacing.

## Matching Input to Actions

User prompts referencing photo video maker fast, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `photo-video-maker-fast`
