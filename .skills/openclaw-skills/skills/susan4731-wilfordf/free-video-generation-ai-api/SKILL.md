---
name: free-video-generation-ai-api
version: "1.0.0"
displayName: "Free Video Generation AI API — Generate Videos from Text Prompts"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a 15-second video clip from a text prompt via API call — and get AI-generated videos back in 30-90 seconds. Upload MP4, MOV, WebM, GIF files up to 500MB, and the AI handles AI video generation automatically. Ideal for developers and indie makers who want to build video generation into their apps without paying for API access upfront.
