...
version: "1.0.0"
displayName: "Video Compressor Online Free — Compress and Download Smaller Videos"
description: >
  Get compressed MP4 files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "compress this video to under 50MB without losing too much quality", and download 1080p MP4 when it's done. Built for students, content creators, everyday users who move fast and want to shrink large video files quickly without installing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-compressor-online-free` |
