---
name: free-text-to-video-create
version: "1.0.0"
displayName: "Free Text to Video Create — Generate Videos from Written Text"
description: >
  create text prompt into AI-generated videos with this skill. Works with TXT, DOCX, PDF, copied text files up to 500MB. marketers use it for generating videos from written content without recording footage — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
