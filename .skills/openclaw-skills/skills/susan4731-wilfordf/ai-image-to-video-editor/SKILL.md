---
name: ai-image-to-video-editor
version: "1.0.0"
displayName: "AI Image to Video Editor — Convert Images into Shareable Videos"
description: >
  Get animated video clips ready to post, without touching a single slider. Upload your images (JPG, PNG, WEBP, HEIC, up to 200MB), say something like "turn these images into a 30-second video with transitions and background music", and download 1080p MP4 when it's done. Built for social media creators who move fast and want to create videos from photos without complex editing software.
