---
name: ai-video-editor-no-login
version: "1.0.0"
displayName: "AI Video Editor No Login — Edit and Export Videos Instantly"
description: >
  Turn a 2-minute screen recording or phone video into 1080p edited MP4 files just by typing what you need. Whether it's editing videos instantly without creating an account or quick social content, drop your raw video clips and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-editor-no-login` |
