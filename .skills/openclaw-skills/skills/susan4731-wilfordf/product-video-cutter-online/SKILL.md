---
name: product-video-cutter-online
version: "1.0.0"
displayName: "Product Video Cutter Online — Cut and Export Product Clips"
description: >
  Get trimmed product clips ready to post, without touching a single slider. Upload your product video footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut out the intro and trim the clip to 30 seconds for Instagram", and download 1080p MP4 when it's done. Built for e-commerce marketers who move fast and want to trim product footage quickly without video editing software.
