---
name: ai-video-maker-free-browser
version: "1.0.0"
displayName: "AI Video Maker Free Browser — Create and Export Videos Online"
description: >
  Get finished MP4 videos ready to post, without touching a single slider. Upload your video clips or images (MP4, MOV, JPG, PNG, up to 500MB), say something like "turn these images into a 30-second promotional video with music and text", and download 1080p MP4 when it's done. Built for content creators and marketers who move fast and want to make videos quickly in a browser without downloading any app.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-maker-free-browser` |
