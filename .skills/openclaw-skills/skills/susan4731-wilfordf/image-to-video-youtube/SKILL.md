---
name: image-to-video-youtube
version: "1.0.0"
displayName: "Image to Video for YouTube — Convert Photos into YouTube Videos"
description: >
  Get YouTube-ready video ready to post, without touching a single slider. Upload your images (JPG, PNG, WEBP, HEIC, up to 200MB), say something like "turn my photos into a YouTube video with transitions and background music", and download 1080p MP4 when it's done. Built for YouTubers who move fast and want to create YouTube videos from photos without editing software.
