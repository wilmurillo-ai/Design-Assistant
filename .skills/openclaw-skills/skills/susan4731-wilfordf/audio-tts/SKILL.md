...
name: audio-tts
version: "1.0.0"
displayName: "Audio TTS — Convert Text to Voiceover Video"
description: >
  convert text or script into voiced video clips with this skill. Works with TXT, DOCX, PDF, SRT files up to 200MB. content creators, marketers, educators use it for generating AI voiceovers from written scripts — processing takes 20-40 seconds on cloud GPUs and you get 1080p MP4 files.
