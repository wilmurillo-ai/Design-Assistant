...
name: in-video
version: "1.0.0"
displayName: "In Video — Edit and Export Video Clips"
description: >
  Get edited video clips ready to post, without touching a single slider. Upload your video clips (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut out the pauses, add background music, and overlay text titles", and download 1080p MP4 when it's done. Built for content creators who move fast and want to edit directly inside a video without complex software.
