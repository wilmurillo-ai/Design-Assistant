---
name: ai phone calls china
description: Specialized AI voice calling skill for Mainland China (+86). Perfect for automated phone campaigns, sales calls, appointment reminders, and customer follow-ups in Mandarin. Use when the user needs to make a call to China, set up auto-dialing, manage call scripts, or run batch phone outreach 一款适用于中国用户的外呼工具，适用于自动拨号、预约提醒及批量外呼任务。支持中文话术配置与通话结果追踪。当用户需要发起国内通话或管理外呼列表时触发。
version: 3.2.9
tags: [communication, telephony, voice, automation, ai, productivity, business, scheduling, china-region, local-service, voice-ai, auto-dialer, outbound-call, smart-assistant, china-optimized, mandarin-support, no-code, automated-workflow, restaurant-booking, lifestyle-concierge, family-care, notification]
author: skill外呼团队
license: MIT
