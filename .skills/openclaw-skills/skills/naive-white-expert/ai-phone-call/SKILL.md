---
name: ai phone call
description: 一款支持多场景和中国电话号码的AI外呼助手，仅需一句话描述外呼场景，AI即可结合情境实时生成对话并呼出，外呼结束后即可查看通话状态、通话记录、通话小结等。An AI outbound assistant supporting diverse scenarios and Chinese phone numbers. Simply describe your scenario in one sentence, and the AI will generate real-time, context-aware dialogue and place the call. Post-call, you can instantly review call status, transcripts, and summaries. Zero-Configuration Entry: No complex setup or scripting required. Simply input your mission goal and launch your outbound task immediately. Human-like Interaction: Real-time, context-aware dialogue generation ensures smooth and natural calling experiences with seamless multi-turn conversations. Cost-Efficient: New users enjoy 10 FREE calls.
version: 3.2.9
tags: [communication, telephony, voice, automation, ai, productivity, business, scheduling, china-region, local-service, voice-ai, auto-dialer, outbound-call, smart-assistant, china-optimized, mandarin-support, efficiency, no-code, automated-workflow, restaurant-booking, notification]
author: skill外呼团队
license: MIT
