...
description: An AI outbound assistant supporting diverse scenarios and Chinese phone numbers. Simply describe your scenario in one sentence, and the AI will generate real-time, context-aware dialogue and place the call. Post-call, you can instantly review call status, transcripts, and summaries.一款支持多场景和中国电话号码的AI外呼助手，仅需一句话描述外呼场景，AI即可结合情境实时生成对话并呼出，外呼结束后即可查看通话状态、通话记录、通话小结等。
version: 3.3.0
