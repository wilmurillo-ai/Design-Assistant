"""
china-beauty-sourcing - OpenClaw skill for China beauty industry intelligence
...
def get_industry_overview() -> Dict:
    """Return overview of China's beauty industry scale and targets."""
    return BEAUTY_DATA.get("industry_overview", {})

def get_supply_chain_structure() -> Dict:
    """Return the complete beauty products supply chain structure."""
    return BEAUTY_DATA.get("supply_chain_structure", {})
...
def get_regional_clusters(region: Optional[str] = None) -> Union[List[Dict], Dict]:
    ...
    """
    clusters = BEAUTY_DATA.get("regional_clusters", [])
...
def find_clusters_by_specialization(specialization: str) -> List[Dict]:
    """Find clusters that specialize in a given beauty product type."""
...
def get_subsector_info(subsector: str) -> Dict:
    """Return detailed information about a specific beauty subsector."""
    subsectors = BEAUTY_DATA.get("subsector_details", {})
    ...
    # Keyword mapping for common beauty terms
    keyword_mapping = {
        "skin": "skincare",
        "cream": "skincare",
        "serum": "skincare",
        ...
        "lipstick": "color_cosmetics",
        "foundation": "color_cosmetics",
        "hair": "hair_care",
        "shampoo": "hair_care",
        "body": "body_care",
        "lotion": "body_care",
...
def get_sourcing_guide() -> Dict:
    ...
    guide = BEAUTY_DATA.get("sourcing_guide", {})
...
def get_glossary(term: Optional[str] = None) -> Union[Dict, str]:
    ...
    glossary = BEAUTY_DATA.get("glossary", {})
...
def search_data(query: str) -> List[Dict]:
    ...
    for cluster in BEAUTY_DATA.get("regional_clusters", []):
    ...
    for subsector_name, subsector_data in BEAUTY_DATA.get("subsector_details", {}).items():
...
def get_metadata() -> Dict:
    ...
    return BEAUTY_DATA.get("metadata", {})

# --- If run directly, provide interactive example ---
if __name__ == "__main__":
    print("💄 China Beauty Sourcing Skill (CLI Test Mode)")
    print("=" * 60)
    ...
    print('  find_clusters_by_specialization("skincare")')
    print('  get_subsector_info("color_cosmetics")')