"""
china-furniture-sourcing - OpenClaw skill for China furniture industry intelligence
...
def get_industry_overview() -> Dict:
    """Return overview of China's furniture industry scale and targets."""
    return FURNITURE_DATA.get("industry_overview", {})

def get_supply_chain_structure() -> Dict:
    """Return the complete furniture supply chain structure."""
    return FURNITURE_DATA.get("supply_chain_structure", {})
...
def get_regional_clusters(region: Optional[str] = None) -> Union[List[Dict], Dict]:
    ...
    """
    clusters = FURNITURE_DATA.get("regional_clusters", [])
...
def find_clusters_by_specialization(specialization: str) -> List[Dict]:
    """Find clusters that specialize in a given furniture type."""
...
def get_subsector_info(subsector: str) -> Dict:
    """Return detailed information about a specific furniture subsector."""
    subsectors = FURNITURE_DATA.get("subsector_details", {})
    ...
    # Keyword mapping for common furniture terms
    keyword_mapping = {
        "sofa": "residential_furniture",
        "bed": "residential_furniture",
        "wardrobe": "residential_furniture",
        "dining": "residential_furniture",
        "desk": "office_furniture",
        "chair": "office_furniture",
        "office chair": "office_furniture",
        "hotel": "hotel_furniture",
        "outdoor": "outdoor_furniture",
        "garden": "outdoor_furniture",
        "patio": "outdoor_furniture",
        "custom": "custom_furniture",
        "built-in": "custom_furniture",
        "kitchen cabinet": "custom_furniture",
        "child": "children_furniture",
        "kids": "children_furniture",
        "mattress": "mattresses"
    }
...
def get_sourcing_guide() -> Dict:
    ...
    guide = FURNITURE_DATA.get("sourcing_guide", {})
...
def get_glossary(term: Optional[str] = None) -> Union[Dict, str]:
    ...
    glossary = FURNITURE_DATA.get("glossary", {})
...
def search_data(query: str) -> List[Dict]:
    ...
    for cluster in FURNITURE_DATA.get("regional_clusters", []):
    ...
    for subsector_name, subsector_data in FURNITURE_DATA.get("subsector_details", {}).items():
...
def get_metadata() -> Dict:
    ...
    return FURNITURE_DATA.get("metadata", {})

# --- If run directly, provide interactive example ---
if __name__ == "__main__":
    print("🛋️ China Furniture Sourcing Skill (CLI Test Mode)")
    print("=" * 60)
    ...
    print('  find_clusters_by_specialization("office chair")')
    print('  get_subsector_info("office_furniture")')