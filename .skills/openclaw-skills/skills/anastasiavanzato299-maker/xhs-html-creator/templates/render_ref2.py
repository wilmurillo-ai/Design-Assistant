...
pages = [
    ('ref2_封面.html',    '模仿ref2_01_封面.png'),
    ('ref2_宝宝产房篇.html', '模仿ref2_02_宝宝产房篇.png'),
    ('ref2_妈妈产房篇.html', '模仿ref2_03_妈妈产房篇.png'),
    ('ref2_宝宝住院篇.html', '模仿ref2_04_宝宝住院篇.png'),
    ('ref2_妈妈住院篇.html', '模仿ref2_05_妈妈住院篇.png'),
    ('ref2_结尾.html',    '模仿ref2_06_结尾.png'),
]
