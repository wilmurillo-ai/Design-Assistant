...
pages = [
    ('table3_封面.html', '表格3_01_封面.png'),
    ('table2_宝宝产房篇.html', '表格3_02_宝宝产房篇.png'),
    ('table2_妈妈产房篇.html', '表格3_03_妈妈产房篇.png'),
    ('table2_宝宝住院篇.html', '表格3_04_宝宝住院篇.png'),
    ('table2_妈妈住院篇.html', '表格3_05_妈妈住院篇.png'),
    ('table2_结尾.html', '表格3_06_结尾.png'),
]
