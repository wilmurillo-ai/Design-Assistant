...
pages = [
    ('memo_封面.html', '备忘录V2_01_封面.png'),
    ('memo_证件产房篇.html', '备忘录V2_02_证件产房篇.png'),
    ('memo_宝宝住院篇.html', '备忘录V2_03_宝宝住院篇.png'),
    ('memo_妈妈住院篇.html', '备忘录V2_04_妈妈住院篇.png'),
    ('memo_结尾.html', '备忘录V2_05_结尾.png'),
]
