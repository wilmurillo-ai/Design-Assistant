...
pages = [
    ('memo_封面.html', '备忘录_01_封面.png'),
    ('memo_宝宝产房篇.html', '备忘录_02_宝宝产房篇.png'),
    ('memo_妈妈产房篇.html', '备忘录_03_妈妈产房篇.png'),
    ('memo_宝宝住院篇.html', '备忘录_04_宝宝住院篇.png'),
    ('memo_妈妈住院篇.html', '备忘录_05_妈妈住院篇.png'),
    ('memo_结尾.html', '备忘录_06_结尾.png'),
]
