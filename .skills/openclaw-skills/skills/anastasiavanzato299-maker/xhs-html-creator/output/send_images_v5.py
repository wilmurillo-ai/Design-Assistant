...
images = ['daishengbao_cover_v5.png','daishengbao_doc_v5.png','daishengbao_baby1_v5.png','daishengbao_baby2_v5.png','daishengbao_mom1_v5.png','daishengbao_mom2_v5.png','daishengbao_ending_v5.png']
for img in images:
