...
```bash
/brand jbv-foto
/brand client-photography-studio
```
...
| `--brand` | Optional | Load brand profile for CTA and compliance hints | `--brand jbv-foto` |
...
**Examples:**
```bash
/seobrief Blogpost "Leica M6 Analogfotografie Guide für Einsteiger" --lang de --brand jbv-foto
/seobrief FAQ "Häufige Fragen zur Leica M6" --primary-kw "leica m6 faq" --lang de
/seobrief Productused "Leica M6 TTL Chrome" --lang de --depth deep
/seobrief Landingpage "Spring Camera Sale 2026" --primary-kw "vintage camera sale" --brand jbv-foto
```

**Using a brief with /write:**
```bash
# Generate brief first
/seobrief Blogpost "Leica M6 Guide" --lang de --brand jbv-foto
# → Saved as SEO_BRIEFS/leica-m6-guide-de.md

# Write content from brief (outline, KWs, and internal links auto-loaded)
/persona blogger
/write Blogpost "Leica M6 Guide" --from-brief leica-m6-guide-de --lang de

# Or generate HTML from brief
/persona blogger
/writehtml Blogpost "Leica M6 Guide" --from-brief leica-m6-guide-de --lang de
```
...
| `--brand` | Optional | Load brand profile for persona defaults | `--brand jbv-foto` |
...
/seoplan "Dental clinic SEO Berlin" --lang de --priority quickwins --depth light

# Full site architecture overview
/seoplan "Photography gear e-commerce Germany" --lang de --mode site

# Deep cluster — maximum node count
/seoplan "Leica M rangefinder cameras" --lang de --brand jbv-foto --depth deep

# Strategic focus — authority building, no urgency
/seoplan "Wedding photography Nuremberg" --lang de --priority strategic
```
...
/seoplan "Vintage analog cameras Germany" --lang de --brand jbv-foto
# → Saved as SEO_PLANS/vintage-analog-cameras-de.md
...
# → Saved as SEO_BRIEFS/film-einlegen-anleitung-de.md
