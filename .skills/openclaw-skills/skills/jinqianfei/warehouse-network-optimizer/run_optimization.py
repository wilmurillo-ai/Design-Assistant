...
- v2.5: 优化门店匹配逻辑（城市优先，省份备选）
- v2.4: 新增等待时间计算

用法: python3 run_optimization.py --store-file <门店Excel> [--rdc-count <数量>] [--output <输出文件>]
"""
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='仓配网络规划优化 v2.6')
    parser.add_argument('--store-file', required=True, help='门店数据Excel文件')
    parser.add_argument('--rdc-count', type=int, default=3, help='RDC数量（默认3）')
