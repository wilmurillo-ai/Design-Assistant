...
if __name__ == "__main__":
    ...
    # 测试不同级别的日志
    info("detail_start", product_id="6921775422265919647")
    warning("detail_main_info_slow", product_id="6921775422265919647", elapsed_ms=3000)
    error("detail_main_info_failed", product_id="6921775422265919647", error_msg="接口超时")
