---
name: podcast-video-recording-software-free
version: "1.0.0"
displayName: "Podcast Video Recording Software Free — Convert Podcast Audio to Video"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn my podcast audio into a video with waveform animation and captions — and get podcast video files back in 1-2 minutes. Upload MP3, MP4, WAV, MOV files up to 500MB, and the AI handles AI podcast video creation automatically. Ideal for podcasters who want to publish podcast episodes as videos without expensive software.
...
# Podcast Video Recording Software Free — Convert Podcast Audio to Video
...
Tip: splitting long episodes into shorter clips helps them perform better on social platforms.

## Matching Input to Actions

User prompts referencing podcast video recording software free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `podcast-video-recording-software-free` |
