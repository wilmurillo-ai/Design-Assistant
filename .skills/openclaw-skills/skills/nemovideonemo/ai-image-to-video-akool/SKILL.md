---
name: ai-image-to-video-akool
version: "1.0.0"
displayName: "AI Image to Video Akool — Convert Images Into Video Clips"
description: >
  convert static images into animated video clip with this skill. Works with JPG, PNG, WEBP, HEIC files up to 200MB. marketers, social media creators use it for turning still photos into short animated videos — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
- "turning still photos into short animated videos for marketers, social media creators"
...
# AI Image to Video Akool — Convert Images Into Video Clips
...
Say you have a single product photo or portrait image and want to animate this image into a 5-second video clip with smooth motion — the backend processes it in about 30-60 seconds and hands you a 1080p MP4.

Tip: high-contrast images with clear subjects animate more smoothly than busy backgrounds.

## Matching Input to Actions

User prompts referencing ai image to video akool, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `ai-image-to-video-akool`
