---
name: best-video-editor-app
version: "1.0.0"
displayName: "Best Video Editor App — Edit and Export Polished Videos"
description: >
  Turn a 2-minute unedited phone recording into 1080p polished edited clips just by typing what you need. Whether it's editing raw footage into a clean, shareable video or quick social content, drop your raw video clips and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
# Best Video Editor App — Edit and Export Polished Videos
...
Here's a typical use: you send a a 2-minute unedited phone recording, ask for trim the pauses, add transitions, and export a clean final cut, and about 1-2 minutes later you've got a MP4 file ready to download. The whole thing runs at 1080p by default.

One thing worth knowing — shorter clips under 3 minutes process significantly faster.

## Matching Input to Actions

User prompts referencing best video editor app, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `best-video-editor-app`
