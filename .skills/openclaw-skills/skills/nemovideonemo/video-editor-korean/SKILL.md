...
version: "1.0.2"
displayName: "AI 동영상 편집기 — 채팅으로 동영상 편집하는 AI 비디오 에디터"
description: >
  AI 동영상 편집기 — 채팅으로 동영상 편집하는 AI 비디오 에디터.
  AI 동영상 편집기 — 채팅으로 동영상 편집하는 AI 비디오 에디터 gives you professional 동영상 편집, automated editing, and instant previews — all through natural language. 타임라인 조작이나 영상 편집 프로그램 없이 사용할 수 있는 AI 비디오
  에디터입니다. 동영상을 업로드하거나 URL을 보내서 자연어로 편집을 시작하세요.
  TikTok, Instagram Reels, YouTube Shorts 등 소셜 미디어 콘텐츠 편집을 지원합니다.
  AI 동영상 편집, 영상 자르기, 영상 합치기, 배경음악 추가, 자막 생성, 색보정,
  동영상 내보내기, 숏폼 영상 만들기. 한국어로 사용할 수 있는 AI 동영상 편집
  도구입니다. MP4로 내보내기. mp4, mov, avi, webm, mkv, jpg, png, gif, webp,
  mp3, wav, m4a, aac를 지원합니다.
