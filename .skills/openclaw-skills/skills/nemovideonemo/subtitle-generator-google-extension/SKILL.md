---
name: subtitle-generator-google-extension
version: "1.0.0"
displayName: "Subtitle Generator Google Extension — Auto-Generate Subtitles for Videos"
description: >
...
# Subtitle Generator Google Extension — Auto-Generate Subtitles for Videos
...
User prompts referencing subtitle generator google extension, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `subtitle-generator-google-extension`
