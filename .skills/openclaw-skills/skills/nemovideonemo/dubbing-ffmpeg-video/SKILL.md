---
name: dubbing-ffmpeg-video
version: "1.0.0"
displayName: "Dubbing FFmpeg Video — Dub and Export Videos Fast"
description: >
  Get dubbed video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, MKV, up to 500MB), say something like "replace the original audio with a dubbed Spanish voiceover using FFmpeg", and download 1080p MP4 when it's done. Built for content creators who move fast and want to dub videos into other languages without manual audio editing.
