---
name: subtitle-generator-in-video
version: "1.0.0"
displayName: "Subtitle Generator in Video — Generate and Embed Video Subtitles"
description: >
  Get captioned video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "generate subtitles in English and add them as burned-in captions", and download 1080p MP4 when it's done. Built for YouTubers, content creators, marketers who move fast and need accurate captions without manual transcription.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `subtitle-generator-in-video` |
