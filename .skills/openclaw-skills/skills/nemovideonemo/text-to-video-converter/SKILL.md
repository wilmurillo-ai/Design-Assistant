---
name: text-to-video-converter
version: "1.0.0"
displayName: "Text to Video Converter — Convert Text into Shareable Videos"
description: >
  Get AI-generated videos ready to post, without touching a single slider. Upload your written text (TXT, DOCX, PDF, SRT, up to 200MB), say something like "turn this blog intro into a 30-second video with visuals and background music", and download 1080p MP4 when it's done. Built for marketers, content creators, educators who move fast and want to produce videos without filming or editing skills.
...
- "turning written content into shareable videos for marketers, content creators, educators"
...
# Text to Video Converter — Convert Text into Shareable Videos
...
Tip: shorter text inputs under 200 words produce tighter, more focused videos.

## Matching Input to Actions

User prompts referencing text to video converter, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-converter` |
