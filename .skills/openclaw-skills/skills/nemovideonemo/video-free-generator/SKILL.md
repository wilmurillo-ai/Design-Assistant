---
name: video-free-generator
version: "1.0.0"
displayName: "Video Free Generator — Generate Videos at No Cost"
description: >
  generate text or images into ready-to-share videos with this skill. Works with MP4, MOV, PNG, JPG files up to 200MB. content creators use it for generating videos from text prompts or images without paying — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
- "generate a 30-second video from my product description with background music"
- "generating videos from text prompts or images without paying for content creators"
...
# Video Free Generator — Generate Videos at No Cost
...
Here's a typical use: you send a a short text prompt describing a product demo scene, ask for generate a 30-second video from my product description with background music, and about 1-2 minutes later you've got a MP4 file ready to download. The whole thing runs at 1080p by default.

One thing worth knowing — shorter prompts with clear scene descriptions produce more accurate results.

## Matching Input to Actions

User prompts referencing video free generator, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `video-free-generator`
