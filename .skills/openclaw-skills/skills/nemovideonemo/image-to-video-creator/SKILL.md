---
name: image-to-video-creator
version: "1.0.0"
displayName: "Image to Video Creator — Turn Photos Into Videos"
description: >
  convert images into animated video clips with this skill. Works with JPG, PNG, WEBP, HEIC files up to 200MB. social media creators use it for turning still photos into shareable videos for social media — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
# Image to Video Creator — Turn Photos Into Videos
...
Worth noting: using images with similar aspect ratios produces smoother transitions.

## Matching Input to Actions

User prompts referencing image to video creator, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `image-to-video-creator` |
