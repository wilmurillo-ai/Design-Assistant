---
name: ai-free-youtube
version: "1.0.0"
displayName: "AI Free YouTube — Edit and Export YouTube Videos"
description: >
  edit YouTube video links into edited YouTube videos with this skill. Works with MP4, MOV, WebM, AVI files up to 500MB. YouTubers use it for editing and repurposing YouTube videos with AI at no cost — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
# AI Free YouTube — Edit and Export YouTube Videos
...
Worth noting: shorter clips under 5 minutes process significantly faster and use fewer resources.

## Matching Input to Actions

User prompts referencing ai free youtube, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `ai-free-youtube`
