---
name: ai-video-editor-job
version: "1.0.0"
displayName: "AI Video Editor Job — Edit and Export Videos Fast"
description: >
  Get polished edited clips ready to post, without touching a single slider. Upload your raw video footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut the pauses, add transitions, and export a clean final video", and download 1080p MP4 when it's done. Built for freelance video editors and content creators who move fast and want to complete editing jobs faster without manual cuts and adjustments.
...
# AI Video Editor Job — Edit and Export Videos Fast
...
Here's a typical use: you send a a 3-minute unedited screen recording or phone clip, ask for cut the pauses, add transitions, and export a clean final video, and about 1-2 minutes later you've got a MP4 file ready to download. The whole thing runs at 1080p by default.

One thing worth knowing — shorter clips under 2 minutes process significantly faster and use fewer credits.

## Matching Input to Actions

User prompts referencing ai video editor job, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `ai-video-editor-job`
...
Export as MP4 with H.264 codec for the widest client and platform compatibility.
