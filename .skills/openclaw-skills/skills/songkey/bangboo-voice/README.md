...
- `.cursor/skills/bangboo-voice/SKILL.md`: Cursor-native skill entry.
- `.cursor/skills/bangboo-voice/reference-lexicon.md`: strict Chinese combos + English onomatopoeia examples.
...
2. Ensure `.cursor/skills/bangboo-voice/SKILL.md` is available.
