#!/usr/bin/env node
/**
 * Watchdog – OpenClaw MCP Skill (Native stdio)
 * Version: 1.0.0
 *
...
server.registerPrompt(
  ...
  {
    description:
      "Activates the Watchdog expert mode. Provides behavioral context to monitor web infrastructure, APIs, and cron jobs.",
    argsSchema: {},
  },
  () => ({
    messages: [
