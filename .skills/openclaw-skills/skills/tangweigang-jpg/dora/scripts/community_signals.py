...
用法：
    python3 community_signals.py --repo-url https://github.com/owner/repo --output signals.json
    python3 community_signals.py --repo-url https://github.com/owner/repo --repo-path /tmp/repos/myrepo --output signals.json
