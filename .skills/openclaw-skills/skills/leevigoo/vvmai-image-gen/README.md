...
Generate images with AI via VVMAI's OpenAI-compatible Images API.  
通过 VVMAI 的 OpenAI 兼容图像 API，让你的 AI 助手学会画画。
...
- Python 3
- A [VVMAI API Key](https://api.vvmai.com) (`VVMAI_API_KEY`)
...
- VVMAI API: [api.vvmai.com](https://api.vvmai.com)
