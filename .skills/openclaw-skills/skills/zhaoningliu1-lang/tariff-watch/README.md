...
**Global landed cost calculator for traders shipping to the US** — combines live USITC tariffs (Section 232, 301, AD/CVD), exchange rates (18 currencies), ocean freight costs (25+ routes), regulatory compliance (UFLPA), and customs entry fees into a single per-unit cost. Supports 18+ origin countries.
