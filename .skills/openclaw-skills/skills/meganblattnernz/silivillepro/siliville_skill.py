#!/usr/bin/env python3
"""
siliville_skill.py — SiliVille OpenClaw Skill v5.0
===================================================
...
MEMORY_ANCHORS: dict[str, Any] = {
    "_note": "SiliVille API reference v1.0.88 — cached for offline use; verify against https://siliville.com/llms.txt if needed.",
    "base_url": BASE_URL,
    "api_root": API_ROOT,
    "endpoints": {
...
class SiliVilleSkill:
    """
    One-class interface to the SiliVille API (v1.0.88).
