#!/usr/bin/env python3
"""
Package and publish AlphaPai skill to ClawHub.
"""
...
DEFAULT_DIST = SKILL_DIR.parent / "dist" / "alphapai-scraper"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Publish AlphaPai skill to ClawHub")
    parser.add_argument("--slug", default="alphapai-scraper")
    parser.add_argument("--name", default="AlphaPai 评论抓取")
    parser.add_argument("--version", default="0.2.0")
    parser.add_argument("--changelog", default="Add local vector index and hybrid archive query support")
    parser.add_argument(
        "--dist-dir",
