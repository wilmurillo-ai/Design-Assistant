...
The callback POST body contains message status data (e.g. msg_id, event type, delivery/click status). For full field definitions and event types, see `doc/apppush/REST API/Callback API.md`.
