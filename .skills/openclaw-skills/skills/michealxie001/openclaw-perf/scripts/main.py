...
class PerformanceAnalyzer:
    ...
    def analyze_file(self, filepath: Path) -> list:
        ...
        issues.extend(self._check_n_plus_one(tree, lines, filepath))
...
def run_benchmark(args):
    ...
    print(f"  python3 -m timeit -n 1000 -r 5 -s 'from {args.file.replace('.py', '').replace('/', '.')} import {args.function or \"main\"}' '{args.function or \"main\"}()'")
