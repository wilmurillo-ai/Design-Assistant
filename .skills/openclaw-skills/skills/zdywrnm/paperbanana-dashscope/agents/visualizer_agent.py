    ...
    async def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for desc_key in desc_keys_to_process:
            ...
            if cfg["use_image_generation"]:
                if any(x in self.model_name for x in ("wanx", "wan2", "wan-")):
                    # DashScope native async API for Wan/wanx image models
                    size_str = "1024*1024"
                    if aspect_ratio == "16:9":
                        ...
                        size_str = "768*1024"
                    response_list = await generation_utils.call_dashscope_image_generation_async(
                        prompt=prompt_text,
