...
name: video-json-ai
version: "1.0.0"
displayName: "Video JSON AI — Extract Video Data as JSON"
description: >
  Skip the learning curve of professional editing software. Describe what you want — extract video metadata and scene data as structured JSON — and get structured JSON data back in 20-40 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI JSON data extraction automatically. Ideal for developers and marketers who need video content parsed into structured data without manual tagging.
