---
name: caption-generator-from-audio
version: "1.0.0"
displayName: "Caption Generator from Audio — Generate Synced Captions from Audio"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate captions from this audio and sync them to the video — and get captioned video files back in 30-60 seconds. Upload MP3, MP4, WAV, M4A files up to 500MB, and the AI handles AI caption generation automatically. Ideal for podcasters, content creators, educators who need accurate captions generated automatically from audio without manual transcription.
