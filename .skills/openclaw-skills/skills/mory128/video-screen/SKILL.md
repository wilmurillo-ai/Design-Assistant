...
name: video-screen
version: "1.0.0"
displayName: "Video Screen — Edit and Export Screen Recordings"
description: >
  Skip the learning curve of professional editing software. Describe what you want — crop the screen recording to 16:9, highlight the cursor clicks, and add a voiceover track — and get polished screen recordings back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles screen capture editing automatically. Ideal for educators, software developers, content creators who want to clean up and share screen recordings without complex editing software.
