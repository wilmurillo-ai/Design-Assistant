---
name: video-editor-hire
version: "1.0.0"
displayName: "Video Editor Hire — Edit and Export Finished Videos"
description: >
  Get polished edited clips ready to post, without touching a single slider. Upload your raw footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut the pauses, add background music, and export a clean final cut", and download 1080p MP4 when it's done. Built for small business owners and content creators who move fast and want professional-looking edits without the cost or wait of hiring someone.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editor-hire` |
