---
name: best-video-editor-for-android
version: "1.0.0"
displayName: "Best Video Editor for Android — Edit and Export Mobile Videos"
description: >
  Turn a 60-second phone-recorded vertical clip into 1080p edited video clips just by typing what you need. Whether it's editing phone-recorded videos into polished shareable clips or quick social content, drop your video clips and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
**Try saying:**
- "edit a 60-second phone-recorded vertical clip into a 1080p MP4"
- "trim the footage, add transitions, and put text overlays on each scene"
- "editing phone-recorded videos into polished shareable clips for Android mobile creators"
...
# Best Video Editor for Android — Edit and Export Mobile Videos
...
A quick example: upload a 60-second phone-recorded vertical clip, type "trim the footage, add transitions, and put text overlays on each scene", and you'll get a 1080p MP4 back in roughly 30-60 seconds. All rendering happens server-side.

Worth noting: vertical 9:16 video works perfectly for Reels and TikTok exports.

## Matching Input to Actions

User prompts referencing best video editor for android, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `best-video-editor-for-android` |
