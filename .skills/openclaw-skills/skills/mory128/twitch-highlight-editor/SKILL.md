---
name: twitch-highlight-editor
version: "1.0.0"
displayName: "Twitch Highlight Editor — Clip and Export Stream Highlights"
description: >
  Skip the learning curve of professional editing software. Describe what you want — find the best moments and cut them into a 5-minute highlight reel — and get highlight reel clips back in 1-3 minutes. Upload MP4, MOV, MKV, AVI files up to 500MB, and the AI handles AI highlight extraction automatically. Ideal for Twitch streamers who want to clip stream highlights quickly without manual scrubbing through hours of footage.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `twitch-highlight-editor` |
