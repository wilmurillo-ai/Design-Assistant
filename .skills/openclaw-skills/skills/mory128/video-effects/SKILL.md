...
name: video-effects
version: "1.0.0"
displayName: "Video Effects — Apply Effects and Export Video"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add a cinematic color grade and motion blur to my video — and get effects-enhanced video back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI effects application automatically. Ideal for TikTok creators who want professional visual effects without complex editing software.
