---
name: video-editing-with-ki
version: "1.0.0"
displayName: "Video Editing with AI — Edit and Export Polished Videos"
description: >
  edit raw video footage into edited MP4 videos with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators and marketers use it for editing raw footage into polished videos using AI — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
# Video Editing with AI — Edit and Export Polished Videos
...
Say you have a 2-minute raw interview recording and want to cut the pauses, add transitions, and export a clean final video — the backend processes it in about 1-2 minutes and hands you a 1080p MP4.

Tip: shorter clips under 3 minutes process significantly faster.

## Matching Input to Actions

User prompts referencing video editing with ki, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-ki` |
