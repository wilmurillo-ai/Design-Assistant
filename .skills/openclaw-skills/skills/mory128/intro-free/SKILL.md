...
name: intro-free
version: "1.0.0"
displayName: "Intro Free — Remove Intros from Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — remove the intro from the beginning of my video — and get intro-free clips back in 20-40 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI intro removal automatically. Ideal for YouTubers and content creators who want to cut opening sequences without manual editing.
