...
name: text-to-ai
version: "1.0.0"
displayName: "Text to AI Video — Convert Text into Generated Videos"
description: >
  convert text prompts into AI generated videos with this skill. Works with TXT, DOCX, PDF, copied text files up to 500MB. marketers use it for generating videos from written text or scripts — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
