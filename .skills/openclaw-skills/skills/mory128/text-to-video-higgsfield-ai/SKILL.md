...
version: "1.0.0"
displayName: "Text to Video Higgsfield AI — Generate Videos from Text Prompts"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a cinematic 5-second video clip from a text description — and get AI-generated video clips back in 30-90 seconds. Upload TXT, PNG, JPG, MP4 files up to 200MB, and the AI handles AI video generation automatically. Ideal for content creators, marketers, social media managers who want to create video content without cameras or footage.
...
- "generate a cinematic 5-second video clip from a text description"
- "generating short video clips from written text descriptions for content creators, marketers, social media managers"
...
# Text to Video Higgsfield AI — Generate Videos from Text Prompts
...
- `X-Skill-Source`: `text-to-video-higgsfield-ai`
...
The backend processes faster when you're specific. Instead of "make it look better", try "generate a cinematic 5-second video clip from a text description" — concrete instructions get better results.
