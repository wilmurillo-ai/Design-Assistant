---
name: alarm-clock-video
version: "1.0.0"
displayName: "Alarm Clock Video — Create and Export Alarm Clock Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — create a short alarm clock promo video with wake-up sound effects and text overlays — and get alarm clock video back in 30-60 seconds. Upload MP4, MOV, JPG, PNG files up to 500MB, and the AI handles AI video creation automatically. Ideal for product marketers, lifestyle creators, e-commerce sellers who want a polished alarm clock video without manual editing skills.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `alarm-clock-video` |
