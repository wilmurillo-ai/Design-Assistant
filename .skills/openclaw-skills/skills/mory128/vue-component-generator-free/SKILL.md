...
version: "1.0.0"
displayName: "Vue Component Generator Free — Generate and Export Vue Components"
description: >
  Get Vue component files ready to post, without touching a single slider. Upload your component descriptions (MP4, MOV, AVI, WebM, up to 200MB), say something like "generate a reusable Vue card component with props for title, image, and description", and download 1080p MP4 when it's done. Built for Vue developers who move fast and want to scaffold components quickly without writing boilerplate code.
