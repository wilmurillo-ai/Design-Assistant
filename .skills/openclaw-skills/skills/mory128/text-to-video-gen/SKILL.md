...
version: "1.0.0"
displayName: "Text to Video Generator — Turn Text Into Video Clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — create a 30-second video from this product description: 'Wireless earbuds with 24-hour battery life. Perfect for commuters and gym-goers.' — and get AI generated videos back in 1-3 minutes. Upload TXT, DOCX, PDF, plain text files up to 50MB, and the AI handles AI video creation automatically. Ideal for marketers who want to produce videos quickly without filming or editing skills.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-gen` |
