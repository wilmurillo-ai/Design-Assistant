---
name: generator-online-free
version: "1.0.0"
displayName: "Generator Online Free — Create and Export Videos Online"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a 60-second video from my product description — and get ready-to-share videos back in 1-2 minutes. Upload MP4, MOV, JPG, PNG files up to 500MB, and the AI handles AI video generation automatically. Ideal for content creators and marketers who want to create videos instantly without installing or paying for tools.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `generator-online-free` |
