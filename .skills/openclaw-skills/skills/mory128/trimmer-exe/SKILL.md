...
name: trimmer-exe
version: "1.0.0"
displayName: "Trimmer Exe — Trim and Export Video Clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the silent pauses and cut the intro down to 30 seconds — and get trimmed video clips back in 20-40 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video trimming automatically. Ideal for content creators who want to cut video segments quickly without manual editing software.
