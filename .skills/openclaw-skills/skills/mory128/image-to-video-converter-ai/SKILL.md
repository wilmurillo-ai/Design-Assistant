---
name: image-to-video-converter-ai
version: "1.0.0"
displayName: "Image to Video Converter AI — Convert Photos into Shareable Videos"
description: >
  Turn three product photos in JPG format into 1080p animated video clips just by typing what you need. Whether it's converting static photos into shareable video content or quick social content, drop your images and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `image-to-video-converter-ai` |
