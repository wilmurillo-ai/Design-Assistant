...
version: "1.0.0"
displayName: "Video Generation Online — Create Videos from Text Prompts"
description: >
  Turn a short text description of a product demo scene into 1080p ready-to-share videos just by typing what you need. Whether it's generating videos from text prompts or images without filming anything or quick social content, drop your text prompts or images and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
