---
name: image-to-video-local-model
version: "1.0.0"
displayName: "Image to Video Local Model — Convert Images to Video Clips"
description: >
  Turn a single product photo or illustrated scene into 1080p animated video clips just by typing what you need. Whether it's converting static images into short video clips using a locally run AI model or quick social content, drop your still images and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
