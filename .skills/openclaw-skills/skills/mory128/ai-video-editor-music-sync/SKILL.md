---
name: ai-video-editor-music-sync
version: "1.0.0"
displayName: "AI Video Editor Music Sync — Sync Video Cuts to Music"
description: >
  Skip the learning curve of professional editing software. Describe what you want — sync the video cuts to the beat drops in my music track — and get beat-synced videos back in 30-60 seconds. Upload MP4, MOV, AVI, WAV files up to 500MB, and the AI handles AI music sync editing automatically. Ideal for content creators and social media editors who want video edits that match the rhythm of their music without manual frame-by-frame cutting.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-editor-music-sync` |
