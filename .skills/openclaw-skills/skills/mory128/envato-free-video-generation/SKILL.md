...
version: "1.0.0"
displayName: "Envato Free Video Generation — Generate Videos Without Paid Assets"
description: >
  Turn a product description and three brand images into 1080p ready-to-use videos just by typing what you need. Whether it's generating polished videos from images or text without paid Envato assets or quick social content, drop your text prompts or assets and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
