...
version: "1.0.0"
displayName: "Meta AI Video Generator Free — Generate Videos from Images Free"
description: >
  Get AI-generated videos ready to post, without touching a single slider. Upload your images or clips (MP4, MOV, JPG, PNG, up to 500MB), say something like "turn my product photos into a promotional video with music and transitions", and download 1080p MP4 when it's done. Built for content creators and marketers who move fast and want to create videos quickly without expensive software or subscriptions.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `meta-ai-video-generator-free` |
