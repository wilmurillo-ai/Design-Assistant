---
name: video-editing-with-macbook-pro
version: "1.0.0"
displayName: "Video Editing with MacBook Pro — Edit and Export Polished Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the footage, add transitions, and export a clean final cut — and get polished edited clips back in 1-2 minutes. Upload MP4, MOV, AVI, ProRes files up to 500MB, and the AI handles AI video editing automatically. Ideal for Mac users and content creators who want quick professional edits without learning Final Cut Pro or Premiere.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-macbook-pro` |
