...
version: "1.0.0"
displayName: "Open AI Video Generation — Generate Videos from Text Prompts"
description: >
  marketers generate text prompts into AI generated videos using this skill. Accepts MP4, MOV, WebM, GIF up to 500MB, renders on cloud GPUs at 1080p, and returns MP4 files in 1-3 minutes. Designed for generating videos from text descriptions using AI.
