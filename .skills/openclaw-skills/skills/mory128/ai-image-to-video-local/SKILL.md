---
name: ai-image-to-video-local
version: "1.0.0"
displayName: "AI Image to Video Local — Convert Images Into Video Clips"
description: >
  Turn a single product photo or landscape image into 1080p animated video clips just by typing what you need. Whether it's converting still images into short videos on a local machine without cloud uploads or quick social content, drop your images and describe the result you want. No timeline dragging, no export settings — 30-90 seconds from upload to download.
