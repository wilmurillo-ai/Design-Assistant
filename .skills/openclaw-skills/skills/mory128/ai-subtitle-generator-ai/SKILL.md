---
name: ai-subtitle-generator-ai
version: "1.0.0"
displayName: "AI Subtitle Generator — Generate and Embed Video Subtitles"
description: >
  generate video files into captioned video files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. YouTubers, content creators, educators use it for adding auto-generated subtitles to videos — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
# AI Subtitle Generator — Generate and Embed Video Subtitles
...
Say you have a 3-minute interview video in MP4 format and want to generate subtitles in English and Spanish and burn them into the video — the backend processes it in about 30-60 seconds and hands you a 1080p MP4.

Tip: shorter clips under 5 minutes produce the most accurate subtitle timing.

## Matching Input to Actions

User prompts referencing ai subtitle generator ai, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-subtitle-generator-ai` |
