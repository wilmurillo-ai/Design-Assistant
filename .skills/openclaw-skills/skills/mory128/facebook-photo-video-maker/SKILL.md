---
name: facebook-photo-video-maker
version: "1.0.0"
displayName: "Facebook Photo Video Maker — Turn Photos Into Facebook Videos"
description: >
  Cloud-based facebook-photo-video-maker tool that handles turning photo albums into shareable Facebook videos. Upload JPG, PNG, HEIC, WebP files (up to 200MB), describe what you need, and get 1080p MP4 output in 30-60 seconds. Built for Facebook users and social media creators who work with photos or images.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `facebook-photo-video-maker` |
