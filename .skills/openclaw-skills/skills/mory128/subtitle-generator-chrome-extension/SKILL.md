---
name: subtitle-generator-chrome-extension
version: "1.0.0"
displayName: "Subtitle Generator Chrome Extension — Generate and Add Video Captions"
description: >
  Get captioned video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, WebM, AVI, up to 500MB), say something like "generate subtitles in English and add them as burned-in captions", and download 1080p MP4 when it's done. Built for YouTubers and content creators who move fast and need captions added quickly without installing desktop software.
