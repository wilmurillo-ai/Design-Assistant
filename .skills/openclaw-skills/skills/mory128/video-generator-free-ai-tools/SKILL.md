---
name: video-generator-free-ai-tools
version: "1.0.0"
displayName: "Video Generator Free AI Tools — Generate Videos from Text Free"
description: >
  Get ready-to-share videos ready to post, without touching a single slider. Upload your text prompts or images (MP4, MOV, JPG, PNG, up to 200MB), say something like "generate a 30-second promotional video from my product description", and download 1080p MP4 when it's done. Built for content creators and marketers who move fast and want to create videos quickly without paying for expensive tools.
...
- "generating short videos from text or images without editing software for content creators and marketers"
...
# Video Generator Free AI Tools — Generate Videos from Text Free
...
User prompts referencing video generator free ai tools, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-generator-free-ai-tools` |
