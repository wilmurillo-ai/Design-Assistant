---
name: free-image-creator
version: "1.0.0"
displayName: "Free Image Creator — Generate Images from Text Prompts"
description: >
  Get AI generated images ready to post, without touching a single slider. Upload your text prompts (JPG, PNG, WEBP, MP4, up to 200MB), say something like "generate a realistic photo of a coffee shop interior with warm lighting", and download 1080p MP4 when it's done. Built for content creators who move fast and want to create custom visuals without owning a camera or hiring a designer.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-image-creator` |
