...
ptengine-cli is an external open-source tool. Install it by following the instructions
at the upstream repository:

- Repo: <https://github.com/Kocoro-lab/ptengine-cli>
- Releases (prebuilt binaries): <https://github.com/Kocoro-lab/ptengine-cli/releases>
- README (current install commands): <https://github.com/Kocoro-lab/ptengine-cli#readme>

This skill does not bundle an installer. After installation, verify with:
