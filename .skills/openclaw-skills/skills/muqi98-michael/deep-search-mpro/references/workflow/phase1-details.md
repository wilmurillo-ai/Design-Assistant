...
| 数据需求类型 | 推荐搜索方法 | 说明 |
|------------|-------------|------|
| 中文市场数据 | web_fetch（百度、微信、头条 URL） | 覆盖中国主流平台 |
| 国际市场数据 | web_fetch（Google、Bing URL） | 全球搜索引擎 |
| 政府统计数据 | web_fetch（site:gov.cn） | 限定政府网站 |
| 行业报告 | web_fetch + filetype:pdf | 搜索 PDF 格式报告 |
| 深度背景研究 | web_fetch（多轮关键词 + 站点限定/文件类型） | 多源交叉验证 |
| 快速补充搜索 | web_fetch（可选任意公开检索入口 URL） | 快速补充与补漏 |
...
|---|-------------|-----------|-------------------|--------------------------|-----------------|----------|------------|
| 1 | 市场规模（亿元） | 定量 | 行业报告、政府统计 | web_fetch（百度、Bing） | "中国护肤市场规模 2024" | P0 | 2020-2025 |
| 2 | CAGR | 定量 | 行业报告 | web_fetch（Google） | "skincare CAGR growth" | P0 | 2020-2025 |
```
...
| 1 | 市场规模（亿元） | 定量 | 行业报告、政府统计 | web_fetch（百度、Bing） | "中国护肤市场规模 2024" | P0 | 2020-2025 |
| 2 | CAGR | 定量 | 行业报告 | web_fetch（Google） | "skincare CAGR growth" | P0 | 2020-2025 |
| 3 | 主要品类占比 | 定量 | 行业报告 | web_fetch（百度） | "护肤品品类占比 2024" | P1 | 2024 |
| 4 | 增长驱动力 | 定性 | 专家观点、行业分析 | web_fetch（百度、微信） | "护肤品市场增长驱动力" | P1 | 2024 |

#### Chapter 2: 竞争格局分析

| # | Data Metric | Data Type | Suggested Sources | Recommended Search Method | Search Keywords | Priority | Time Range |
|---|-------------|-----------|-------------------|--------------------------|-----------------|----------|------------|
| 5 | 主要品牌市场份额 | 定量 | 行业报告、市场调研 | web_fetch（百度、Google） | "护肤品品牌市场份额 2024" | P0 | 2024 |
| 6 | 头部企业营收数据 | 定量 | 财报、新闻报道 | web_fetch（百度） | "欧莱雅 资生堂 营收 2024" | P0 | 2024 |
| 7 | 竞争强度评估 | 定性 | 专家观点、行业分析 | web_fetch（微信） | "护肤品行业竞争分析" | P1 | 2024 |
```
