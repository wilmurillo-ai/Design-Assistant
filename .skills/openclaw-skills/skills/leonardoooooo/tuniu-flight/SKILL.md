...
version: 1.0.0
metadata: {"openclaw": {"emoji": "✈️", "category": "travel", "tags": ["途牛", "机票", "航班", "预订"], "requires": {"bins": ["curl"]}, "env": {"TUNIU_API_KEY": {"type": "string", "description": "途牛开放平台 API key，用于 apiKey 请求头", "required": true}}}}
---
