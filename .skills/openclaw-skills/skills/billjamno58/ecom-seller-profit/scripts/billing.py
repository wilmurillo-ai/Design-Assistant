...
# Pay-per-call: $0.03 USDT per analysis run
# ═══════════════════════════════════════════════════
import os
import requests
...
SKILL_ID = os.environ.get("SKILL_BILLING_SKILL_ID", "ecom-seller-profit")
...
def charge_user(user_id: str, amount: float = 0.03) -> dict:
