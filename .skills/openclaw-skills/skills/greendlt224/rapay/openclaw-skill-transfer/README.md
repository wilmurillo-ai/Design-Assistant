...
- **Agent-to-agent transaction scripts** — Shareable onboarding scripts that a buyer agent can forward to a seller agent (and vice versa) to coordinate payments without both sides needing the skill installed
