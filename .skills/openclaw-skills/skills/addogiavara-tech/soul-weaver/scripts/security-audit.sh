...
echo "━━━ AI Soul Weaver — Security Audit ━━━"
...
# 5. Check HEARTBEAT.md exists (for Soul Weaver users)
echo "🔍 Checking Soul Weaver configuration..."
if [ -f "$WORKSPACE/HEARTBEAT.md" ]; then
  echo "✅ HEARTBEAT.md found - Soul Weaver configured"
else
  echo "ℹ️  No HEARTBEAT.md found (optional for Soul Weaver)"
fi
echo ""
