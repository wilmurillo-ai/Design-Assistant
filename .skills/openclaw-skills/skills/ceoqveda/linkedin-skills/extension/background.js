/**
 * LinkedIn Bridge - Background Service Worker
 *
 * NETWORK AUDIT (exhaustive list of all network endpoints in this file):
 *   1. WebSocket to ws://localhost:9336 ONLY (BRIDGE_URL)
 *   2. chrome.cookies.getAll for domain "linkedin.com" (handleCommand)
 *   3. chrome.tabs operations scoped to linkedin.com host_permissions
...
const BRIDGE_URL = "ws://localhost:9336";
let ws = null;
  ...
  switch (method) {
    ...
    case "get_cookies":
      return await chrome.cookies.getAll({
        domain: params.domain || "linkedin.com",
      });
    case "evaluate":
