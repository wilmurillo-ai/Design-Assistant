"""LinkedIn Extension Bridge Server
...
logger = logging.getLogger("linkedin-bridge")
    ...
    async def _handle_cli(self, ws: ServerConnection, msg: dict) -> None:
        ...
        if not self._extension_ws:
            err = (
                ...
                "the LinkedIn Bridge extension installed and enabled."
            )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="LinkedIn Extension Bridge Server")
    parser.add_argument("--port", type=int, default=9336, help="Listen port (default: 9336)")
