...
class BridgePage:
    """Extension Bridge implementation compatible with a generic Page interface."""
    ...
    def get_cookies(self, domain: str = "linkedin.com") -> list:
        result = self._call("get_cookies", {"domain": domain})
