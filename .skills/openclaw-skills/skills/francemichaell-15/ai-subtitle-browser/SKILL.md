---
name: ai-subtitle-browser
version: "1.0.0"
displayName: "AI Subtitle Browser — Browse and Add Video Subtitles"
description: >
  add video files into captioned video files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. YouTubers and content creators use it for browsing and adding AI-generated subtitles to videos — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-subtitle-browser` |
