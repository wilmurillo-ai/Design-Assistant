---
name: image-compressor-pro-free
version: "1.0.0"
displayName: "Image Compressor Pro Free — Compress and Export Smaller Images"
description: >
  Get compressed image files ready to post, without touching a single slider. Upload your image files (JPG, PNG, WEBP, GIF, up to 200MB), say something like "compress this image to under 500KB without losing visible quality", and download 1080p MP4 when it's done. Built for web designers, bloggers, marketers who move fast and want smaller image files without paying for desktop software.
