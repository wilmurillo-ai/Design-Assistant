---
name: audio-upload-aioz
version: "1.0.0"
displayName: "Audio Upload AIOZ — Convert Audio Files to Video"
description: >
  Turn a 3-minute MP3 podcast recording into 1080p audio-driven MP4 just by typing what you need. Whether it's uploading audio files to create shareable video content on AIOZ network or quick social content, drop your audio files and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
