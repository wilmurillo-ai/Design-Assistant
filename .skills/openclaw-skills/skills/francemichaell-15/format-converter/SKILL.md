...
version: "1.0.0"
displayName: "Format Converter — Convert Videos to MP4"
description: >
  Get converted MP4 files ready to post, without touching a single slider. Upload your video files (AVI, MOV, MKV, WebM, up to 500MB), say something like "convert this AVI to MP4 so I can upload it to YouTube", and download 1080p MP4 when it's done. Built for content creators who move fast and need videos in a compatible format without desktop software.
