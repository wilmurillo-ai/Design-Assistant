---
name: best-video-script-writer
version: "1.0.0"
displayName: "Best Video Script Writer — Generate Scripts for Any Video"
description: >
  Turn a 2-minute product explainer brief into 1080p ready-to-use scripts just by typing what you need. Whether it's generating video scripts from a topic or brief or quick social content, drop your topic or brief and describe the result you want. No timeline dragging, no export settings — 20-40 seconds from upload to download.
