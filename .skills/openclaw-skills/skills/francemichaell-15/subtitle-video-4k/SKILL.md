---
name: subtitle-video-4k
version: "1.0.0"
displayName: "Subtitle Video 4K — Add Subtitles to 4K Videos"
description: >
  Get captioned 4K videos ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "add subtitles in English to my 4K video", and download 4K MP4 when it's done. Built for YouTubers and filmmakers who move fast and need accurate captions on high-resolution videos without manual editing.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `subtitle-video-4k` |
