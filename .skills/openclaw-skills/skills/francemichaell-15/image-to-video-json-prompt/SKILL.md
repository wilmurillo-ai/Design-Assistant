---
name: image-to-video-json-prompt
version: "1.0.0"
displayName: "Image to Video JSON Prompt — Convert Images into Videos via JSON"
description: >
  convert images into animated video clips with this skill. Works with JPG, PNG, WEBP, GIF files up to 200MB. developers and content creators use it for turning static images into video using a structured JSON prompt — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
