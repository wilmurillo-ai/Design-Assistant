---
name: ai-video-editor-eraser
version: "1.0.0"
displayName: "AI Video Editor Eraser — Erase Objects from Videos"
description: >
  Get clean erased clips ready to post, without touching a single slider. Upload your video clips (MP4, MOV, AVI, WebM, up to 500MB), say something like "erase the watermark from the bottom-right corner of my video", and download 1080p MP4 when it's done. Built for content creators who move fast and want to remove distracting elements without complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-editor-eraser` |
