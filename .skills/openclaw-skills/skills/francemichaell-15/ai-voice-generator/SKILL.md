...
version: "1.0.0"
displayName: "AI Voice Generator — Generate Voiceovers for Videos"
description: >
  Turn a 200-word product description script into 1080p voiced video clips just by typing what you need. Whether it's adding AI voiceovers to videos without recording audio or quick social content, drop your text or script and describe the result you want. No timeline dragging, no export settings — 20-40 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-voice-generator` |
