---
name: video-editor-ai-best
version: "1.0.0"
displayName: "Best AI Video Editor — Edit and Export Polished Videos"
description: >
  edit raw video footage into polished edited clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators and marketers use it for automatically editing raw footage into a finished video — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editor-ai-best` |
