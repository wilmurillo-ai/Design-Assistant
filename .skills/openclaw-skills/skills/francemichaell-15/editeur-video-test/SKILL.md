---
name: editeur-video-test
version: "1.0.0"
displayName: "Video Editor Test — Test and Export Edited Videos"
description: >
  Get edited video clips ready to post, without touching a single slider. Upload your raw video clips (MP4, MOV, AVI, WebM, up to 500MB), say something like "trim unnecessary parts, add transitions, and export a clean final cut", and download 1080p MP4 when it's done. Built for content creators and marketers who move fast and want to try out the video editor quickly without a steep learning curve.
