...
name: review-editor
version: "1.0.0"
displayName: "Review Editor — Edit and Export Review Videos"
description: >
  Get polished review clips ready to post, without touching a single slider. Upload your recorded video footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut filler moments, add text overlays highlighting key points, and smooth transitions between scenes", and download 1080p MP4 when it's done. Built for YouTubers and content reviewers who move fast and want to trim, annotate, and polish review footage without manual editing skills.
