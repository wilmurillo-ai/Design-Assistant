...
version: "1.0.0"
displayName: "Photo Video Maker for Facebook — Turn Photos into Facebook Videos"
description: >
  Cloud-based photo-video-maker-facebook tool that handles creating Facebook slideshow videos from photos. Upload JPG, PNG, HEIC, WebP files (up to 200MB), describe what you need, and get 1080p MP4 output in 30-60 seconds. Built for Facebook users and social media marketers who work with photos and images.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `photo-video-maker-facebook` |
