---
name: free-video-letter-maker
version: "1.0.0"
displayName: "Free Video Letter Maker — Turn Messages Into Video Letters"
description: >
  Turn a short personal message and one photo into 1080p personalized video letters just by typing what you need. Whether it's turning written messages into shareable video letters or quick social content, drop your text or photos and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-video-letter-maker` |
