---
name: youtube-text-to
version: "1.0.0"
displayName: "YouTube Text To Video — Convert Text Into YouTube Videos"
description: >
  convert text script into text-based videos with this skill. Works with TXT, DOCX, PDF, SRT files up to 200MB. YouTubers use it for converting written text into YouTube-ready videos — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
