---
name: github-subtitle-generator
version: "1.0.0"
displayName: "GitHub Subtitle Generator — Generate Subtitles for Videos"
description: >
  Get captioned video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "generate subtitles and export as SRT with burned-in captions", and download 1080p MP4 when it's done. Built for developers and open source content creators who move fast and need accurate captions for technical videos without manual transcription.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `github-subtitle-generator` |
