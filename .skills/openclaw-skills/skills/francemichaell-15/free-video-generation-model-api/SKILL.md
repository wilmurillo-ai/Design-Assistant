---
name: free-video-generation-model-api
version: "1.0.0"
displayName: "Free Video Generation Model API — Generate Videos from Text Prompts"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a 10-second video clip of a futuristic city at night from a text prompt — and get AI generated clips back in 30-90 seconds. Upload MP4, MOV, WebM, GIF files up to 500MB, and the AI handles AI video generation automatically. Ideal for developers and creators who want to integrate video generation into apps without paying for API access.
