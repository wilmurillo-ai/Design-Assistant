---
name: maker-text-generator
version: "1.0.0"
displayName: "Maker Text Generator — Generate Text Overlays for Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate on-screen text labels and title cards for my video — and get text-overlaid videos back in 20-40 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI text generation automatically. Ideal for content creators who want to add professional text overlays without manual design work.
