---
name: ai-animation-software
version: "1.0.0"
displayName: "AI Animation Software — Generate Animated Videos from Images"
description: >
  Get animated video clips ready to post, without touching a single slider. Upload your images or text (PNG, JPG, MP4, GIF, up to 500MB), say something like "animate these frames into a smooth 30-second explainer video with motion and transitions", and download 1080p MP4 when it's done. Built for content creators, marketers, educators who move fast and want to produce animations without manual frame-by-frame design skills.
