---
name: podcast-video-free
version: "1.0.0"
displayName: "Podcast Video Free — Convert Podcast Audio to Video"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn my podcast audio into a video with waveform animation and captions — and get podcast video files back in 1-2 minutes. Upload MP3, MP4, WAV, MOV files up to 500MB, and the AI handles AI podcast video creation automatically. Ideal for podcasters who want to publish podcast episodes on YouTube or social media without complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `podcast-video-free` |
