---
name: ai-video-maker-sora
version: "1.0.0"
displayName: "AI Video Maker Sora — Generate Videos from Text Prompts"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, PNG, up to 200MB), say something like "generate a 10-second video of a sunset over a city skyline", and download 1080p MP4 when it's done. Built for content creators who move fast and want to create videos without filming or editing skills.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-maker-sora` |
