...
name: ai-photo-video
version: "1.0.0"
displayName: "AI Photo Video — Convert Photos Into Shareable Videos"
description: >
  Get animated photo videos ready to post, without touching a single slider. Upload your images or photos (JPG, PNG, HEIC, WEBP, up to 200MB), say something like "turn these photos into a 30-second slideshow video with music and transitions", and download 1080p MP4 when it's done. Built for social media creators who move fast and want to create videos from photos without editing software.
