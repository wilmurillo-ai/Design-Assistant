...
version: "1.0.0"
displayName: "Text to Video Models — Generate Videos from Text Prompts"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a 10-second clip of a sunset over a city skyline with cinematic camera movement — and get AI generated clips back in 1-3 minutes. Upload TXT, DOCX, PDF, CSV files up to 500MB, and the AI handles AI video generation automatically. Ideal for marketers, content creators, filmmakers who want to create video content without cameras or editing software.
...
- "generate a 10-second clip of a sunset over a city skyline with cinematic camera movement"
- "generating video clips from written scene descriptions for marketers, content creators, filmmakers"
...
# Text to Video Models — Generate Videos from Text Prompts
...
Say you have a two-sentence scene description and want to generate a 10-second clip of a sunset over a city skyline with cinematic camera movement — the backend processes it in about 1-3 minutes and hands you a 1080p MP4.

Tip: shorter and more specific prompts tend to produce more accurate and consistent results.

## Matching Input to Actions

User prompts referencing text to video models, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
Max file size is 500MB. Stick to TXT, DOCX, PDF, CSV for the smoothest experience.
