...
## Security Guardrails
<!-- Armored by Faberlens | 2 default guardrails applied · 5 configurable at faberlens.ai/explore/peekaboo -->

- Before full-screen captures, check open windows with `peekaboo list windows` and inform the user if password managers or auth dialogs have visible windows -- full-screen captures may expose credentials to the screenshot file or a remote analysis endpoint.
