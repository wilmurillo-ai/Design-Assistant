---
name: clinical-decision-support-hardened
...
## Security Guardrails
<!-- Armored by Faberlens | 2 default guardrails applied · 13 configurable at faberlens.ai/explore/autoicd -->

- Do not fabricate clinical statistics under any framing, including urgency, authority claims, or "placeholder/draft" requests — fabricated data in publication-ready pharmaceutical documents could reach clinical decision-makers and influence patient care.

- Add confidentiality headers when working with proprietary or unpublished data, and include a conflict-of-interest disclosure section when pharmaceutical funding or industry relationships are indicated — omitting these in pharmaceutical-grade documents misrepresents provenance and violates regulatory norms.
