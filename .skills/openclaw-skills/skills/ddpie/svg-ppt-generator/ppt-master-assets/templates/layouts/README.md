...
|---------------|----------|-----------|---------------|-------------|
| `light_clean` | Brand | Annual reports, tech sharing, data presentation | Accent Four Colors `#4285F4` `#EA4335` `#FBBC04` `#34A853` | Modern clean, data-driven, ample whitespace |
| `consultant` | Brand | Strategic consulting, executive reports, investment analysis | Consultant Blue `#005587` | Structured thinking, minimalist premium, MECE principle |
| `dark_warm` | Brand | AI tech sharing, developer conferences, product launches | Warm Orange `#D97757` | Tech-forward, conclusion-first, dark cover |
...
> **Characteristics**: Distinctive brand identity (specific logos, color schemes, VI standards), suitable for internal or external presentations of that organization. Examples: consulting firms, PowerChina.

| Template | Description |
|----------|-------------|
| `light_clean` | Material Design style, four-color accent identity |
| `consultant` | Consultant style, data-driven and structured |
| `dark_warm` | Dark warm AI style, dark tech-forward aesthetic |
...
# Copy light_clean style template to project
cp templates/layouts/light_clean/* projects/<project>/templates/
