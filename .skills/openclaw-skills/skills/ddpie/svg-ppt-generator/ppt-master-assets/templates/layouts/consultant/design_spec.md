...
| **Theme Mode** | Light theme (white background + Consultant Blue accent)      |
...
| Role             | Value       | Notes                            |
| ---------------- | ----------- | -------------------------------- |
| **Consultant Blue**| `#005587`   | Primary color, title bar, accent elements |
...
| ---------- | --------------- | -------------------------------------- |
| **Top**    | y=0, h=4px      | Consultant Blue horizontal bar           |
...
- **Left Accent Bar**: Consultant Blue (`#005587`), width 8px (cover page)
- **Top Decoration Line**: Consultant Blue (`#005587`), height 4px
...
- Consultant Blue full-screen background
...
- [ ] viewBox = `0 0 1280 720`
- [ ] Consultant Blue consistently applied
