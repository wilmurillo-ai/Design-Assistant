# Dark Warm Style Template - Design Specification
...
| -------------- | ------------------------------------------------------ |
| **Template Name** | dark_warm (Dark Warm Style Template)                |
...
| Role             | Value       | Notes                            |
| ---------------- | ----------- | -------------------------------- |
| **Warm Orange** | `#D97757` | Brand identity, title emphasis, key data |
...
| -------------- | --------------- | -------------------------------------- |
| **Top**        | y=0, h=6-8px    | Warm Orange decorative bar        |
...
- **Top Orange Bar**: Warm Orange (`#D97757`), height 6px
