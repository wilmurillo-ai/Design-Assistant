---
name: add-subtitle-to-video-ai
version: "1.0.0"
displayName: "Add Subtitle to Video AI — Generate and Burn In Captions"
description: >
  Get captioned video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "add captions in English and Spanish", and download 1080p MP4 when it's done. Built for YouTubers and content creators who move fast and need captions added quickly without manual transcription.
...
# Add Subtitle to Video AI — Generate and Burn In Captions
...
Say you have a 3-minute YouTube tutorial recording and want to add captions in English and Spanish — the backend processes it in about 30-60 seconds and hands you a 1080p MP4.

Tip: shorter clips under 5 minutes process significantly faster.

## Matching Input to Actions

User prompts referencing add subtitle to video ai, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `add-subtitle-to-video-ai`
