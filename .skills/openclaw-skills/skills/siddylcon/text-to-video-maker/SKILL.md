...
version: "1.0.0"
displayName: "Text to Video Maker — Convert Text into Shareable Videos"
description: >
  Turn a 150-word product description into 1080p ready-to-share videos just by typing what you need. Whether it's turning written content into short shareable videos or quick social content, drop your written text and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
- "turning written content into short shareable videos for marketers, content creators, small business owners"
...
# Text to Video Maker — Convert Text into Shareable Videos
...
Tip: shorter text prompts under 100 words tend to produce tighter, more focused videos.

## Matching Input to Actions

User prompts referencing text to video maker, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-maker` |
