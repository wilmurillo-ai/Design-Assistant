---
name: free-video-editing
version: "1.0.0"
displayName: "Free Video Editing — Edit and Export Videos Online"
description: >
  edit raw video clips into edited MP4 clips with this free-video-editing skill. Works with MP4, MOV, AVI, WebM files up to 500MB. students, casual creators, social media users use it for editing raw footage into shareable videos without paid software — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
# Free Video Editing — Edit and Export Videos Online
...
Say you have a 2-minute unedited phone recording and want to trim the pauses, add background music, and export as MP4 — the backend processes it in about 1-2 minutes and hands you a 1080p MP4.

Tip: shorter clips under 3 minutes process significantly faster.

## Matching Input to Actions

User prompts referencing free video editing, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-video-editing` |
