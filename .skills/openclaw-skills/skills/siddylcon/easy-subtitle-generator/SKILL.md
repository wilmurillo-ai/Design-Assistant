---
name: easy-subtitle-generator
version: "1.0.0"
displayName: "Easy Subtitle Generator — Generate and Burn In Captions"
description: >
  Cloud-based easy-subtitle-generator tool that handles adding subtitles to YouTube videos. Upload MP4, MOV, AVI, WebM files (up to 500MB), describe what you need, and get 1080p MP4 output in 30-60 seconds. Built for YouTubers and content creators who work with video files.
...
# Easy Subtitle Generator — Generate and Burn In Captions
...
User prompts referencing easy subtitle generator, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `easy-subtitle-generator`
