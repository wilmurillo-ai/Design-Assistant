---
name: text-to-video-online
version: "1.0.0"
displayName: "Text to Video Online — Convert Text into Shareable Videos"
description: >
  Turn a 150-word product description into 1080p finished video clips just by typing what you need. Whether it's converting written content into shareable videos or quick social content, drop your written text and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
- "converting written content into shareable videos for marketers, bloggers, social media creators"
...
# Text to Video Online — Convert Text into Shareable Videos
...
Tip: shorter text inputs under 100 words tend to produce tighter, more focused videos.

## Matching Input to Actions

User prompts referencing text to video online, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-online` |
