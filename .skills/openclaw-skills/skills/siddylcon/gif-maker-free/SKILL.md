...
name: gif-maker-free
version: "1.0.0"
displayName: "GIF Maker Free — Convert Video Clips to GIFs"
description: >
  Get looping GIF files ready to post, without touching a single slider. Upload your video clips or images (MP4, MOV, GIF, WebM, up to 200MB), say something like "convert this video clip into a looping GIF", and download 720p MP4 when it's done. Built for social media users and content creators who move fast and want to make GIFs quickly without paying for software.
...
# GIF Maker Free — Convert Video Clips to GIFs
...
Worth noting: clips under 6 seconds produce the smoothest, smallest GIFs.

## Matching Input to Actions

User prompts referencing gif maker free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
Export as MP4 for widest compatibility if sharing on platforms that support video.
