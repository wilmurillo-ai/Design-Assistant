# Sports Highlight Video Marketing Skill
...
- Athletic recruitment reels (high school to college, college to pro)
- Game and match highlights for team social media
- Individual athlete personal branding
- Sports club and league marketing
- Youth sports organization parent engagement
- Sports facility and training center marketing
- Event coverage for tournaments and championships

## Video Types for Sports Content

### 1. Individual Athlete Highlight Reel
...
### 3. Season Highlight Compilation
...
### 9. Pre-Game and Post-Game Content
...
### 10. Facility and Equipment Showcase
For sports facilities, training centers, and equipment businesses. Show the environment and tools athletes use.

## Script Templates

### Template 1: Individual Athlete Recruitment Reel Narration (Voice-Over for 4-Minute Reel)
...
### Template 2: Game Recap Social Media Video (90 seconds)
...
### Template 3: Sports Facility Marketing (60 seconds)
...
## Filming Tips for Sports Content

### Equipment for Sports Videography

**Essential:**
- Camera with good autofocus tracking (Sony A7IV, Canon R6, or similar)
- 70-200mm f/2.8 lens for field sports (versatile, sufficient reach)
- Wide angle (24-70mm equivalent) for facility and sideline shots
- Extra batteries (2-3 minimum for long events)
- Fast SD cards (UHS-II minimum)
- Monopod for stability while tracking action

**Advanced:**
- 400mm or longer for baseball, football (distant action)
- Gimbal for smooth tracking shots
- Drone for aerial perspective (FAA Part 107 certification required for commercial use)
- Wireless microphone for interviews and sideline audio
- Laptop for same-day editing delivery

### Camera Settings for Sports
- Shutter speed: 2x your frame rate minimum (1/250 at minimum for 120fps slow motion)
- Autofocus: Continuous AF, subject tracking enabled
- Frame rate: 24fps for cinematic look; 120fps for slow motion segments; 60fps for web delivery
- ISO: Keep as low as possible; modern cameras handle ISO 3200-6400 acceptably
- Burst mode: For peak action moments in photography alongside video

### Positioning Strategy
- **Primary position:** Where the most consequential action occurs (goal mouth in soccer, key in basketball, end zone in football)
- **Secondary position:** Opposite side for different angle coverage
- **Wide shot position:** For context and team play visualization
- **Sideline level:** Lower angle makes athletes look more powerful and impressive
- Move positions at half-time or between periods

### Slow Motion Usage
Slow motion is the most powerful tool in sports video:
- Reserve it for exceptional moments: key scores, big hits, impressive technique
- Overuse dilutes impact — use at 20-30% of total edit maximum
- 120fps gives smooth 4x slow motion; 240fps gives 8-10x for extreme slow motion
- Pair slow motion with music transition for maximum emotional impact

### Lighting Considerations
- Indoor facilities vary dramatically: professional arenas are well-lit; high school gyms often struggle
- Increase ISO for dim indoor venues and accept some grain — sharp and slightly grainy beats blurry at proper exposure
- Evening outdoor games have good quality light during the first and last 30 minutes
- Overcast days provide excellent even light for outdoor sports
- Avoid shooting directly into bright stadium or gymnasium lights

## Platform Strategy

### Instagram
**Primary platform for athlete and team highlights**
- Reels: Game highlights, training clips, big play moments
- Stories: Game day content, locker room energy (appropriate), real-time score updates
- Feed: Season compilations, player profiles, achievement announcements
- Best times: Post highlights within 2 hours of game completion for maximum engagement
- Top hashtags: #highlights #[sport]highlights #[sport] #recruitmevideo #athletelife #[conference] #[state]sports

### TikTok
**Fastest growing platform for sports content**
- Reaction content ("watch me watch my own highlight")
- Training montage content
- Skills breakdown with explanation
- "Rate my [sport] technique" engagement content
- Partner with trending sounds for montage content

### YouTube
**Home for long-form sports content**
- Full recruitment reels (5-7 minutes)
- Player profile documentaries
- Game film breakdowns and analysis
- Season highlight compilations (10-15 minutes)
- Training tutorial content

### Twitter/X
**Real-time sports conversation platform**
- Post game highlight clips immediately after games
- Engage with team and league conversations
- Tag athletes, teams, and programs in relevant content
- Use event hashtags for tournament visibility

### Hudl and NCSA
**Recruitment-specific platforms**
- All recruitment content should be hosted on Hudl for coaches
- NCSA and other recruiting platforms have specific format requirements
- YouTube serves as the public-facing version of the same reel

## Workflow for Event Coverage

### Pre-Event (Day Before)
- Scout the venue: identify best camera positions, lighting assessment, power access
- Confirm with client: key players to feature, key moments to capture, delivery timeline
- Charge all batteries, format all cards, test all equipment
- Plan shot list and sequences to capture

### During Event
- Arrive 30-60 minutes before game time for warm-ups (excellent technical content)
- Establish primary position and set exposure for current lighting conditions
- Capture at least 3 angles of every major play if possible
- Film interviews during breaks and immediately post-game
- Back up footage to second card or drive during halftime if long event

### Post-Event Edit Workflow
**Same-Day Delivery (Social Media Highlight):**
1. Import and cull footage (15-20 min)
2. Select 8-12 best moments (10 min)
3. Rough cut to music (20-30 min)
4. Color grade and text overlays (15-20 min)
5. Export and post (10 min)
Total: 70-90 minutes

**Full Recruitment Reel:**
1. Import and organize all footage (1-2 hours)
2. Create athlete skill breakdown spreadsheet
3. Select 30-50 best plays per skill category
4. Build sequence: opening hero moment, skill sections, stats close
5. Sync to music, color grade, add graphics package
6. Review with athlete/family, revise, deliver
Total: 8-15 hours
...
### Sports Parent Community Building
...
This skill enables:
1. Recruitment reel narration scripts customized for specific athletes and sports
2. Game recap video scripts and caption packages
3. Event coverage shot lists and production plans for any sport
4. Platform-specific caption and hashtag packages for sports content
5. Season content calendar planning
6. Parent community content packages
