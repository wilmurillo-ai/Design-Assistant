...
version: "1.0.0"
displayName: "Image to Video Deepfake — Animate photos into video clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — animate this photo to match the lip movements in the attached audio clip — and get animated face video back in 30-90 seconds. Upload JPG, PNG, WEBP, HEIC files up to 50MB, and the AI handles AI face animation automatically. Ideal for content creators, filmmakers, digital artists who want to bring still images to life without filming real footage.
...
# Image to Video Deepfake — Animate photos into video clips

Send me your portrait images and describe the result you want. The AI face animation runs on remote GPU nodes — nothing to install on your machine.
...
**Quick edit**: Upload → "animate this photo to match the lip movements in the attached audio clip" → Download MP4. Takes 30-90 seconds for a 30-second clip.
...
The backend processes faster when you're specific. Instead of "make it look better", try "animate this photo to match the lip movements in the attached audio clip" — concrete instructions get better results.
