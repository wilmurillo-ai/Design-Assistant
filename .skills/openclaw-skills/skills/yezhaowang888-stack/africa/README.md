...
[![Version](https://img.shields.io/badge/version-1.0.0-green.svg)](https://clawhub.ai/skills/africa-policy-query)
...
非洲市场政策查询Skill - 提供非洲市场政策、法规、投资环境的智能查询和分析
...
```javascript
const PolicyQuery = require('africa-policy-query');
...
### 运行测试
```bash
cd node_modules/africa-policy-query
npm test
```
