...
const SLUG = "ai-diagram-generator";
const VERSION = "1.0.0";
...
function main() {
  console.log(`\n  Diagram Generator — OpenClaw Skill Installer v${VERSION}`);
  ...
  console.log("  2. bash scripts/diagram.sh generate flowchart \"user login flow\"");
  console.log("  3. bash scripts/diagram.sh help");
  console.log("");
}
