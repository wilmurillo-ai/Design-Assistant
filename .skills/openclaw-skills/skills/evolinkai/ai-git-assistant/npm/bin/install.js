...
function main() {
  console.log(`\n  Git Assistant — OpenClaw Skill Installer v${VERSION}`);
  ...
  console.log("  2. git add . && bash scripts/git-assist.sh commit");
  console.log("  3. bash scripts/git-assist.sh help");
  console.log("");
}
