...
function main() {
  console.log(`\n  Email Assistant — OpenClaw Skill Installer v${VERSION}`);
  ...
  console.log("  2. bash scripts/email.sh generate welcome");
  console.log("  3. bash scripts/email.sh help");
  console.log("");
}
