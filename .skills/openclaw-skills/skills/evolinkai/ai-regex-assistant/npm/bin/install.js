...
function main() {
  console.log(`\n  Regex Assistant — OpenClaw Skill Installer v${VERSION}`);
  ...
  console.log("  2. bash scripts/regex.sh generate \"match email addresses\"");
  console.log("  3. bash scripts/regex.sh help");
  console.log("");
}
