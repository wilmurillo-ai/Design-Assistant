...
const SLUG = "ai-subtitle-assistant";
const VERSION = "1.0.0";
...
function main() {
  console.log(`\n  Subtitle Assistant — OpenClaw Skill Installer v${VERSION}`);
  ...
  console.log("  2. export EVOLINK_API_KEY=\"your-key-here\"");
  console.log("     Get a free key: https://evolink.ai/signup");
  console.log("  3. bash scripts/subtitle.sh summarize \"https://youtube.com/watch?v=...\"");
  console.log("  4. bash scripts/subtitle.sh help");
  console.log("");
}
