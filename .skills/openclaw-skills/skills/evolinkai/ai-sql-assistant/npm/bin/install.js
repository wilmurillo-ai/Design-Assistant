...
function main() {
  console.log(`\n  SQL Assistant — OpenClaw Skill Installer v${VERSION}`);
  ...
  console.log("  2. bash scripts/sql.sh query \"find all active users\" --db postgres");
  console.log("  3. bash scripts/sql.sh help");
  console.log("");
}
