...
> Universal quality standards and validation criteria for all CRIF outputs. Apply before delivery.
...
These criteria apply to **all outputs** from CRIF. Every output must meet all 7 criteria. Each output type emphasizes different criteria based on its purpose, but all 7 are evaluated for every deliverable.
