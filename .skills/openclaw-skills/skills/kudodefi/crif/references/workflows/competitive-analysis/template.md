...
- Terminology Rules: PRESERVE English (domain-specific | proper noun | precision-critical | community-standard), otherwise TRANSLATE (see core-config.md)
...
> **Format:** Structured recommendations with supporting evidence. See `./references/workflows/competitive-analysis/objectives.md` for purpose-specific format guidance
