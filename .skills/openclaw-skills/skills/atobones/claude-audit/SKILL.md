---
name: claude-audit
description: "Full project audit — launches 5 parallel AI agents (security, bugs, dead code, architecture, performance) to scan your codebase read-only, then compiles a unified report with health grade (A+ to F) and offers surgical fixes. Language-agnostic. Zero config."
version: 1.0.0
metadata:
  openclaw:
    emoji: "🔍"
    homepage: https://github.com/atobones/claude-audit
