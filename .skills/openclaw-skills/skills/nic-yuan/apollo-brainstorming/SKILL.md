---
name: apollo-brainstorming
description: >
  做新东西之前，先帮你把问题想清楚、方向理顺。
---

# Apollo Brainstorming - 想法到设计
...
6. **写设计文档** — 保存到 `docs/apollo/YYYY-MM-DD-<topic>-design.md` 并 commit
7. **规格自审** — 快速内联检查占位符、矛盾、模糊、范围
8. **主人审查书面规格** — 在继续之前请主人审查规格文件
9. **过渡到实现** — 调用 `apollo-writing-plans` 技能创建实现计划
...
**文档：**
- 将经验证的设计（规格）写到 `docs/apollo/YYYY-MM-DD-<topic>-design.md`
- Commit 设计文档到 git
...
**实现：**
- 调用 `apollo-writing-plans` 技能创建详细实现计划
