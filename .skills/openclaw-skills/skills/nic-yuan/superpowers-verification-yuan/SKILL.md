...
description: >
  ...
  Requires running fresh verification commands and reading actual output before making any success claims.
  Evidence before assertions always. Triggered by: user says "done", "fixed", "working", "complete",
  "passed", "verified", or before any commit/PR/merge. Part of the superpowers suite.
version: 1.0.2
read_when:
