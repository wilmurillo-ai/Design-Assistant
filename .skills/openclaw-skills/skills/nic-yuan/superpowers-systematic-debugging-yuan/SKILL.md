...
description: >
  ...
  Enforces systematic four-phase debugging: root cause investigation, pattern analysis,
  hypothesis testing, and evidence-based fix verification. HARD GATE: no fixes without root cause investigation.
  Triggered by: bug report, test failure, error, unexpected behavior, "debug this", "it's broken".
  Part of the superpowers suite.
version: 1.0.2
read_when:
