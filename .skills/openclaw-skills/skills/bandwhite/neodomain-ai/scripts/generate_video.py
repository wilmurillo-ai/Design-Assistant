...
def submit_video_generation(token: str, **params):
    ...
    payload = {
        "modelName": params.get("model", "veo3"),
...
def main():
    ...
    # Model options
    parser.add_argument("--model", default="veo3", help="Model name (veo3, hailuo02, doubao)")
    ...
    parser.add_argument("--image-urls", help="Comma-separated reference image URLs (for REFERENCE_TO_VIDEO)")
    
    # Video options
    parser.add_argument("--aspect-ratio", default="16:9", 
                        choices=["16:9", "9:16", "1:1"], help="Aspect ratio")
    parser.add_argument("--resolution", default="720p",
                        choices=["720p", "768p", "1080p"], help="Resolution")
    parser.add_argument("--duration", default="8s",
                        choices=["4s", "5s", "6s", "8s", "10s", "16s"], help="Duration")
