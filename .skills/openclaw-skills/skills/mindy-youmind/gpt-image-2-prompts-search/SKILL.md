...
description: |
  ...
  - Generate images with AI (any model — GPT Image 2, GPT Image 1.5, Nano Banana Pro, Seedream, etc.)
...
https://github.com/YouMind-OpenLab/gpt-image-2-prompts-search/tree/main/references
