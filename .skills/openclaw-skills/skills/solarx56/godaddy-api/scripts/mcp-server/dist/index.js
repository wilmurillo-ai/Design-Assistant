...
const doRequest = async (method, path, query, body) => {
...
const tools = [
    ...
    },
    {
        ...
        handler: async ({ domain, checkType, forTransfer }) => doRequest("GET", "/v1/domains/available", { domain, checkType, forTransfer }),
    },
    {
