...
> **Dependencies**: Model files (GLM-OCR-Q8_0.gguf, mmproj-GLM-OCR-Q8_0.gguf) are downloaded
> via Python's `huggingface_hub` (hf download) or `modelscope`. If Python is not installed,
> Step 2 will automatically install **Miniforge** (recommended — lightweight, includes conda/pip,
