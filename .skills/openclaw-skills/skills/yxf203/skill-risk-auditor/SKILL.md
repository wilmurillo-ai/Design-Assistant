...
version: 1.0.0
description: >
  Comprehensive pre-install guard that audits third-party skills across nine risk
  areas — covering semantic integrity, supply chain, secrets, data exfiltration,
  injection resistance, permission scope, destructive potential, resource abuse,
  and persistence — with clear severity levels and plain-language explanations
  so users can make informed decisions.
---

# Skill Risk Auditor

Pre-install guard skill that checks candidate skills across nine risk areas, rates each one, and gives you a clear overall risk picture. Instead of a single pass/fail, you get a breakdown of where the risks are and how serious they are, explained in language anyone can understand.
...
Before installing or enabling any externally sourced skill.
...
Each area also includes a priority tag: **High Priority** (areas where problems tend to cause the most damage) or **Standard Priority** (still important, but consequences tend to be more contained).

## Risk Areas

### Area 1 — Semantic & Structural Integrity (High Priority)
...
### Area 3 — Secret & Credential Exposure (High Priority)
...
### Area 5 — Injection & Influence Resistance (High Priority)
...
### Area 6 — Permission & Access Scope (High Priority)
...
### Area 7 — Destructive Potential (Standard Priority)
...
### Area 9 — Persistence (Standard Priority)
...
| Overall Risk       | Indicator  | What It Means                                                                                                     |
| ------------------ | ---------- | ----------------------------------------------------------------------------------------------------------------- |
...
The report is designed so a non-technical user can understand the overall risk within the first few lines, then drill into details only if they want to.

```
╔══════════════════════════════════════════════════════════════╗
║  RISK ASSESSMENT — [Skill Name]                             ║
╠══════════════════════════════════════════════════════════════╣
...
│   Explain the key risks as if talking to a friend.           │
│   Example: "This skill says it only formats code, but we     │
│   found it also tries to read your saved passwords and       │
│   send them to an unknown website. That's a serious red      │
│   flag — we recommend not installing it."]                   │
│                                                              │
│  WHAT YOU CAN DO:                                            │
│  [Specific, actionable suggestions in plain language.        │
│   Example: "Ask the author to explain why the skill needs    │
│   network access. Until then, don't install it."]            │
└──────────────────────────────────────────────────────────────┘

─── HIGH PRIORITY AREAS (most likely to cause real damage) ────

  1. Semantic & Structural Integrity
     [##...]  Moderate
     In short: [one sentence a non-expert can understand]
     Evidence: [specific finding from the skill]

  2. Supply Chain & Source Verification
     [.....]  No Concern
  ...
  4. Data Privacy & Exfiltration
     [###..]  Serious
     In short: [one sentence]
     Evidence: [specific finding]

  5. Injection & Influence Resistance
     [#....]  Minor
     In short: [one sentence]
     Evidence: [specific finding]

  6. Permission & Access Scope
     [##...]  Moderate
     In short: [one sentence]
     Evidence: [specific finding]

─── STANDARD PRIORITY AREAS (important but more contained) ────
...
─── CROSS-AREA CONNECTIONS ────────────────────────────────────
  ...
  [If findings in different areas connect to each other,
   explain the connection here. Example:
   "Area 3 found the skill reads your AWS keys, and Area 4
    found it sends data to an undisclosed server. Together,
    this suggests your credentials could be stolen."]
