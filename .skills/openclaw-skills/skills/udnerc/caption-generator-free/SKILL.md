---
name: caption-generator-free
version: "1.0.0"
displayName: "Caption Generator Free — Auto-Generate Captions for Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add captions in English and Spanish to my video — and get captioned video files back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI subtitle generation automatically. Ideal for content creators who need captions without paying for expensive software.
...
# Caption Generator Free — Auto-Generate Captions for Videos
...
A quick example: upload a 3-minute YouTube tutorial video, type "add captions in English and Spanish to my video", and you'll get a 1080p MP4 back in roughly 30-60 seconds. All rendering happens server-side.

Worth noting: shorter clips under 2 minutes generate captions significantly faster.

## Matching Input to Actions

User prompts referencing caption generator free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `caption-generator-free`
