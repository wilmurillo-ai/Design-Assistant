# 场景 12 [驾驶证识别]
**适用场景**: 驾驶证识别接口利用夸克高精度的基础OCR识别能力，结合夸克自研的文档大模型基础，实现对驾驶证识别内容信息的提取，支持""证号", "姓名", "性别","住址", "出生日期", "初次领证日期", "准驾车型", "有效期限", "档案编号"等11个行驶证字段信息的提取。
...
python3 scripts/scan.py \
  ...
  --input-configs '{"function_option":"RecognizeDriverLicense"}' \
