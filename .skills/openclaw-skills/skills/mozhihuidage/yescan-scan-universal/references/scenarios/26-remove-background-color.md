# 场景 26 [文档去底色]
**适用场景**: 文档去色接口采用最新AI图像算法，将彩色文档智能调整为白底黑字文档，同时将文档质感增强，使文档更清晰的展现。且能将由于纸质偏薄透过页面的字迹精准智能消除，使用户更加高效便捷的使用文档。适用于深底色文档打印，板书图片扫描等场景。
...
python3 scripts/scan.py \
  --url "${IMAGE_URL}" \
  --service-option "scan" \
  --input-configs '{"function_option":"monochrome"}' \
