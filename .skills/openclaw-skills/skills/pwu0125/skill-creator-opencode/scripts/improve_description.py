...
by calling `opencode run` as a subprocess — uses Opencode CLI.
"""
...
def _find_opencode() -> str:
    ...
    # Default fallback
    return str(home / ".opencode" / "bin" / "opencode")
...
def _call_claude(prompt: str, model: Optional[str], timeout: int = 300) -> str:
    ...
    Uses Opencode CLI instead of Claude Code CLI.
    Auto-detects opencode installation path.
    """
