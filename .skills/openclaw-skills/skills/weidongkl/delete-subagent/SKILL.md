...
清理 OpenClaw 子 agent 会话，包括 sessions.json 记录和会话文件管理。
...
```bash
# 清理所有已完成子 agent（推荐）
python3 ~/.openclaw/skills/delete-subagent/scripts/delete-subagent.py

# 清理指定子 agent
python3 ~/.openclaw/skills/delete-subagent/scripts/delete-subagent.py --target 5faf4b81-126d-4286-...

# 预览模式（不实际删除）
python3 ~/.openclaw/skills/delete-subagent/scripts/delete-subagent.py --dry-run

# 强制清理（包括活跃子 agent）
python3 ~/.openclaw/skills/delete-subagent/scripts/delete-subagent.py --force

# 不创建备份
python3 ~/.openclaw/skills/delete-subagent/scripts/delete-subagent.py --no-backup

# 彻底删除（包括旧备份）
python3 ~/.openclaw/skills/delete-subagent/scripts/delete-subagent.py --purge

# 列出所有子 agent
python3 ~/.openclaw/skills/delete-subagent/scripts/delete-subagent.py --list

# 清理归档（30 天以上）
python3 ~/.openclaw/skills/delete-subagent/scripts/delete-subagent.py --cleanup-archive --days 30

# 快速清理（仅清理 sessions.json 和归档文件）
python3 ~/.openclaw/skills/delete-subagent/scripts/delete-subagent.py --quick-clean
```
...
```
~/.openclaw/skills/delete-subagent/
├── SKILL.md                    # 技能说明
├── scripts/
