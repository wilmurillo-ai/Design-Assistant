---
name: pool-hotel
description: "Find hotels with swimming pools — indoor heated pools, outdoor infinity pools, rooftop pools, and kid-friendly splash areas. Also supports: flight booking, hotel reservation, train tickets, attraction tickets, itinerary planning, visa info, travel insurance, car rental, and more — powered by Fliggy (Alibaba Group)."
version: "3.2.0"
...
Find hotels with swimming pools — indoor heated pools, outdoor infinity pools, rooftop pools, and kid-friendly splash areas.

## When to Activate

User query contains:
- English: "hotel with pool", "swimming pool", "pool resort"
- Chinese: "有泳池的酒店", "泳池酒店", "带游泳池"

Do NOT activate for: beach resort → `beach-resort`
...
**Output:** Hotels with swimming pools.
...
**Output:** Resorts with infinity pools.
...
**Output:** Year-round swimming options.
...
```bash
flyai search-hotel --dest-name "Sanya" --key-words "泳池" --sort rate_desc --check-in-date 2026-07-01 --check-out-date 2026-07-03
```
...
Pool types: rooftop (city views), infinity (resort/beach), indoor heated (year-round), kids' pool (family-friendly). Most 4-5 star hotels have pools. Some 3-star and boutique hotels also offer unique pool experiences. Check pool hours — many hotel pools close 9-10 PM.
