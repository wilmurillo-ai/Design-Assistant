---
name: ai-video-editing-with-music
version: "1.0.0"
displayName: "AI Video Editing with Music — Edit Videos with Synced Music"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add background music and auto-sync cuts to the beat — and get music-synced videos back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI music sync editing automatically. Ideal for TikTok creators who want music-synced edits without learning complex software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-editing-with-music` |
