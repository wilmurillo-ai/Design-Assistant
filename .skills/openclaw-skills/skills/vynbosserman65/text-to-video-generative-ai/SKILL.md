---
name: text-to-video-generative-ai
version: "1.0.0"
displayName: "Text to Video Generative AI — Turn Text Prompts into Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a 15-second video of a sunset over a city skyline with cinematic camera movement — and get AI-generated videos back in 1-3 minutes. Upload TXT, DOCX, PDF, plain text files up to 500MB, and the AI handles AI video generation automatically. Ideal for marketers, content creators, social media managers who want to produce video content without cameras, actors, or editing skills.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-generative-ai` |
