...
name: text-to-free
version: "1.0.0"
displayName: "Text to Free Video — Generate Videos from Text"
description: >
  convert text prompt into generated video clips with this skill. Works with TXT, DOCX, PDF, plain text files up to 200MB. content creators use it for generating videos from written descriptions or scripts — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
