...
name: letter-maker
version: "1.0.0"
displayName: "Letter Maker — Turn Written Letters Into Videos"
description: >
  Get animated letter videos ready to post, without touching a single slider. Upload your text or images (MP4, MOV, PNG, JPG, up to 200MB), say something like "turn my written letter into a video with animated text and background music", and download 1080p MP4 when it's done. Built for content creators, students, marketers who move fast and want to turn written messages into shareable video format quickly.
