---
name: text-to-video-open-ai
version: "1.0.0"
displayName: "Text to Video AI — Generate Videos from Text"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn this script into a 30-second video with visuals and background music — and get AI generated videos back in 1-2 minutes. Upload TXT, DOCX, PDF, SRT files up to 200MB, and the AI handles AI video creation automatically. Ideal for marketers, content creators, social media managers who want to create videos without filming or editing skills.
...
A quick example: upload a 3-sentence product description, type "turn this script into a 30-second video with visuals and background music", and you'll get a 1080p MP4 back in roughly 1-2 minutes. All rendering happens server-side.

Worth noting: shorter, clearer prompts produce more accurate video scenes.

## Matching Input to Actions

User prompts referencing text to video open ai, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-open-ai` |
