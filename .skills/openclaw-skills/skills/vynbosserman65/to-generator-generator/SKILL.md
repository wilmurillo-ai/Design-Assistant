---
name: to-generator-generator
version: "1.0.0"
displayName: "To Generator Generator — Generate Videos From Text Prompts"
description: >
  Get generated video clips ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, MP4, up to 200MB), say something like "generate a video from this prompt: 'a sunrise over a mountain range with cinematic panning'", and download 1080p MP4 when it's done. Built for content creators who move fast and want to create videos without filming or editing manually.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `to-generator-generator` |
