---
name: text-to-video-grok
version: "1.0.0"
displayName: "Text to Video Grok — Generate Videos from Text Prompts"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, RTF, up to 500MB), say something like "generate a 30-second video of a sunset over a city skyline with cinematic camera movement", and download 1080p MP4 when it's done. Built for content creators who move fast and want to create videos without cameras or editing skills.
...
# Text to Video Grok — Generate Videos from Text Prompts
...
User prompts referencing text to video grok, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `text-to-video-grok`
...
Max file size is 500MB. Stick to TXT, DOCX, PDF, RTF for the smoothest experience.
