---
name: create-ai-videos
version: "1.0.0"
displayName: "Create AI Videos — Generate Videos from Text or Images"
description: >
  generate text or images into AI-generated videos with this create-ai-videos skill. Works with MP4, MOV, PNG, JPG files up to 500MB. marketers, social media creators use it for generating short videos from text prompts or images — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
