---
name: video-editing-and-ai
version: "1.0.0"
displayName: "Video Editing and AI — Edit and Export AI Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — cut the pauses, add transitions, and export a clean final video — and get AI-edited videos back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI-powered video editing automatically. Ideal for content creators and marketers who want fast professional edits without learning complex editing software.
...
- "automatically editing raw footage into polished videos using AI for content creators and marketers"
...
# Video Editing and AI — Edit and Export AI Videos
...
Worth noting: shorter clips under 2 minutes process significantly faster and give more accurate AI cuts.

## Matching Input to Actions

User prompts referencing video editing and ai, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `video-editing-and-ai`
