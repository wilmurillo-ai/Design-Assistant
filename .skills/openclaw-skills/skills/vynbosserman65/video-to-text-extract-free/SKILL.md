...
version: "1.0.0"
displayName: "Video To Text Extract Free — Extract Text From Any Video"
description: >
  Get plain text transcript ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "extract all spoken words from this video as a text transcript", and download 1080p MP4 when it's done. Built for students, journalists, content creators who move fast and need spoken video content converted to text without paying for transcription software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-to-text-extract-free` |
