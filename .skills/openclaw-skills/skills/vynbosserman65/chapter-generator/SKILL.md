...
version: "1.0.0"
displayName: "Chapter Generator — Generate Timestamped Chapters for Videos"
description: >
  Turn a 45-minute tutorial video recording into 1080p chaptered video file just by typing what you need. Whether it's adding timestamped chapters to long YouTube or course videos or quick social content, drop your long-form video and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `chapter-generator` |
