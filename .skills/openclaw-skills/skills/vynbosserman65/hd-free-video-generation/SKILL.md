---
name: hd-free-video-generation
version: "1.0.0"
displayName: "HD Free Video Generation — Generate HD Videos From Text"
description: >
  Turn a short text description of a beach sunset scene into 1080p HD video clips just by typing what you need. Whether it's generating HD videos from text prompts at no cost or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `hd-free-video-generation` |
