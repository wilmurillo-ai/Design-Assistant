...
version: "1.0.0"
displayName: "Text to Video IO — Convert Text Into AI Videos"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, SRT, up to 200MB), say something like "turn this script into a 30-second video with visuals and background music", and download 1080p MP4 when it's done. Built for marketers, content creators, educators who move fast and want to create videos without cameras or editing software.
