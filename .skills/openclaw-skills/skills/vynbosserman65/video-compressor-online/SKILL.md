...
version: "1.0.0"
displayName: "Video Compressor Online — Compress and Download Smaller Videos"
description: >
  compress large video files into compressed MP4 files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators, students, marketers use it for reducing video file size for upload or sharing — processing takes 30-90 seconds on cloud GPUs and you get 1080p MP4 files.
...
# Video Compressor Online — Compress and Download Smaller Videos
...
A quick example: upload a 500MB 1080p MP4 recording, type "compress this video to under 50MB without losing quality", and you'll get a 1080p MP4 back in roughly 30-90 seconds. All rendering happens server-side.

Worth noting: shorter clips compress faster and give more predictable output sizes.

## Matching Input to Actions

User prompts referencing video compressor online, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `video-compressor-online`
