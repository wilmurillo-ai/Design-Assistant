---
name: ai-video-editor-change-clothes
version: "1.0.0"
displayName: "AI Video Editor Change Clothes — Swap Outfits in Any Video"
description: >
  Get reclothed video clips ready to post, without touching a single slider. Upload your video footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "change the outfit in my video to a formal suit and keep all movements natural", and download 1080p MP4 when it's done. Built for content creators, fashion marketers, TikTok creators who move fast and want to change outfits in existing video without filming again.
