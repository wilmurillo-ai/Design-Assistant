---
name: arabic-video-editing-with
version: "1.0.0"
displayName: "Arabic Video Editing With AI — Edit Arabic Videos With AI"
description: >
  edit raw video footage into edited Arabic videos with this arabic-video-editing-with skill. Works with MP4, MOV, AVI, WebM files up to 500MB. Arabic content creators use it for editing Arabic-language videos with AI-assisted cuts, captions, and effects — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `arabic-video-editing-with` |
