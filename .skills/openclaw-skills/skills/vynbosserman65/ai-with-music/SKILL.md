...
name: ai-with-music
version: "1.0.0"
displayName: "AI With Music — Add Music to Videos Automatically"
description: >
  Get music-enhanced videos ready to post, without touching a single slider. Upload your video clips (MP4, MOV, AVI, WebM, up to 500MB), say something like "add background music that matches the mood of my video", and download 1080p MP4 when it's done. Built for content creators who move fast and want background music synced to their video without manual audio editing.
