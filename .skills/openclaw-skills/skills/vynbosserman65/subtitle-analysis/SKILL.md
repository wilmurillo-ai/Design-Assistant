...
version: "1.0.0"
displayName: "Subtitle Analysis — Analyze and Extract Subtitle Insights"
description: >
  Get analyzed subtitle report ready to post, without touching a single slider. Upload your video with subtitles (MP4, MOV, AVI, WebM, up to 500MB), say something like "analyze the subtitles in this video and summarize the key topics discussed", and download 1080p MP4 when it's done. Built for content creators, researchers, marketers who move fast and need to quickly understand video content without watching the full footage.
