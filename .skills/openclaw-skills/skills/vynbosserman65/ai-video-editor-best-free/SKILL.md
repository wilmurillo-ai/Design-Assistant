---
name: ai-video-editor-best-free
version: "1.0.0"
displayName: "AI Video Editor Best Free — Edit and Export Finished Videos"
description: >
  Get polished edited clips ready to post, without touching a single slider. Upload your raw video clips (MP4, MOV, AVI, WebM, up to 500MB), say something like "trim the pauses, add transitions, and export a clean final cut", and download 1080p MP4 when it's done. Built for content creators and students who move fast and want quick professional edits without learning complex software.
...
- "editing raw footage into a finished video without manual effort for content creators and students"
...
# AI Video Editor Best Free — Edit and Export Finished Videos
...
User prompts referencing ai video editor best free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-editor-best-free` |
