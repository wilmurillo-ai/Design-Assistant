...
function resolveNamedDirectory(rawPath) {
...
async function defaultOutputDirectory() {
...
export async function resolveOutputPath(defaultFileName) {
...
export async function writeTextOutput(content, defaultFileName) {
...
export function getNumberArg(flag, fallback) {
