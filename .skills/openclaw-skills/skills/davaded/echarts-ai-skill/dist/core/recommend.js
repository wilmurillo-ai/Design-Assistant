...
export function inferFields(dataset) {
    if (dataset.length === 0) {
        return [];
    }
...
function recommendGoal(request, fields) {
...
function recommendChartType(request, fields) {
...
function buildIndicators(request, fields) {
    if (request.indicators?.length) {
...
function buildParallelAxis(request, fields) {
...
function buildSeries(request, chartType, fields) {
...
export function buildChartSpec(request) {
