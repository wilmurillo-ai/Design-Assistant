# Novita Sandbox: Browser Use Integration
...
```
Local machine (OpenClaw)                 Novita Cloud (Firecracker VM)
┌──────────────────────────┐            ┌──────────────────────────┐
...
|---|---|---|
| `NOVITA_API_KEY` | Yes | Novita API key |
| `NOVITA_DOMAIN` | No | Default: `sandbox.novita.ai` |
