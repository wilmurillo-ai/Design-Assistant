...
echo "================================"
echo ""
echo "This script will help you set up your email credentials."
echo ""
...
echo ""
read -p "Display name for outbound emails (e.g. John): " FROM_NAME
...
read -p "Allowed directories for reading files (comma-separated, default: ~/.openclaw/workspace): " ALLOWED_READ_DIRS
read -p "Allowed directories for saving attachments (comma-separated, default: ~/.openclaw/workspace/exports): " ALLOWED_WRITE_DIRS

# Create credentials file
CRED_DIR="${HOME}/.openclaw/credentials"
CRED_FILE="${CRED_DIR}/imap-smtp-mail.env"
mkdir -p "$CRED_DIR"
cat > "$CRED_FILE" << EOF
# IMAP Configuration
IMAP_HOST=$IMAP_HOST
...
ALLOWED_READ_DIRS=${ALLOWED_READ_DIRS:-$HOME/.openclaw/workspace,$HOME/.openclaw/workspace/exports,$HOME/.openclaw/workspace/out,$HOME/.openclaw/workspace/tmp}
ALLOWED_WRITE_DIRS=${ALLOWED_WRITE_DIRS:-$HOME/.openclaw/workspace/exports,$HOME/.openclaw/workspace/tmp}
EOF

echo ""
echo "Created credentials at: $CRED_FILE"
chmod 600 "$CRED_FILE"
