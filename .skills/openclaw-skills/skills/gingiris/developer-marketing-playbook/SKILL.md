---
name: "Developer Marketing & DevRel Playbook"
description: |
  Build a developer community that drives adoption and revenue. DevRel strategy covering tech content marketing, HN/Reddit distribution, API docs optimization, developer events, and measurable KPIs — based on AFFiNE's path to 33k GitHub stars. Multi-language: EN/ZH/JA/KO.

  🇨🇳 开发者营销 & DevRel 手册 | 🇯🇵 デベロッパーマーケティング | 🇰🇷 개발자 마케팅

  Website: https://www.gingiris.com

  Keywords: developer marketing, DevRel, developer relations, developer advocacy, developer community, technical marketing, developer content, API marketing, developer events, developer experience, DX, developer growth, 开发者关系, 开发者营销, DevRel KPIs
---
