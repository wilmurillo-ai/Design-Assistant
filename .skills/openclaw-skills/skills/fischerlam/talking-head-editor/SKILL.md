...
Use this variant when the user wants to edit talking-head footage, direct-to-camera recordings, interviews, tutorials, or presenter videos.

Examples:
- Edit this talking-head video.
- Clean up this presenter video.
