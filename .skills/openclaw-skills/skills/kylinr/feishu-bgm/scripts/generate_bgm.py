#!/usr/bin/env python3
"""
generate_bgm.py - Generate instrumental BGM via MiniMax Music API
Usage: python3 generate_bgm.py --prompt "..." --output /tmp/bgm.mp3
...
def main():
    ...
    print(f"🎵 Generating BGM...", flush=True)
    start = time.time()
