---
name: ai-video-editor-generator
version: "1.0.0"
displayName: "AI Video Editor Generator — Edit and Generate Polished Videos"
description: >
...
- `X-Skill-Source`: `ai-video-editor-generator`
...
**Quick edit**: Upload → "cut the pauses, add background music, and generate a title card" → Download MP4. Takes 1-2 minutes for a 30-second clip.
...
The backend processes faster when you're specific. Instead of "make it look better", try "cut the pauses, add background music, and generate a title card" — concrete instructions get better results.
