---
name: ai-image-to-video-best
version: "1.0.0"
displayName: "AI Image to Video — Convert Images Into Video Clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn these images into a smooth animated video with transitions — and get animated video clips back in 30-60 seconds. Upload JPG, PNG, WEBP, HEIC files up to 200MB, and the AI handles AI video creation automatically. Ideal for marketers, social media creators who want to create videos from images without complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-image-to-video-best` |
