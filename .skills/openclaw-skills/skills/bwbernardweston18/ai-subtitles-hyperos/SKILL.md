---
name: ai-subtitles-hyperos
version: "1.0.0"
displayName: "AI Subtitles HyperOS — Generate Subtitles for HyperOS Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate and burn in subtitles for my HyperOS walkthrough video — and get captioned videos back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI subtitle generation automatically. Ideal for tech content creators who need accurate subtitles added to HyperOS demo or tutorial videos quickly.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-subtitles-hyperos` |
