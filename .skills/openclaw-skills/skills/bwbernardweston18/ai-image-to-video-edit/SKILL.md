---
name: ai-image-to-video-edit
version: "1.0.0"
displayName: "AI Image to Video Editor — Convert Images Into Video Clips"
description: >
  convert images into animated video clips with this skill. Works with JPG, PNG, WEBP, HEIC files up to 200MB. social media creators use it for converting still images into shareable video content — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
# AI Image to Video Editor — Convert Images Into Video Clips
...
One thing worth knowing — using images with similar aspect ratios produces smoother transitions between scenes.

## Matching Input to Actions

User prompts referencing ai image to video edit, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `ai-image-to-video-edit`
