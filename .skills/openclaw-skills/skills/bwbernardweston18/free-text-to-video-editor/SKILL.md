...
version: "1.0.0"
displayName: "Free Text to Video Editor — Convert Text into Shareable Videos"
description: >
  convert text prompts into text-based videos with this skill. Works with TXT, DOCX, PDF, plain text files up to 500MB. content creators, marketers, educators use it for converting written content into shareable videos — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
