---
name: free-tiktok-video-editor
version: "1.0.0"
displayName: "Free TikTok Video Editor — Edit and Export TikTok Videos"
description: >
  edit raw video clips into TikTok-ready clips with this free-tiktok-video-editor skill. Works with MP4, MOV, AVI, WebM files up to 500MB. TikTok creators use it for editing short vertical videos for TikTok posting — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
# Free TikTok Video Editor — Edit and Export TikTok Videos
...
A quick example: upload a 60-second vertical phone recording, type "trim the clip, add trending captions, and sync cuts to the beat", and you'll get a 1080p MP4 back in roughly 30-60 seconds. All rendering happens server-side.

Worth noting: vertical 9:16 video uploads process faster and require no cropping.

## Matching Input to Actions

User prompts referencing free tiktok video editor, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-tiktok-video-editor` |
