---
name: photo-video-maker-free
version: "1.0.0"
displayName: "Photo Video Maker Free — Turn Photos into Shareable Videos"
description: >
  casual creators and social media users turn photos and images into slideshow MP4 video using this skill. Accepts JPG, PNG, HEIC, WebP up to 200MB, renders on cloud GPUs at 1080p, and returns MP4 files in 30-60 seconds. Designed for turning photo collections into shareable videos.
...
# Photo Video Maker Free — Turn Photos into Shareable Videos
...
Worth noting: keeping your photo set under 20 images speeds up processing noticeably.

## Matching Input to Actions

User prompts referencing photo video maker free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `photo-video-maker-free`
...
Export as MP4 for widest compatibility across phones, social platforms, and web.
