---
name: add-music-to-youtube-video
version: "1.0.0"
displayName: "Add Music to YouTube Video — Overlay Music and Export Video"
description: >
  Get music-backed videos ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "add background music to my YouTube video and fade it out at the end", and download 1080p MP4 when it's done. Built for YouTubers who move fast and want to add music to videos without using complex editing software.
metadata: {"openclaw": {"emoji": "🎵", "requires": {"env": ["NEMO_TOKEN"], "configPaths": ["~/.config/nemovideo/"]}, "primaryEnv": "NEMO_TOKEN", "variant": "short_prompts"}}
---

## Getting Started

> Share your video files and I'll get started on AI music overlay. Or just tell me what you're thinking.
...
# Add Music to YouTube Video — Overlay Music and Export Video
...
Here's a typical use: you send a a 3-minute YouTube vlog in MP4 format, ask for add background music to my YouTube video and fade it out at the end, and about 30-60 seconds later you've got a MP4 file ready to download. The whole thing runs at 1080p by default.

One thing worth knowing — trim your video to final length before adding music so the audio syncs cleanly from the start.

## Matching Input to Actions

User prompts referencing add music to youtube video, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `add-music-to-youtube-video`
