#!/usr/bin/env bash
# jd-writer - Content creation and optimization assistant
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${JD_WRITER_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/jd-writer}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "jd-writer v$VERSION" ;;
