#!/usr/bin/env bash
# labor-law - Multi-purpose utility tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${LABOR_LAW_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/labor-law}"
...
case "${1:-help}" in
    ...
    info) shift; cmd_info "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "labor-law v$VERSION" ;;
