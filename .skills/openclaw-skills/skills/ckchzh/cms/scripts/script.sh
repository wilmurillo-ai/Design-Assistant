#!/usr/bin/env bash
# cms — Cms reference tool. Use when working with cms in devtools contexts.
...
show_help() {
    cat << 'HELPEOF'
cms v$VERSION — Cms Reference Tool
...
## What is Cms?
Cms (cms) is a specialized tool/concept in the devtools domain.
It provides essential capabilities for professionals working with cms.

## Key Concepts
- Core cms principles and fundamentals
- How cms fits into the broader devtools ecosystem  
- Essential terminology every practitioner should know

## Why Cms Matters
Understanding cms is critical for:
...
## Getting Started
1. Understand the basic cms concepts
...
## Installation
1. Download or clone the cms package
...
cmd_patterns() {
    cat << 'EOF'
# Cms — Common Patterns & Best Practices

## Design Patterns
1. **Standard Pattern**: The most common approach for cms
...
case "$CMD" in
    ...
    version|--version|-v) echo "cms v$VERSION — Powered by BytesAgain" ;;
    *) echo "Unknown: $CMD"; echo "Run: cms help"; exit 1 ;;
esac
