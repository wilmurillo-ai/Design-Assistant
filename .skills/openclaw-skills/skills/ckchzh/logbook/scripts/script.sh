#!/usr/bin/env bash
# logbook - Data processing and analysis toolkit
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${LOGBOOK_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/logbook}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "logbook v$VERSION" ;;
