#!/usr/bin/env bash
# leave-doc - Multi-purpose utility tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${LEAVE_DOC_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/leave-doc}"
...
case "${1:-help}" in
    ...
    info) shift; cmd_info "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "leave-doc v$VERSION" ;;
