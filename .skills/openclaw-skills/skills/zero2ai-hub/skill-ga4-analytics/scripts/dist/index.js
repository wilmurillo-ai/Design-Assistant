...
import { runReport, getPageViews, getTrafficSources, getUserDemographics, getEventCounts, } from './api/reports.js';
...
import { getTopQueries, getTopPages as getSearchConsoleTopPages, getDevicePerformance, getCountryPerformance, } from './api/searchConsole.js';
 ...
 */
export async function siteOverview(dateRange) {
 ...
 */
export async function trafficAnalysis(dateRange) {
 ...
 */
export async function contentPerformance(dateRange) {
 ...
 */
export async function userBehavior(dateRange) {
 ...
 */
export async function compareDateRanges(range1, range2, dimensions = ['date'], metrics = ['activeUsers', 'sessions', 'screenPageViews']) {
 ...
 */
export async function searchConsoleOverview(dateRange) {
 ...
 */
export async function keywordAnalysis(dateRange) {
    console.log('\n🔑 Analyzing keywords...');
    const results = {};
    console.log('  → Getting top queries...');
 ...
 */
export async function seoPagePerformance(dateRange) {
 ...
 */
export async function reindexUrls(urls) {
 ...
 */
export async function checkIndexStatus(urls) {
