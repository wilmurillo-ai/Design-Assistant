...
- Minimal permission for this skill is `Coupon:Read`.
...
- On missing MCP configuration, auth failure, or unsupported coupon filters, explain why the requested query cannot proceed.
