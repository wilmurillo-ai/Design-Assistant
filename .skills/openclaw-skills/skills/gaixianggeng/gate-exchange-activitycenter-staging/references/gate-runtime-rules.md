...
- Minimal permission for this skill is `Activity:Read`.
...
- On missing MCP configuration, auth failure, or unsupported filtering inputs, explain why the requested query cannot proceed.
