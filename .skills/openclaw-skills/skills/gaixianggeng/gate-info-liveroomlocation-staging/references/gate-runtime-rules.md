---
name: gate-info-liveroomlocation-runtime-rules
version: "2026.4.8-1"
updated: "2026-04-08"
description: "Packaged runtime rules for gate-info-liveroomlocation so every mandatory artifact referenced by SKILL.md is included in the published bundle."
---

# Gate Info Liveroom Location Runtime Rules

> Packaged runtime rules for `gate-info-liveroomlocation`.
...
- Use this skill only for live-stream and replay listing requests.
- If the user asks for analysis, trading, or other non-listing workflows, route to the matching skill instead of stretching this one.
