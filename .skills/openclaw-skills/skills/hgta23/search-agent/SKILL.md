...
name: search-agent
version: 1.0.0
description: "AI-powered search agent that performs intelligent web searches, aggregates results, and provides summarized answers with source citations. Use when: user needs to find current information, research topics, verify facts, or gather data from multiple sources."
---
