...
#### add_text(image: Image.Image, text: str, position: str | tuple[int, int] = 'center', font_size: int = 36, color: tuple[int, int, int] | tuple[int, int, int, int] = (0, 0, 0), font_path: str = None, rotation: float = 0, offset: tuple[int, int] = (0, 0)) -> Image.Image
向图片添加文字。
