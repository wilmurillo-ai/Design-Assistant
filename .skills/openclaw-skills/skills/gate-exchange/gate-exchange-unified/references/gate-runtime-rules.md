...
- Minimal permissions for this skill are `Unified:Read` and `Unified:Write`.
...
- On missing MCP configuration, auth failure, invalid leverage or borrow constraints, or unsupported account state, stay in read-only explanation mode.
