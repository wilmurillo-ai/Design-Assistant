...
**Your text goes wherever your LLM calls go.** If your agent uses a cloud-hosted model (most do), your text is sent to that model's API. If your agent uses a local model (Ollama, llama.cpp), your text stays on your machine.
