...
*This spec is for the Dashboard Builder upsell ($19.99). The core Trainer Buddy Pro skill ($9.99) works perfectly without it — the dashboard is for users who want to visualize their gains.*
