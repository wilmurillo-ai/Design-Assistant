...
from scripts.config_manager import load_config, update_config, get_config
from scripts.recommend import generate_recommendation, get_meal_time_status
import argparse
...
示例:
  设置配置:
    python main.py set-config --cookie "your_cookie" --flavor "清淡" --count 3
