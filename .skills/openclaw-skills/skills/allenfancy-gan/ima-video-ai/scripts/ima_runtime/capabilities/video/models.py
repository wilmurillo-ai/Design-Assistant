...
def build_video_model_binding(product_tree: list, model_id: str, version_id: str | None = None) -> ModelBinding:
    ...
    if node is None:
        raise RuntimeError(
            f"Video model not found: model_id={normalized_model_id}, version_id={version_id}"
        )
