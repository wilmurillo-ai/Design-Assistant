...
exports.searchOpenclaw = searchOpenclaw;
exports.getOpenclawDoc = getOpenclawDoc;
const jsdom_1 = require("jsdom");
const turndown_1 = __importDefault(require("turndown"));
function formatResultsToMarkdown(data) {
...
async function searchOpenclaw(query, language = 'en') {
 ...
 */
async function getOpenclawDoc(pagePath) {
    // 拼接完整 URL
    ...
    try {
        ...
        const dom = new jsdom_1.JSDOM(htmlText);
