...
| Kategorie | Skills |
|-----------|--------|
| **Grundlage** | product-marketing-context |
...
Adaptiert von [marketingskills](https://github.com/PlatoTheOne/marketingskills) von Corey Haines, konvertiert ins OpenClaw AgentSkills-Format.

Bereitgestellt von [MyClaw.ai](https://myclaw.ai).
