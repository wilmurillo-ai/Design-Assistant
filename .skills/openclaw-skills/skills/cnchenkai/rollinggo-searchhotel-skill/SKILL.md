...
This skill comes with a pre-configured public API Key. See [references/env.md](references/env.md) for detailed usage instructions.
...
- **API Key setup:** Load [references/env.md](references/env.md)
