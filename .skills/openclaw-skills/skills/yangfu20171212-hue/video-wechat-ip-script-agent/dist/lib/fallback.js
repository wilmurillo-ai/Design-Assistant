...
exports.applyTopicFallback = applyTopicFallback;
exports.applyScriptFallback = applyScriptFallback;
exports.applyComplianceFallback = applyComplianceFallback;
function applyTopicFallback(items, targetAudience = "泛人群") {
    if (items.length === 0) {
        return [
            {
...
function applyComplianceFallback(output) {
    return {
