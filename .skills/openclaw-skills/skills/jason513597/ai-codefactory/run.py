...
N="AI_CodeFactory";p=argparse.ArgumentParser(description=f"{N} runner");p.add_argument("--task",required=True);p.add_argument("--context",default="");p.add_argument("--constraints",default="");a=p.parse_args()
