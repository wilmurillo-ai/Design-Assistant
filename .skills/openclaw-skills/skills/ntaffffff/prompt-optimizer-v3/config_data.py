...
TASK_PATTERNS = {
    ...
    # ============ v3.2 新增任务类型 ============
    "写测试用例": {
        "keywords": ["写测试", "测试用例", "unittest", "pytest", "测试代码", "单元测试", "集成测试", "写个测试", "测试覆盖", "coverage"],
        "priority": 9,
        "enhancements": [
            "你是一个资深测试工程师。",
            "请编写完整的测试用例，覆盖主要场景和边界条件",
            "使用主流测试框架（如 pytest/unittest），输出可直接运行的测试代码",
            "包含正向用例、负向用例、边界条件测试",
        ]
    },
    "代码调试": {
        "keywords": ["调试", "debug", "报错", "错误", "bug", "修复", "问题", "崩溃", "闪退", "异常", "failed", "error", "exception"],
        "priority": 10,
        "enhancements": [
            "你是一个资深调试专家。",
            "请分析问题原因，提供完整的错误分析和解决方案",
            "用 Markdown 格式输出，包含：错误信息 → 原因分析 → 解决方案 → 验证步骤",
            "如果需要，请提供可执行的修复代码",
        ]
    },
    "性能优化": {
        "keywords": ["性能优化", "优化代码", "提升性能", "慢", "卡顿", "优化", "performance", "优化速度", "加速", "效率"],
        "priority": 9,
        "enhancements": [
            "你是一个性能优化专家。",
            "请分析代码的性能瓶颈，提供具体的优化方案",
            "用 Markdown 输出，包含：性能分析 → 瓶颈定位 → 优化方案 → 预期提升",
            "提供优化后的代码和 benchmark 对比",
        ]
    },
    "安全检查": {
        "keywords": ["安全检查", "安全审计", "漏洞", "注入", "xss", "sql注入", "csrf", "权限", "加密", "security", "渗透测试", "审计"],
        "priority": 10,
        "enhancements": [
            "你是一个安全专家。",
            "请从 OWASP Top 10 等安全标准进行全面审查",
            "用 Markdown 格式输出安全报告，包含：漏洞类型 → 风险等级 → 修复建议 → 参考链接",
            "标注每个问题的严重程度（高/中/低）",
        ]
    },
    "API设计": {
        "keywords": ["api设计", "接口设计", "设计api", "restful", "接口规范", "openapi", "swagger", "接口文档", "定义接口", "帮我设计接口", "设计个api", "帮我设计一个api", "帮我设计个api"],
        "priority": 10,  # 提高优先级
        "enhancements": [
            "你是一个 API 设计专家。",
            "请设计清晰、规范的 API 接口",
            "使用 RESTful 规范，包含完整的请求/响应示例",
            "用 Markdown 输出，包含：接口路径、请求方法、参数说明、响应格式、错误码",
        ]
    },
    "数据结构设计": {
        "keywords": ["数据结构", "设计数据结构", "选什么结构", "用什么数据结构", "树", "图", "hash", "堆", "队列", "栈"],
        "priority": 8,
        "enhancements": [
            "你是一个算法专家。",
            "请根据场景选择最优的数据结构",
            "用 Markdown 输出，包含：问题分析 → 方案对比 → 推荐方案 → 复杂度分析",
            "对比多种方案的优劣",
        ]
    },
}
...
# ============ 输出格式配置 ============
FORMAT_PATTERNS = {
    "Markdown": ["markdown", "md", "文档格式", "md格式", "md格式输出"],
    "JSON": ["json", "接口", "返回json", "json格式", "api", "json输出"],
    "YAML": ["yaml", "yml", "yaml格式", "yml格式"],
    "XML": ["xml", "xml格式"],
...
STYLE_PATTERNS = {
    "专业正式": ["专业", "正式", "严肃", "商务", "正规"],
    "轻松幽默": ["轻松", "幽默", "有趣", "搞笑", "活泼", "俏皮"],
    "简洁明了": ["简洁", "简单", "明了", "简短", "精炼", "干练"],
    "详细全面": ["详细", "全面", "完整", "细致", "充分", "详尽"],
    "技术风格": ["技术", "极客", "程序员", "geek", "硬核"],
    "口语化": ["口语", "随意", "大白话", "通俗", "接地气"],
    "学术风格": ["学术", "论文", "研究", "严谨", "理论"],
    "教程风格": ["教程", "教学", "一步一步", "一步步", "手把手"],
}


# ============ 目标受众配置 ============
AUDIENCE_PATTERNS = {
    "技术人员": ["程序员", "开发", "工程师", "技术", "代码", "dev", "开发人员", "技术人"],
    "产品经理": ["产品", "pm", "产品经理", "需求", "产品人", "业务"],
    "管理者": ["管理", "老板", "领导", "决策", "管理层", "总监", "ceo"],
    "运维人员": ["运维", "部署", "运维人", "sre", "dba"],
    "设计师": ["设计", "设计师", "ui", "ux", "设计人"],
    "初学者": ["入门", "初学", "小白", "新手", "基础", "教程"],
    "普通用户": ["普通", "用户", "大众", "日常"],
}
...
CONSTRAINT_PATTERNS = {
    "字数限制": {
        "简短": ["50字", "100字", "200字", "精简", "简要"],
        "中等": ["300字", "500字", "中等"],
        "详细": ["1000字", "2000字", "详细", "全面"],
    },
    "条数限制": {
        "大量": ["20个", "多个"],  # 先匹配更具体的
        "中等": ["10个", "10条", "5-10"],
