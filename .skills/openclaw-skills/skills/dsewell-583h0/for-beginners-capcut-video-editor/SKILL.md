---
name: for-beginners-capcut-video-editor
version: "1.0.0"
displayName: "For Beginners CapCut Video Editor — Edit and Export Beginner Videos"
description: >
  edit raw video clips into edited video clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. beginner video creators use it for editing short videos with simple cuts, transitions, and music — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `for-beginners-capcut-video-editor` |
