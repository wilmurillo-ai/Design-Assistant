---
name: ai-image-to-video-dance
version: "1.0.0"
displayName: "AI Image to Video Dance — Animate Photos Into Dance Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — animate this photo so the person is dancing to the uploaded beat — and get dancing video clips back in 1-2 minutes. Upload JPG, PNG, WEBP, HEIC files up to 200MB, and the AI handles AI dance video generation automatically. Ideal for TikTok creators who want to make photos come alive with dance movement without filming anything.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-image-to-video-dance` |
