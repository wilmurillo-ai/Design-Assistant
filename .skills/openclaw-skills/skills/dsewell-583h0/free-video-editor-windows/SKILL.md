---
name: free-video-editor-windows
version: "1.0.0"
displayName: "Free Video Editor for Windows — Edit and Export Videos Online"
description: >
  edit raw video clips into edited MP4 clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. Windows users and casual creators use it for trimming and polishing raw footage without installing software — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-video-editor-windows` |
