---
name: fast-photo-video-maker
version: "1.0.0"
displayName: "Fast Photo Video Maker — Turn Photos Into Shareable Videos"
description: >
  social media creators turn photos and images into slideshow video MP4 using this skill. Accepts JPG, PNG, HEIC, WebP up to 200MB, renders on cloud GPUs at 1080p, and returns MP4 files in 30-60 seconds. Designed for turning photo collections into shareable videos.
...
# Fast Photo Video Maker — Turn Photos Into Shareable Videos
...
A quick example: upload ten vacation photos in JPG format, type "turn my photos into a 30-second video with music and transitions", and you'll get a 1080p MP4 back in roughly 30-60 seconds. All rendering happens server-side.

Worth noting: fewer than 20 photos process fastest and keep the video tight.

## Matching Input to Actions

User prompts referencing fast photo video maker, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `fast-photo-video-maker`
