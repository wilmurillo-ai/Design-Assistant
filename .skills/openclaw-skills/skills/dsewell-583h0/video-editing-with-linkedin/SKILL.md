---
name: video-editing-with-linkedin
version: "1.0.0"
displayName: "Video Editing with LinkedIn — Edit and Share LinkedIn Videos"
description: >
  Cloud-based video-editing-with-linkedin tool that handles editing and formatting videos for LinkedIn posts. Upload MP4, MOV, AVI, WebM files (up to 500MB), describe what you need, and get 1080p MP4 output in 30-60 seconds. Built for marketers who work with video clips.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-linkedin` |
