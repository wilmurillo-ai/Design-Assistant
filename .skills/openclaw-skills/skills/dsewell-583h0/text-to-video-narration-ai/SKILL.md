---
name: text-to-video-narration-ai
version: "1.0.0"
displayName: "Text to Video Narration AI — Convert Scripts into Narrated Videos"
description: >
  convert text script into narrated video files with this skill. Works with TXT, DOCX, PDF, SRT files up to 200MB. marketers use it for turning written scripts into AI-narrated videos — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
