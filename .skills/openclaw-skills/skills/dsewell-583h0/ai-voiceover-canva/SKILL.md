...
version: "1.0.0"
displayName: "AI Voiceover for Canva — Add AI Voice to Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add an AI voiceover narrating each slide in English — and get narrated video files back in 30-60 seconds. Upload MP4, PNG, JPG, PDF files up to 200MB, and the AI handles AI voiceover generation automatically. Ideal for marketers, educators, content creators who want to turn silent Canva videos into narrated content without recording audio.
