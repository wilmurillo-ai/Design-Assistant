...
name: liveportrait
version: "1.0.0"
displayName: "Live Portrait — Animate portraits into videos"
description: >
  Get animated portrait video ready to post, without touching a single slider. Upload your portrait images (JPG, PNG, WEBP, MP4, up to 200MB), say something like "animate my portrait photo to talk and move naturally", and download 1080p MP4 when it's done. Built for content creators, marketers, social media users who move fast and want to bring still photos to life without complex animation software.
