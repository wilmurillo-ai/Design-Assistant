...
version: "1.0.0"
displayName: "Video Editor Extension — Edit and Export Video Clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the pauses, add transitions, and export as a clean MP4 — and get edited video clips back in 30-90 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video editing automatically. Ideal for content creators and marketers who want quick edits and extensions without learning complex software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editor-extension` |
