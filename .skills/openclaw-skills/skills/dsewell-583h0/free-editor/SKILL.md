...
name: free-editor
version: "1.0.0"
displayName: "Free Editor — Edit and Export Polished Videos"
description: >
  edit video clips into edited MP4 clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators and students use it for editing raw footage into a polished video without paid software — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
# Free Editor — Edit and Export Polished Videos
...
A quick example: upload a 2-minute raw screen recording, type "trim the pauses, add transitions, and export a clean final cut", and you'll get a 1080p MP4 back in roughly 30-60 seconds. All rendering happens server-side.

Worth noting: shorter clips under 3 minutes process significantly faster.

## Matching Input to Actions

User prompts referencing free editor, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
