...
version: "1.0.0"
displayName: "Text to Video Kaggle — Generate Videos from Text Prompts"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a video from this text description: 'a dog running through a sunny park' — and get AI generated videos back in 1-3 minutes. Upload TXT, CSV, JSON, MP4 files up to 200MB, and the AI handles AI video generation automatically. Ideal for data scientists and ML researchers who need to create or evaluate text-to-video outputs for machine learning projects and Kaggle challenges.
