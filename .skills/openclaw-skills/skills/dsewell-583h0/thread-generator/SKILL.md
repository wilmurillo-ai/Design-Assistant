...
version: "1.0.0"
displayName: "Thread Generator — Convert Videos into Thread Clips"
description: >
  Turn a 3-minute talking-head video into 1080p threaded video clips just by typing what you need. Whether it's splitting long videos into sequential thread-ready clips or quick social content, drop your video footage and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `thread-generator` |
