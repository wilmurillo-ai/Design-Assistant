---
name: for-beginners-editor-online
version: "1.0.0"
displayName: "For Beginners Editor Online — Edit and Export Videos Online"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the video, add transitions, and put text titles at the start — and get edited video files back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI-assisted video editing automatically. Ideal for beginners and first-time creators who want to edit videos without learning complex software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `for-beginners-editor-online` |
