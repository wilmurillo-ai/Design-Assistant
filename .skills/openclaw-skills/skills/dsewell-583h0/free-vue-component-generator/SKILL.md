---
name: free-vue-component-generator
version: "1.0.0"
displayName: "Free Vue Component Generator — Generate Vue Components via AI"
description: >
  Turn a short description of a dropdown menu component into 1080p coded component videos just by typing what you need. Whether it's generating Vue component code walkthroughs from text prompts or quick social content, drop your text descriptions and describe the result you want. No timeline dragging, no export settings — 20-40 seconds from upload to download.
