...
version: "1.0.0"
displayName: "Text to Video Long Duration — Generate Long Videos from Text"
description: >
  generate text prompts into long-form videos with this skill. Works with TXT, DOCX, PDF, SRT files up to 50MB. educators, marketers, content creators use it for creating multi-minute videos from written scripts or text prompts — processing takes 3-6 minutes on cloud GPUs and you get 1080p MP4 files.
