...
name: image-to-ai
version: "1.0.0"
displayName: "Image to AI — Convert Images into AI Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn these images into a short video with transitions and background music — and get AI-generated video back in 30-60 seconds. Upload JPG, PNG, WEBP, HEIC files up to 200MB, and the AI handles AI video creation automatically. Ideal for marketers who want to create videos from photos without manual editing.
