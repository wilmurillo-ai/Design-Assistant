---
name: bing-video-creator-ai
version: "1.0.0"
displayName: "Bing Video Creator AI — Generate Videos from Text Prompts"
description: >
  Cloud-based bing-video-creator-ai tool that handles generating videos from text prompts or images. Upload MP4, MOV, PNG, JPG files (up to 200MB), describe what you need, and get 1080p MP4 output in 1-2 minutes. Built for content creators who work with text prompts.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `bing-video-creator-ai` |
