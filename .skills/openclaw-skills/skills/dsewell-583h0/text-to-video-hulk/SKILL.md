---
name: text-to-video-hulk
version: "1.0.0"
displayName: "Text to Video Hulk — Generate Hulk Videos from Text"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, plain text, up to 500MB), say something like "generate a short video of the Hulk running through a forest based on this text description", and download 1080p MP4 when it's done. Built for Marvel fans, content creators, social media users who move fast and want to create Hulk character videos without animation skills or footage.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-hulk` |
