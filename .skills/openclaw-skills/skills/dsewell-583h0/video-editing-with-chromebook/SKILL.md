---
name: video-editing-with-chromebook
version: "1.0.0"
displayName: "Video Editing with Chromebook — Edit and Export Videos Online"
description: >
  Get edited MP4 clips ready to post, without touching a single slider. Upload your video clips (MP4, WebM, MOV, AVI, up to 500MB), say something like "trim the pauses, add transitions, and export as MP4", and download 1080p MP4 when it's done. Built for Chromebook users and students who move fast and want browser-based video editing without heavy software installs.
