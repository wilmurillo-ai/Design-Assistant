...
name: pika-ai
version: "1.0.0"
displayName: "Pika AI — Generate Videos from Images"
description: >
  generate text or images into AI generated clips with this pika-ai skill. Works with MP4, PNG, JPG, WebM files up to 200MB. content creators use it for generating short video clips from images or text prompts — processing takes 30-90 seconds on cloud GPUs and you get 1080p MP4 files.
