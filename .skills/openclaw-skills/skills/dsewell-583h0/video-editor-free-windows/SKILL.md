---
name: video-editor-free-windows
version: "1.0.0"
displayName: "Video Editor Free Windows — Edit and Export Videos Free"
description: >
  edit raw video clips into edited MP4 clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. Windows PC users and casual creators use it for editing and trimming video clips without paid software — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
# Video Editor Free Windows — Edit and Export Videos Free
...
A quick example: upload a 3-minute screen recording or phone footage, type "trim the footage, add transitions, and export as a clean MP4", and you'll get a 1080p MP4 back in roughly 1-2 minutes. All rendering happens server-side.

Worth noting: shorter clips under 2 minutes process significantly faster.

## Matching Input to Actions

User prompts referencing video editor free windows, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editor-free-windows` |
