---
name: video-generative-ai
version: "1.0.0"
displayName: "Video Generative AI — Generate Videos from Text Prompts"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text or images (MP4, MOV, PNG, JPG, up to 200MB), say something like "generate a 30-second video clip from this description: a timelapse of city traffic at night", and download 1080p MP4 when it's done. Built for marketers who move fast and want to create videos without filming or editing experience.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-generative-ai` |
