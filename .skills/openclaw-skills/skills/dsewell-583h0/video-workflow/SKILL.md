...
name: video-workflow
version: "1.0.0"
displayName: "Video Workflow — Edit and Export Finished Videos"
description: >
  edit raw video clips into polished edited clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators and marketers use it for streamlining end-to-end video editing without manual tools — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
# Video Workflow — Edit and Export Finished Videos
...
Tip: breaking long recordings into shorter segments speeds up processing noticeably.

## Matching Input to Actions

User prompts referencing video workflow, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
