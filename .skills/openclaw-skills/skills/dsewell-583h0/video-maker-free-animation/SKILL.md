...
version: "1.0.0"
displayName: "Video Maker Free Animation — Create Animated Videos from Images"
description: >
  Turn five product images and a script into 1080p animated MP4 videos just by typing what you need. Whether it's creating free animated videos from images or text prompts or quick social content, drop your images or text and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-maker-free-animation` |
