---
name: lapse-video-maker
version: "1.0.0"
displayName: "Lapse Video Maker — Convert Photo Sequences into Video"
description: >
  Get time-lapse MP4 ready to post, without touching a single slider. Upload your sequential images (JPG, PNG, MP4, MOV, up to 500MB), say something like "turn my 150 landscape photos into a smooth 30-second time-lapse video", and download 1080p MP4 when it's done. Built for photographers and content creators who move fast and want to compile photo sequences into smooth time-lapse clips without complex software.
