...
name: trimmer-canva
version: "1.0.0"
displayName: "Trimmer for Canva Videos — Trim and Export Canva Videos"
description: >
  Get trimmed video clips ready to post, without touching a single slider. Upload your raw video clips (MP4, MOV, WebM, AVI, up to 500MB), say something like "trim the intro and outro, cut dead air between slides", and download 1080p MP4 when it's done. Built for Canva users and content creators who move fast and want to cut and trim Canva videos without switching to a complex editor.
