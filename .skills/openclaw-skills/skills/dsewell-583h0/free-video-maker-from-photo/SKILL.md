---
name: free-video-maker-from-photo
version: "1.0.0"
displayName: "Free Video Maker from Photo — Turn Photos into MP4 Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn my photos into a slideshow video with music and transitions — and get photo slideshow video back in 30-60 seconds. Upload JPG, PNG, WEBP, HEIC files up to 200MB, and the AI handles AI video creation automatically. Ideal for social media creators who want to make videos from photos without editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-video-maker-from-photo` |
