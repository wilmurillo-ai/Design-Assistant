...
version: "1.0.0"
displayName: "Video Extractor — Extract and Save Video Clips"
description: >
  Get extracted video clips ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, MKV, up to 500MB), say something like "extract the key highlights and save them as separate clips", and download 1080p MP4 when it's done. Built for content creators who move fast and want to isolate scenes or moments without manual editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-extractor` |
