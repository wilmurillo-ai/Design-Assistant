...
name: video-builder
version: "1.0.0"
displayName: "Video Builder — Build and Export Finished Videos"
description: >
  Get assembled MP4 video ready to post, without touching a single slider. Upload your video clips or images (MP4, MOV, JPG, PNG, up to 500MB), say something like "combine these clips into a 60-second promo video with transitions and text overlays", and download 1080p MP4 when it's done. Built for marketers and content creators who move fast and want to assemble polished videos without manual editing software.
