---
name: editor-kaise-kare
version: "1.0.0"
displayName: "Editor Kaise Kare — Edit and Export Finished Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the video, add transitions, and export a clean final cut — and get polished edited clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video editing automatically. Ideal for beginner creators and students who want quick edits without learning complex software like Premiere.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `editor-kaise-kare` |
