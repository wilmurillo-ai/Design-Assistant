...
```bash
# 场景 1：主歌
pnpm start make_image --prompt "场景 1 描述" --aspect "16:9"
pnpm start make_video --image_source "<URL1>" --prompt "场景 1 动态"

# 场景 2：副歌
pnpm start make_image --prompt "场景 2 描述，更热烈的氛围" --aspect "16:9"
pnpm start make_video --image_source "<URL2>" --prompt "场景 2 动态，更强烈的效果"

# 场景 3：桥段
pnpm start make_image --prompt "场景 3 描述，情绪转折" --aspect "16:9"
pnpm start make_video --image_source "<URL3>" --prompt "场景 3 动态"
```
