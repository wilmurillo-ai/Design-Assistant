#!/usr/bin/env python3
"""
ETH 5m MTF Momentum — Multi-Timeframe CEX Momentum for Polymarket Fast Markets

Reads 1m/3m/5m Binance ETH/USDT returns, votes on direction,
...
SKILL_SLUG = "polymarket-eth-5m-mtf-momentum-dyll"
TRADE_SOURCE = "sdk:eth-mtf-momentum"
ASSET = "ETH"
