#!/usr/bin/env python3
"""
BTC 5m MTF Momentum — Multi-Timeframe CEX Momentum for Polymarket Fast Markets

Reads 1m/3m/5m Binance BTC/USDT returns, votes on direction,
...
SKILL_SLUG = "polymarket-btc-5m-mtf-momentum-dyll"
TRADE_SOURCE = "sdk:btc-mtf-momentum"
ASSET = "BTC"
