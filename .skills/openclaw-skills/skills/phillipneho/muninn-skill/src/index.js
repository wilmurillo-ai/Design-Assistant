...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var args, store, mem, results, stats;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    args = process.argv.slice(2);
                    if (!(args[0] === 'test')) return [3 /*break*/, 3];
                    // Run quick test
                    console.log('🧪 Running quick test...\n');
                    store = new index_js_1.MemoryStore('/tmp/test-memory-quick.db');
                    return [4 /*yield*/, store.remember('Test memory: User prefers dark mode', 'semantic')];
                case 1:
                    mem = _a.sent();
                    console.log('✅ Stored:', mem.id);
                    return [4 /*yield*/, store.recall('user preferences')];
                case 2:
                    results = _a.sent();
