...
class WeSpeakerRuntime:
    ...
    def _patch_torchaudio_compat(self) -> None:
        try:
            import torchaudio
        except Exception:
            return

        # Newer torchaudio builds removed the legacy global backend helpers.
        # Older s3prl / WeSpeaker import paths still call them during module import.
        if not hasattr(torchaudio, "set_audio_backend"):
            def _set_audio_backend(_backend=None):
                return None
