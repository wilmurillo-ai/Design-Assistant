...
Generate and edit images via SkillBoss API Hub for [OpenClaw](https://openclaw.org). Supports standard generation, high-quality generation, style presets, and batch generation with HTML gallery. Zero dependencies.
...
- **Dual engine** — Standard (generation + editing) and high-quality generation, both via SkillBoss API Hub
