...
SKILL_NAME="Nex MeetCost"
SKILL_SLUG="nex-meetcost"
BRAND="Nex AI (nex-ai.be)"
DATA_DIR="$HOME/.nex-meetcost"
...
"
echo "[OK] Database ready at $DATA_DIR/meetcost.db"
...
echo ""
echo "Quick start:"
echo "  $SKILL_SLUG calc 60 -a \"Kevin:developer,Sarah:designer\""
echo "  $SKILL_SLUG log \"Standup\" 15 -a \"Kevin:developer\" --type standup"
echo "  $SKILL_SLUG stats"
echo ""
