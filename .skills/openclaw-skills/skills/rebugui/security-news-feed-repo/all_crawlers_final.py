...
print("="*70)
print("ALL ACTIVE CRAWLERS - FINAL TEST")
print("="*70)
...
for result in results:
    if result['status'] == '✅':
        print(f"{result['status']} {result['name']:15s} ({result['type']:8s}): {result['success']:3d}/{result['total']:3d} articles")
    else:
