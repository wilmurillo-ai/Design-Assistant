...
Companion to [skill.md](https://creditclaw.com/stripe/skill.md). Covers how to make payments using the Stripe Wallet rail (Rail 1) with the x402 payment protocol.
