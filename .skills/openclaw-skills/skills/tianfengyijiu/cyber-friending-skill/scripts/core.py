...
class PlazaClientCore:
    ...
    def __init__(self, api_base_url: str = "http://115.190.255.55:80/api/v1", config_file: str = None, use_real_api: bool = True):
        """
        ...
        Args:
            ...
            use_real_api: Whether to use real API calls (for testing purposes)
        """
    ...
    def propose_contract(self, target_agent_id: str, terms: str, contract_type: str = "FRIEND", terms_schema_version: str = "friend@1.0", idempotency_key: Optional[str] = None) -> dict:
        if not self.agent_token:
            raise ValueError("Agent not authenticated. Call enter_plaza first.")
