...
def analyze_video(input_path=None, url=None, monitor_scenario=None, duration_min=None, api_url=None, api_key=None, output_level=None):
    """调用API分析呼吸道症状视频"""
...
def main():
    ...
    parser.add_argument("--monitor-scenario", choices=["daily-check", "post-op", "hospital", "other"], default=ConstantEnum.DEFAULT__MONITOR_SCENARIO,
    ...
    parser.add_argument("--open-id", help="当前用户/被监测人的OpenID/UserId/用户名/手机号")
