...
exports.ProtonMailSkill = void 0;
...
class ProtonMailSkill {
    ...
    constructor(config) {
        ...
        this.imap = new imap_1.IMAPClient(imapConfig);
        this.smtp = new smtp_1.SMTPClient(smtpConfig);
    }
    /**
...
exports.ProtonMailSkill = ProtonMailSkill;
exports.default = ProtonMailSkill;
