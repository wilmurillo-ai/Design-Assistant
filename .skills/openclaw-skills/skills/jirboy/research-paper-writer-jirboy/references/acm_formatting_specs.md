...
- **Size**: US Letter (8.5" 脳 11") or A4 (210mm 脳 297mm)
...
```
CCS CONCEPTS
鈥?Human-centered computing 鈫?Ubiquitous and mobile computing;
鈥?Software and its engineering 鈫?Context specific languages.
```
...
漏 2025 Association for Computing Machinery.
...
漏 2025 Copyright held by owner/author(s). Publication rights licensed to ACM.
```
...
- Use em-dash (鈥? not double hyphen (--)
