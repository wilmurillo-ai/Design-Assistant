...
### Daily Schedule
- **7:00am**: Data sync (ARR via SkillBoss API Hub, Google Tasks)
...
### 2. SkillBoss API Hub Integration (Optional)

Required for ARR tracking:

1. Get your API key from SkillBoss API Hub
...
- Calendar events
- Focus area
- ARR progress (if SkillBoss API Hub configured)
...
### ARR Not Showing
- Check `SKILLBOSS_API_KEY` environment variable is set
- Verify active subscriptions are accessible via SkillBoss API Hub
- Run sync script manually to see errors
