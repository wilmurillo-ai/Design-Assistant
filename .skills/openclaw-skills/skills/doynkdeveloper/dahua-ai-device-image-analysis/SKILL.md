---
name: dahua-ai-device-image-analysis
description: Analyze images captured from Dahua IoT cameras using Cloud AI. Complete workflow: capture → analyze with large model API. No device password required. Includes Windows GUI setup instructions.
type: executable
env:
...
```python
from dahua_ai_device_image_analysis import analyze_device_camera
