...
export class OpenClawApp extends LitElement {
  ...
  @state() agentPipedreamState: import("./views/agents-panel-pipedream.ts").AgentPipedreamState = {
    loading: false, error: null, success: null, configured: false, globalConfigured: false,
    externalUserId: "", enabledApps: [], connectedApps: [],
    saving: false, editingUserId: false, draftUserId: "",
    showAppBrowser: false, appBrowserSearch: "", connectingApp: null,
    testingApp: null, disconnectingApp: null, manualSlug: "", expandedApps: new Set(),
  };
  @state() agentZapierState: import("./views/agents-panel-zapier.ts").AgentZapierState = {
    loading: false, error: null, configured: false, globalConfigured: false,
    mcpUrl: "", enabledTools: [], availableTools: [],
    saving: false, testing: false, testResult: null,
    editingUrl: false, draftUrl: "", toolsLoading: false,
  };
  ...
  @state() bgSessionsList: Array<{ key: string; sessionId: string; label: string; updatedAt: number; running: boolean }> | null = null;
  @state() bgSessionsLoading = false;
  @state() bgSessionsSelectedKey: string | null = null;
  @state() bgSessionsHistory: Array<{ role: string; text: string; timestamp?: number; toolName?: string }> | null = null;
  ...
  @state() upstreamDivergence: { behind: number; ahead: number; upstreamRef: string; localRef: string; error?: string } | null = null;
