 ...
 */
export function isLowRisk(tool) {
 ...
 */
export async function assessConfidence(tool, context, llmCall) {
 ...
 */
export function quickAssessConfidence(tool) {
...
function defaultAssessment(tool) {
    const risk = classifyRisk(tool);
    return {
 ...
 */
export function makeGateDecision(assessment, thresholds) {
 ...
 */
export async function gateAction(tool, context, config, llmCall) {
 ...
 */
export async function createCheckpoint(tool, context, readFile) {
    const checkpoint = {
