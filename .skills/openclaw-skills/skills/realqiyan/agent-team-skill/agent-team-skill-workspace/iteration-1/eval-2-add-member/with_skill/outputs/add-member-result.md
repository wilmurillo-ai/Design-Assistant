## Command: Add New Team Member

```bash
python3 /home/yhb/work/agent-team-skill/scripts/team.py update --agent-id "bob" --name "Bob" --role "Backend Developer" --is-leader "false" --enabled "true" --tags "backend,api,database" --expertise "Python,Go" --not-good-at "frontend"
```

## Output

```
Added member: Bob (bob)
```

## Verification

After adding, the team list shows:
...
New team member Bob has been successfully added with:
- Name: Bob
- Agent ID: bob
- Role: Backend Developer
- Tags: backend,api,database
- Expertise: Python, Go
- Not good at: frontend
- Leader status: false (regular member)
- Enabled: true

Bob is now the 6th member of the team.