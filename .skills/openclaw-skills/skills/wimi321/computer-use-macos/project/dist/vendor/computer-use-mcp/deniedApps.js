 ...
 */
export function categoryToTier(category) {
 ...
 */
export function isPolicyDenied(bundleId, displayName) {
...
export function getDeniedCategory(bundleId) {
 ...
 */
export function getDeniedCategoryByDisplayName(name) {
 ...
 */
export function getDeniedCategoryForApp(bundleId, displayName) {
    if (bundleId) {
 ...
 */
export function getDefaultTierForApp(bundleId, displayName) {
...
//# sourceMappingURL=deniedApps.js.map