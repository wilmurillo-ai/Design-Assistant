 ...
 */
export function comparePixelAtLocation(crop, lastScreenshot, freshScreenshot, xPercent, yPercent, gridSize = DEFAULT_GRID_SIZE) {
 ...
 */
export async function validateClickTarget(crop, lastScreenshot, xPercent, yPercent, takeFreshScreenshot, logger, gridSize = DEFAULT_GRID_SIZE) {
    if (!lastScreenshot) {
