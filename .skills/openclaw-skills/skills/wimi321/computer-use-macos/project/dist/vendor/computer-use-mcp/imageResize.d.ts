 ...
 */
export declare const API_RESIZE_PARAMS: ResizeParams;
/** ceil(px / pxPerToken). Matches resize.rs:74-76 (which uses integer ceil-div). */
export declare function nTokensForPx(px: number, pxPerToken: number): number;
/**
 ...
 */
export declare function targetImageSize(width: number, height: number, params: ResizeParams): [number, number];
