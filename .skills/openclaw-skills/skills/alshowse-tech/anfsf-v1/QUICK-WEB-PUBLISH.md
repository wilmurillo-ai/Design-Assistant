# 🚀 ASF V4.0 Skill - 快速 Web 发布指南

**状态**: ✅ 发布包已准备 (36KB)  
**位置**: `/tmp/asf-v4-1.0.0.tar.gz`
...
选择文件：`/tmp/asf-v4-1.0.0.tar.gz`

(如果无法访问该路径，可以重新打包:
```bash
cd /root/.openclaw/workspace-main/skills
tar -czf ~/Desktop/asf-v4-1.0.0.tar.gz asf-v4/
```
)
...
复制以下完整内容到 **"Description"** 或 **"README"** 框:
...
1. 勾选 "I agree to the terms" 或类似选项
...
1. **打开浏览器** → https://clawhub.ai/create
2. **复制步骤 2 的内容** → 填写表单
3. **上传文件** → `/tmp/asf-v4-1.0.0.tar.gz` (36KB)
4. **复制步骤 4 的介绍** → 粘贴到介绍框
5. **点击发布按钮**
