...
PUBLISH_LABEL="ai.openclaw.jun-invest-option-master.publish"
...
<plist version="1.0">
  <dict>
    ...
    <key>StandardOutPath</key><string>$HOME/.openclaw/logs/jun-invest-option-master.publish.out.log</string>
    <key>StandardErrorPath</key><string>$HOME/.openclaw/logs/jun-invest-option-master.publish.err.log</string>
  </dict>
</plist>
EOF
