...
#   ~/.openclaw/workspace-jun-invest-option-master
# Artifact lives here:
#   ~/.openclaw/workspace/skills/jun-invest-option-master
...
SLUG="${SLUG:-jun-invest-option-master}"
NAME="${NAME:-jun-invest-option-master}"
