---
name: video-script-writer-online
version: "1.0.0"
displayName: "Video Script Writer Online — Generate Scripts for Any Video"
description: >
  Skip the learning curve of professional editing software. Describe what you want — write a YouTube script for a 3-minute video about budgeting tips for beginners — and get ready-to-record scripts back in 20-40 seconds. Upload MP4, MOV, TXT, DOCX files up to 200MB, and the AI handles AI script generation automatically. Ideal for YouTubers, content creators, marketers who need a structured script fast without hiring a copywriter.
metadata: {"openclaw": {"emoji": "🎬", "requires": {"env": ["NEMO_TOKEN"], "configPaths": ["~/.config/nemovideo/"]}, "primaryEnv": "NEMO_TOKEN", "variant": "greeting_v2"}}
---

## Getting Started

> Ready when you are. Drop your topic or idea here or describe what you want to make.
...
# Video Script Writer Online — Generate Scripts for Any Video
...
One thing worth knowing — adding a target audience in your prompt makes the script tone much more accurate.

## Matching Input to Actions

User prompts referencing video script writer online, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-script-writer-online` |
