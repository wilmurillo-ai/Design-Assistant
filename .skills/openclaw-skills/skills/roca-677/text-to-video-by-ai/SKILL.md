---
name: text-to-video-by-ai
version: "1.0.0"
displayName: "Text to Video by AI — Convert Text Into AI Videos"
description: >
  Turn a 150-word product description into 1080p AI-generated videos just by typing what you need. Whether it's generating videos from written content or scripts or quick social content, drop your text prompt and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
# Text to Video by AI — Convert Text Into AI Videos
...
One thing worth knowing — shorter, clearer prompts produce more accurate video results.

## Matching Input to Actions

User prompts referencing text to video by ai, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-by-ai` |
