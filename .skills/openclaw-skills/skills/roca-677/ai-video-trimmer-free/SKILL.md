---
name: ai-video-trimmer-free
version: "1.0.0"
displayName: "AI Video Trimmer Free — Trim and Export Clean Clips"
description: >
  trim raw video footage into trimmed video clips with this ai-video-trimmer-free skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators use it for cutting down long recordings into clean short clips — processing takes 20-40 seconds on cloud GPUs and you get 1080p MP4 files.
...
# AI Video Trimmer Free — Trim and Export Clean Clips
...
A quick example: upload a 10-minute unedited screen recording, type "trim the silent pauses and cut out the first 30 seconds", and you'll get a 1080p MP4 back in roughly 20-40 seconds. All rendering happens server-side.

Worth noting: shorter source clips process faster and give more precise trim results.

## Matching Input to Actions

User prompts referencing ai video trimmer free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `ai-video-trimmer-free`
