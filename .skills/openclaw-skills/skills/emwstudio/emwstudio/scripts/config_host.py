#!/usr/bin/env python3
"""
检查并设置emwstudio.env.RH_HOST
用法: python3 config_host.py [--check] [--set RH_HOST]
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 config_host.py [--check] [--set RH_HOST]", file=sys.stderr)
        sys.exit(1)
