...
echo "This skill requires an API Key from https://plugin.human-like.me"
echo ""
...
read -p "Enter Base URL [https://plugin.human-like.me]: " BASE_URL
BASE_URL=${BASE_URL:-"https://plugin.human-like.me"}
