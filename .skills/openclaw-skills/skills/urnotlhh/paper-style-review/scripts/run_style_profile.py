#!/usr/bin/env python3
"""CLI entrypoint for refs style-profile extraction stage."""
...
from orchestrators.style_stage_orchestrator import run_style_profile_stage


def main() -> None:
    parser = argparse.ArgumentParser(description="Run refs style-profile extraction stage")
