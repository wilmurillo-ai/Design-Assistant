...
```bash
# Emergency detection
$ python mordred_v4.1.py "CRITICAL breach in production"
STC: 0.6610 | Top: SENTINELLE

# Chinese support
$ python mordred_v4.1.py "全体紧急情况服务器崩溃"
STC: 0.444 | Top: GARDIEN

# Emotional understanding
$ python mordred_v4.1.py "I just lost my dog"
...
*Morgana Security - Axioma Stellaris*
