  ...
  if (!cmd || cmd === "help" || cmd === "--help") {
    process.stdout.write(
      [
        ...
        "",
        "Usage:",
        "  node kalshi-api.mjs status [--pretty]",
        "  node kalshi-api.mjs markets --limit 500 [--status open] [--series KXBTC] [--event <ticker>] [--cursor <c>] [--pretty]",
        "  node kalshi-api.mjs market --ticker <market_ticker> [--pretty]",
        "  node kalshi-api.mjs orderbook --ticker <market_ticker> [--depth 50] [--pretty]",
        "  node kalshi-api.mjs trades [--ticker <market_ticker>] [--limit 100] [--cursor <c>] [--min_ts <unix>] [--max_ts <unix>] [--pretty]",
        "  node kalshi-api.mjs events [--limit 100] [--status open] [--series <series_ticker>] [--cursor <c>] [--pretty]",
        "  node kalshi-api.mjs event --event <event_ticker> [--pretty]",
        "  node kalshi-api.mjs series [--limit 400] [--category Economics] [--cursor <c>] [--pretty]",
      ].join("\n"),
    );
    return;
  }
