    ...
    "itemList": [
      {
        ...
        "id": "...", // Attraction id
        "mainPic": "https://...", // Main image
        "jumpUrl": "...", // Booking link
        "name": "...", // Attraction name
        "freePoiStatus": "...", // Attraction pricing status, enum values: "FREE": free attraction; "NOT_FREE": paid attraction; "UNKNOWN": unknown, uncertain if free
        "ticketInfo": // Ticket information
        {
          "price": "...", // Price
          "priceDate": "...", // Applicable date for price
