...
def test_basic_functionality():
    ...
    for user_input, expected_type, description in test_cases:
        print(f"\n[EMOJI:6D4B][EMOJI:8BD5]: {description}")
        ...
        if result['task_type'] == expected_type:
            print("   [EMOJI:4EFB][EMOJI:52A1][EMOJI:7C7B][EMOJI:578B][EMOJI:68C0][EMOJI:6D4B][EMOJI:6B63][EMOJI:786E]")
        else:
            print(f"   [EMOJI:4EFB][EMOJI:52A1][EMOJI:7C7B][EMOJI:578B][EMOJI:68C0][EMOJI:6D4B][EMOJI:504F][EMOJI:5DEE]: {result['task_type']} != {expected_type}")
    ...
    print("\n" + "=" * 80)
    print("[EMOJI:6D4B][EMOJI:8BD5][EMOJI:5B8C][EMOJI:6210]")

def test_model_selection():
    """[EMOJI:6D4B][EMOJI:8BD5][EMOJI:6A21][EMOJI:578B][EMOJI:9009][EMOJI:62E9][EMOJI:7B56][EMOJI:7565]"""
    print("\n[EMOJI:6A21][EMOJI:578B][EMOJI:9009][EMOJI:62E9][EMOJI:7B56][EMOJI:7565][EMOJI:6D4B][EMOJI:8BD5]")
    print("=" * 80)
    ...
    for description, complexity, task_type, expectation in test_scenarios:
        print(f"\n[EMOJI:573A][EMOJI:666F]: {description}")
        ...
        if "deepseek" in model.lower() and complexity == "low":
            print("   [EMOJI:6A21][EMOJI:578B][EMOJI:9009][EMOJI:62E9][EMOJI:5408][EMOJI:7406][EMOJI:FF08][EMOJI:7B80][EMOJI:5355][EMOJI:4EFB][EMOJI:52A1][EMOJI:7528]DeepSeek[EMOJI:FF09]")
        elif "qwen" in model.lower() and complexity in ["medium", "high"]:
            print("   [EMOJI:6A21][EMOJI:578B][EMOJI:9009][EMOJI:62E9][EMOJI:5408][EMOJI:7406][EMOJI:FF08][EMOJI:590D][EMOJI:6742][EMOJI:4EFB][EMOJI:52A1][EMOJI:7528][EMOJI:5343][EMOJI:95EE][EMOJI:FF09]")
        else:
            print("   [EMOJI:6A21][EMOJI:578B][EMOJI:9009][EMOJI:62E9][EMOJI:9700][EMOJI:8981][EMOJI:68C0][EMOJI:67E5]")
    
    print("\n" + "=" * 80)

def test_configuration():
    """[EMOJI:6D4B][EMOJI:8BD5][EMOJI:914D][EMOJI:7F6E][EMOJI:52A0][EMOJI:8F7D]"""
    print("\n[EMOJI:914D][EMOJI:7F6E][EMOJI:7CFB][EMOJI:7EDF][EMOJI:6D4B][EMOJI:8BD5]")
    print("=" * 80)
    
    optimizer = TSPromptOptimizer()
    
    # [EMOJI:6D4B][EMOJI:8BD5][EMOJI:914D][EMOJI:7F6E][EMOJI:52A0][EMOJI:8F7D]
    print("[EMOJI:914D][EMOJI:7F6E][EMOJI:68C0][EMOJI:67E5]:")
    ...
    for config in required_configs:
        if config in optimizer.dongdong_rules:
            print(f"   {config} [EMOJI:914D][EMOJI:7F6E][EMOJI:5B58][EMOJI:5728]")
        else:
            print(f"   {config} [EMOJI:914D][EMOJI:7F6E][EMOJI:7F3A][EMOJI:5931]")
    
    print("\n" + "=" * 80)

def test_history_recording():
    """[EMOJI:6D4B][EMOJI:8BD5][EMOJI:5386][EMOJI:53F2][EMOJI:8BB0][EMOJI:5F55]"""
    print("\n[EMOJI:5386][EMOJI:53F2][EMOJI:8BB0][EMOJI:5F55][EMOJI:7CFB][EMOJI:7EDF][EMOJI:6D4B][EMOJI:8BD5]")
    print("=" * 80)
    ...
    print(f"[EMOJI:6587][EMOJI:4EF6][EMOJI:68C0][EMOJI:67E5]:")
    ...
    if history_file.exists():
        ...
        try:
            with open(history_file, 'r', encoding='utf-8') as f:
                ...
                if entry_count > 0:
                    print("   [EMOJI:5386][EMOJI:53F2][EMOJI:8BB0][EMOJI:5F55][EMOJI:529F][EMOJI:80FD][EMOJI:6B63][EMOJI:5E38]")
                else:
                    print("   [EMOJI:5386][EMOJI:53F2][EMOJI:8BB0][EMOJI:5F55][EMOJI:4E3A][EMOJI:7A7A]")
        except Exception as e:
            print(f"   [EMOJI:8BFB][EMOJI:53D6][EMOJI:5386][EMOJI:53F2][EMOJI:6587][EMOJI:4EF6][EMOJI:5931][EMOJI:8D25]: {e}")
    else:
        print("   [EMOJI:5386][EMOJI:53F2][EMOJI:6587][EMOJI:4EF6][EMOJI:4E0D][EMOJI:5B58][EMOJI:5728]")
...
def main():
    ...
    print("\n" + "=" * 80)
    print("[EMOJI:6240][EMOJI:6709][EMOJI:6D4B][EMOJI:8BD5][EMOJI:5B8C][EMOJI:6210]")
    print("\n[EMOJI:6D4B][EMOJI:8BD5][EMOJI:603B][EMOJI:7ED3]:")
    print("   1. [EMOJI:57FA][EMOJI:672C][EMOJI:529F][EMOJI:80FD][EMOJI:6D4B][EMOJI:8BD5]")
    print("   2. [EMOJI:6A21][EMOJI:578B][EMOJI:9009][EMOJI:62E9][EMOJI:6D4B][EMOJI:8BD5]")
    print("   3. [EMOJI:914D][EMOJI:7F6E][EMOJI:7CFB][EMOJI:7EDF][EMOJI:6D4B][EMOJI:8BD5]")
    print("   4. [EMOJI:5386][EMOJI:53F2][EMOJI:8BB0][EMOJI:5F55][EMOJI:6D4B][EMOJI:8BD5]")
    print("\nTS-Prompt-Optimizer [EMOJI:5C31][EMOJI:7EEA][EMOJI:FF01]")
