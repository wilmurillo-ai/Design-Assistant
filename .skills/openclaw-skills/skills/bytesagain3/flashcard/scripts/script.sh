#!/usr/bin/env bash
# flashcard - Learning and study assistant
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${FLASHCARD_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/flashcard}"
...
case "${1:-help}" in
    ...
    test) shift; cmd_test "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "flashcard v$VERSION" ;;
