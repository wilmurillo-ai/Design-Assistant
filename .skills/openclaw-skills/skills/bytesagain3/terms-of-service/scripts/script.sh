#!/usr/bin/env bash
# terms-of-service - Multi-purpose utility tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${TERMS_OF_SERVICE_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/terms-of-service}"
...
Usage: terms-of-service <command> [args]
...
case "${1:-help}" in
    ...
    info) shift; cmd_info "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "terms-of-service v$VERSION" ;;
