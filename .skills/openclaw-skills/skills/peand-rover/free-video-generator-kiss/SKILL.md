---
name: free-video-generator-kiss
version: "1.0.0"
displayName: "Free Video Generator Kiss — Generate Kiss Scene Videos Free"
description: >
  Get animated kiss videos ready to post, without touching a single slider. Upload your images or clips (JPG, PNG, MP4, MOV, up to 200MB), say something like "generate a short romantic kiss scene video from these two photos", and download 1080p MP4 when it's done. Built for social media creators who move fast and want to create fun romantic video clips without paid software.
