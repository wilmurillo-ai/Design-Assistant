---
name: ai-image-to-video-effects
version: "1.0.0"
displayName: "AI Image to Video Effects — Animate Images Into Video Clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — animate this image with a cinematic zoom and motion blur effect — and get animated video clips back in 30-60 seconds. Upload JPG, PNG, WEBP, HEIC files up to 200MB, and the AI handles AI video effects generation automatically. Ideal for social media creators, marketers, photographers who want to bring photos to life as videos without complex animation software.
