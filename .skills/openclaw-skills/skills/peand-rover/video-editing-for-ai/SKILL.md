...
version: "1.0.0"
displayName: "Video Editing for AI — Edit and Export AI-Ready Videos"
description: >
  edit raw video footage into AI-edited clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators and marketers use it for using AI to automatically cut, trim, and polish raw video footage — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-for-ai` |
