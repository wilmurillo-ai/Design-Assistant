---
name: nano-banana-video-generator-free
version: "1.0.0"
displayName: "Nano Banana Video Generator Free — Generate Animated Videos From Text"
description: >
  Turn a short text description of a banana character doing tricks into 720p animated video clips just by typing what you need. Whether it's generating short fun animated videos from text prompts at no cost or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `nano-banana-video-generator-free` |
