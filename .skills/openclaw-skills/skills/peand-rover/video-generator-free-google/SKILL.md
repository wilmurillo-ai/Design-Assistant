...
version: "1.0.0"
displayName: "Video Generator Free Google — Generate Videos from Text or Images"
description: >
  Turn a short text description of a product launch into 1080p ready-to-share videos just by typing what you need. Whether it's generating short videos from text or images for free or quick social content, drop your text prompts or images and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
