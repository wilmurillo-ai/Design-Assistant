---
name: video-maker-easy
version: "1.0.0"
displayName: "Video Maker Easy — Create and Export Videos Fast"
description: >
  Get finished MP4 videos ready to post, without touching a single slider. Upload your video clips or images (MP4, MOV, JPG, PNG, up to 500MB), say something like "combine these photos into a 30-second video with transitions and music", and download 1080p MP4 when it's done. Built for casual creators and small business owners who move fast and want to make videos fast without editing software skills.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-maker-easy` |
