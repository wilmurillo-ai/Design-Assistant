...
version: "1.0.0"
displayName: "AI Video Generator Free Cartoon — Generate Cartoon Videos from Text"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a free cartoon video of a robot dancing in a city from my text prompt — and get animated cartoon videos back in 1-2 minutes. Upload MP4, MOV, WebM, GIF files up to 500MB, and the AI handles AI cartoon video generation automatically. Ideal for content creators, educators, social media users who want animated cartoon videos without animation software skills or cost.
