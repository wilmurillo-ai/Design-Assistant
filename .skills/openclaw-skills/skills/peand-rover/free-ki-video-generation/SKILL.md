---
name: free-ki-video-generation
version: "1.0.0"
displayName: "Free AI Video Generation — Generate Videos from Text or Images"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text prompts or images (MP4, MOV, JPG, PNG, up to 200MB), say something like "generate a 30-second video from my product description with background music", and download 1080p MP4 when it's done. Built for content creators, marketers, students who move fast and want to create videos quickly without editing skills or paid tools.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-ki-video-generation` |
