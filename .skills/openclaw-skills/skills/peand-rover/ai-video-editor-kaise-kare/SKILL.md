---
name: ai-video-editor-kaise-kare
version: "1.0.0"
displayName: "AI Video Editor Kaise Kare — Edit and Export Videos with AI"
description: >
  edit raw video footage into edited video clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. Hindi-speaking content creators use it for editing raw videos into polished clips using AI — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-editor-kaise-kare` |
