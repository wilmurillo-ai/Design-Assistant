...
version: "1.0.0"
displayName: "Unified Video Lyrics Free — Sync and overlay video lyrics"
description: >
  Get lyrics-overlaid videos ready to post, without touching a single slider. Upload your video with audio (MP4, MOV, AVI, WebM, up to 500MB), say something like "sync lyrics to the music video and display them as on-screen text", and download 1080p MP4 when it's done. Built for musicians and content creators who move fast and need lyrics displayed on their music videos without paying for editing software.
