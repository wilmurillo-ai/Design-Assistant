---
name: caption-generator-image
version: "1.0.0"
displayName: "Caption Generator Image — Generate Captions from Images"
description: >
  Get captioned image videos ready to post, without touching a single slider. Upload your images with text (JPG, PNG, WEBP, GIF, up to 200MB), say something like "generate a caption for this image and overlay it as text", and download 1080p MP4 when it's done. Built for social media creators who move fast and need captions added to images quickly without manual typing.
