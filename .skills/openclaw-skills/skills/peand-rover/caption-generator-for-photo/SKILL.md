---
name: caption-generator-for-photo
version: "1.0.0"
displayName: "Caption Generator for Photo — Add Captions to Photos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add a caption to this photo and export it as a video — and get captioned photo videos back in 20-40 seconds. Upload JPG, PNG, WEBP, HEIC files up to 200MB, and the AI handles AI caption generation automatically. Ideal for social media creators who need captions on photos without using complex design tools.
