...
name: film-maker
version: "1.0.0"
displayName: "Film Maker — Edit and Export Film Videos"
description: >
  Get polished film clips ready to post, without touching a single slider. Upload your raw footage (MP4, MOV, AVI, MKV, up to 500MB), say something like "cut the best takes, add transitions, and sync background music", and download 1080p MP4 when it's done. Built for indie filmmakers who move fast and want professional edits without a full editing suite.
