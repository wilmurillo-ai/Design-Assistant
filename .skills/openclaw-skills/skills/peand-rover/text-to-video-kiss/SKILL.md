---
name: text-to-video-kiss
version: "1.0.0"
displayName: "Text to Video Kiss — Generate Kiss Scenes from Text"
description: >
  Get AI-generated video clips ready to post, without touching a single slider. Upload your text prompt (TXT, DOCX, PDF, plain text, up to 500MB), say something like "generate a romantic kiss scene from a written description", and download 1080p MP4 when it's done. Built for filmmakers, storytellers, content creators who move fast and want to visualize romantic scenes without filming actors.
