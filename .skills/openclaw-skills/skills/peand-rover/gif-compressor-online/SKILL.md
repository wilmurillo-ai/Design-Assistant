---
name: gif-compressor-online
version: "1.0.0"
displayName: "GIF Compressor Online — Compress and Optimize GIF Files"
description: >
  compress GIF files into compressed GIF files with this skill. Works with GIF, MP4, WebM, APNG files up to 200MB. web designers, marketers, social media managers use it for reducing GIF file size for web and social media use — processing takes 10-30 seconds on cloud GPUs and you get 720p MP4 files.
