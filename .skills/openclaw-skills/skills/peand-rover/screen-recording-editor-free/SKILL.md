...
version: "1.0.0"
displayName: "Screen Recording Editor Free — Edit and Export Screen Recordings"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the pauses, add text annotations, and export as a clean tutorial video — and get edited screen recordings back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI clip editing automatically. Ideal for educators, developers, content creators who want to clean up screen recordings without learning complex editing software.
