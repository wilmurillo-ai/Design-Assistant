---
name: generateur-video-ia
version: "1.0.0"
displayName: "Générateur Vidéo IA — Créez des vidéos par IA"
description: >
  generate text or images into AI-generated videos with this generateur-video-ia skill. Works with MP4, MOV, JPG, PNG files up to 200MB. marketers, content creators, entrepreneurs use it for generating videos from text prompts or images without filming anything — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
# Générateur Vidéo IA — Créez des vidéos par IA
...
A quick example: upload a short text prompt describing a product demo scene, type "generate a 30-second promotional video from this product description", and you'll get a 1080p MP4 back in roughly 1-2 minutes. All rendering happens server-side.

Worth noting: shorter and more specific prompts tend to produce more accurate video results.

## Matching Input to Actions

User prompts referencing generateur video ia, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `generateur-video-ia` |
