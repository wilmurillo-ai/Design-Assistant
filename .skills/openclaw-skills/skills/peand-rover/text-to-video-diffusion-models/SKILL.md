...
version: "1.0.0"
displayName: "Text to Video Diffusion Models — Generate Videos From Text Prompts"
description: >
  Get AI generated clips ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, PNG, up to 10MB), say something like "generate a 10-second clip of a sunset over a city skyline with cinematic camera movement", and download 1080p MP4 when it's done. Built for marketers who move fast and want to create video content without cameras or editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-diffusion-models` |
