---
name: ai-video-maker-from-image
version: "1.0.0"
displayName: "AI Video Maker from Image — Convert Images into Videos"
description: >
  convert images into animated image videos with this skill. Works with JPG, PNG, WEBP, HEIC files up to 200MB. marketers, social media creators use it for turning still photos into shareable videos — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-maker-from-image` |
