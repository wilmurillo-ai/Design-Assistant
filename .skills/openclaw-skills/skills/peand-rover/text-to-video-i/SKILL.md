...
description: >
  Get AI-generated videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, SRT, up to 200MB), say something like "turn this text into a 30-second explainer video with voiceover and visuals", and download 1080p MP4 when it's done. Built for marketers who move fast and want to create videos from scripts without filming anything.
