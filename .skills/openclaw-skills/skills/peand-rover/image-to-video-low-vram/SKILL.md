---
name: image-to-video-low-vram
version: "1.0.0"
displayName: "Image to Video Low VRAM — Animate Images on Budget GPUs"
description: >
  Get animated video clips ready to post, without touching a single slider. Upload your still images (JPG, PNG, WEBP, BMP, up to 50MB), say something like "animate this image into a 5-second video clip using low VRAM mode", and download 720p MP4 when it's done. Built for indie creators, hobbyists with budget hardware who move fast and want to generate videos from images without a high-end GPU.
