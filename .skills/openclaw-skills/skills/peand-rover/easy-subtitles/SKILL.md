...
name: easy-subtitles
version: "1.0.0"
displayName: "Easy Subtitles — Auto-Generate Captions for Videos"
description: >
  YouTubers and content creators add video files into captioned videos using this skill. Accepts MP4, MOV, AVI, WebM up to 500MB, renders on cloud GPUs at 1080p, and returns MP4 files in 30-60 seconds. Designed for adding subtitles to videos automatically.
...
# Easy Subtitles — Auto-Generate Captions for Videos
...
Say you have a 3-minute YouTube video recording and want to add captions in English and Spanish — the backend processes it in about 30-60 seconds and hands you a 1080p MP4.

Tip: shorter clips under 5 minutes generate subtitles significantly faster.

## Matching Input to Actions

User prompts referencing easy subtitles, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
