---
name: how-to-add-music-to-a-video
version: "1.0.0"
displayName: "How to Add Music to a Video — Merge Audio and Export Video"
description: >
  Get music-backed videos ready to post, without touching a single slider. Upload your video and audio files (MP4, MOV, AVI, MP3, up to 500MB), say something like "add this background music to my video and fade it out at the end", and download 1080p MP4 when it's done. Built for content creators who move fast and want to add music to videos without complex editing software.
