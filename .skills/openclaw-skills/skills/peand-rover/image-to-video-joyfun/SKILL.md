---
name: image-to-video-joyfun
version: "1.0.0"
displayName: "Image to Video Joyfun — Convert Images Into Video Clips"
description: >
  Get animated video clips ready to post, without touching a single slider. Upload your still images (JPG, PNG, WEBP, GIF, up to 200MB), say something like "animate this image into a 5-second video clip with smooth motion", and download 1080p MP4 when it's done. Built for social media creators who move fast and want to bring still photos to life without complex animation software.
