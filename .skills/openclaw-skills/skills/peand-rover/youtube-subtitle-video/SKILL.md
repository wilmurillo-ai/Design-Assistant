...
version: "1.0.0"
displayName: "YouTube Subtitle Video — Add Subtitles to YouTube Videos"
description: >
  Turn a 10-minute YouTube tutorial video into 1080p captioned YouTube videos just by typing what you need. Whether it's adding subtitles to YouTube videos or quick social content, drop your YouTube video and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `youtube-subtitle-video` |
