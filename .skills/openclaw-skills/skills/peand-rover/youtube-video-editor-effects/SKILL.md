---
name: youtube-video-editor-effects
version: "1.0.0"
displayName: "YouTube Video Editor Effects — Add Effects and Export Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add cinematic color grading, transitions, and motion blur effects between scenes — and get effects-enhanced videos back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI effects editing automatically. Ideal for YouTubers who want professional effects without learning complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `youtube-video-editor-effects` |
