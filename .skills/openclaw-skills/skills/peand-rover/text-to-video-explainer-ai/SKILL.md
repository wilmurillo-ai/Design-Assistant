---
name: text-to-video-explainer-ai
version: "1.0.0"
displayName: "Text to Video Explainer AI — Convert Scripts into Explainer Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn this script into an animated explainer video with voiceover and subtitles — and get animated explainer videos back in 1-2 minutes. Upload TXT, DOCX, PDF, SRT files up to 50MB, and the AI handles AI video creation automatically. Ideal for marketers, educators, startup founders who want explainer videos without hiring animators or video editors.
