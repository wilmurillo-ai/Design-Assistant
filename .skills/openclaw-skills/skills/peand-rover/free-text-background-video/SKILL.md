---
name: free-text-background-video
version: "1.0.0"
displayName: "Free Text Background Video — Remove Backgrounds and Add Text"
description: >
  Turn a 30-second talking head clip with a cluttered background into 1080p background-free videos just by typing what you need. Whether it's removing video backgrounds and adding custom text overlays or quick social content, drop your text or video and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
