---
name: ai-video-generator-free-lifetime
version: "1.0.0"
displayName: "AI Video Generator Free Lifetime — Generate Videos from Text Free"
description: >
  Turn a short product description and three product photos into 1080p finished MP4 videos just by typing what you need. Whether it's generating videos from text or images without paid software or quick social content, drop your text or images and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-generator-free-lifetime` |
