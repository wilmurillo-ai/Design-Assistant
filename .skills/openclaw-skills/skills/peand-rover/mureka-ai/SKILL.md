...
name: mureka-ai
version: "1.0.0"
displayName: "Mureka AI — Generate Songs from Audio"
description: >
  Get AI composed songs ready to post, without touching a single slider. Upload your audio files (MP3, WAV, MP4, AAC, up to 200MB), say something like "generate a full song with instruments from my hummed melody", and download 1080p MP4 when it's done. Built for musicians, content creators, YouTubers who move fast and want to create original music without a full production setup.
