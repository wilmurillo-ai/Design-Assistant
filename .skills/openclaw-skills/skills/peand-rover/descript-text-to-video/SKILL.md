---
name: descript-text-to-video
version: "1.0.0"
displayName: "Descript Text to Video — Convert Scripts into Finished Videos"
description: >
  convert text script into AI-generated videos with this skill. Works with TXT, DOCX, PDF, SRT files up to 50MB. content creators use it for converting written scripts into finished videos — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
