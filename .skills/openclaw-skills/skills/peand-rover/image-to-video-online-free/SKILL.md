---
name: image-to-video-online-free
version: "1.0.0"
displayName: "Image to Video Online Free — Convert Photos into Shareable Videos"
description: >
  Turn three product photos in JPG format into 1080p animated video clips just by typing what you need. Whether it's converting photos into shareable video content or quick social content, drop your still images and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
# Image to Video Online Free — Convert Photos into Shareable Videos
...
User prompts referencing image to video online free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `image-to-video-online-free` |
