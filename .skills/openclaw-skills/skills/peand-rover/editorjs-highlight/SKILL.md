---
name: editorjs-highlight
version: "1.0.0"
displayName: "EditorJS Highlight — Extract and Export Key Moments"
description: >
  Get highlighted video clips ready to post, without touching a single slider. Upload your video clips (MP4, MOV, AVI, WebM, up to 500MB), say something like "detect and highlight the key moments from this video and export a summary clip", and download 1080p MP4 when it's done. Built for content creators who move fast and want to pull the best moments from long recordings without manual scrubbing.
