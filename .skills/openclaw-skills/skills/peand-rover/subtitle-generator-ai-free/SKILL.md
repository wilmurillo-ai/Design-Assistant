...
version: "1.0.0"
displayName: "Subtitle Generator AI Free — Generate and Embed Video Subtitles"
description: >
  Get captioned video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "generate subtitles in English and add them as burned-in captions", and download 1080p MP4 when it's done. Built for YouTubers and content creators who move fast and need accurate captions without paying for transcription services.
...
# Subtitle Generator AI Free — Generate and Embed Video Subtitles
...
User prompts referencing subtitle generator ai free, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `subtitle-generator-ai-free` |
