---
name: online-highlight-editor
version: "1.0.0"
displayName: "Online Highlight Editor — Extract and Export Video Highlights"
description: >
  Skip the learning curve of professional editing software. Describe what you want — extract the best moments and compile them into a 2-minute highlight reel — and get highlight reel clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI highlight extraction automatically. Ideal for sports creators, event videographers, content creators who want to pull key moments from long footage without manual scrubbing.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `online-highlight-editor` |
