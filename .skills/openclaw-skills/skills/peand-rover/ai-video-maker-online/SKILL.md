...
version: "1.0.0"
displayName: "AI Video Maker Online — Create and Export Videos Online"
description: >
  Turn five product photos and a logo file into 1080p finished MP4 videos just by typing what you need. Whether it's generating videos from images or clips without manual editing or quick social content, drop your images or clips and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
# AI Video Maker Online — Create and Export Videos Online
...
Worth noting: using 5-10 images gives the AI enough material to build a natural-feeling video.

## Matching Input to Actions

User prompts referencing ai video maker online, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-maker-online` |
