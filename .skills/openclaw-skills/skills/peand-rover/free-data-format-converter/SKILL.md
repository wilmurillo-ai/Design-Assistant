---
name: free-data-format-converter
version: "1.0.0"
displayName: "Free Data Format Converter — Convert and Export Data Files"
description: >
  convert data files into converted data files with this skill. Works with CSV, JSON, XML, TXT files up to 200MB. developers, analysts, students use it for converting data files between formats without installing software — processing takes 20-40 seconds on cloud GPUs and you get 1080p MP4 files.
