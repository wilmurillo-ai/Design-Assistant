---
name: video-editing-with-gpu
version: "1.0.0"
displayName: "Video Editing with GPU — Edit and Export Videos Fast"
description: >
  Get GPU-rendered MP4 ready to post, without touching a single slider. Upload your raw video footage (MP4, MOV, AVI, MKV, up to 500MB), say something like "cut the slow parts, add transitions, and export in 4K using GPU rendering", and download 4K MP4 when it's done. Built for video creators and editors who move fast and want fast rendering and editing without long export wait times.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-gpu` |
