---
name: simple-video-generator-cartoon
version: "1.0.0"
displayName: "Simple Video Generator Cartoon — Generate Cartoon Videos from Text"
description: >
  generate text or images into animated cartoon videos with this skill. Works with JPG, PNG, MP4, GIF files up to 200MB. educators, content creators, parents use it for creating simple cartoon videos from text prompts or images — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `simple-video-generator-cartoon` |
