...
version: "1.0.0"
displayName: "Video Editing AI Auto — Auto Edit and Export Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — automatically cut dead air, add transitions, and sync to background music — and get auto-edited clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI auto editing automatically. Ideal for content creators and social media marketers who want quick professional edits without learning complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-ai-auto` |
