---
name: erong-agents
description: AI Agent 团队 - 49个专业Agent，8大部门，完整的AI代理机构。支持单Agent使用和多Agent协作编排。
version: 1.1.0
author: erong (based on agency-agents by @msitarzewski)
license: MIT
...
```bash
# 语法
/openclaw skill use erong-agents --agent <agent-name> "<任务描述>"
