...
**Best for:** About pages, company pages. Critical for entity clarity in AI systems.
...
**Best for:** Voice search optimization, AI extraction. Add to WebPage or Article schema.
...
## Combined Schema Example (using @graph)

For a software product page with FAQ and organization info:
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "[Answer with statistics and sources]"
          }
        }
      ]
    },
...
Place at `https://example.com/llms.txt`. Serve as `text/plain; charset=utf-8`.

```markdown
# [Company/Project Name]

> [1-3 sentence summary of what the company/project does, who it serves, and its core value proposition.]
...
- [Important page 1](https://example.com/page1): [Description]
- [Important page 2](https://example.com/page2): [Description]
- [Pricing](https://example.com/pricing): [Description]
- [Documentation](https://example.com/docs): [Description]
```
...
1. **Google Rich Results Test** -- `https://search.google.com/test/rich-results?url={your-url}` (renders JavaScript)
2. **Schema.org Validator** -- `https://validator.schema.org/?url={your-url}`
