...
description: First-time setup flow for tuzi-cover-image preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.tuzi-skills/tuzi-cover-image/EXTEND.md` | Current project |
| User | `~/.tuzi-skills/tuzi-cover-image/EXTEND.md` | All projects |
