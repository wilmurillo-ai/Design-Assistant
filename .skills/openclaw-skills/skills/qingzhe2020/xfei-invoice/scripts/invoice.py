...
Environment variables:
    XFEI_APP_ID      - Required. App ID from https://console.xfyun.cn
    XFEI_API_KEY     - Required. API Key
    XFEI_API_SECRET  - Required. API Secret
...
def main():
    ...
    app_id = os.environ.get("XFEI_APP_ID")
    api_key = os.environ.get("XFEI_API_KEY")
    api_secret = os.environ.get("XFEI_API_SECRET")

    if not all([app_id, api_key, api_secret]):
        missing = []
        if not app_id:
            missing.append("XFEI_APP_ID")
        if not api_key:
            missing.append("XFEI_API_KEY")
        if not api_secret:
            missing.append("XFEI_API_SECRET")
