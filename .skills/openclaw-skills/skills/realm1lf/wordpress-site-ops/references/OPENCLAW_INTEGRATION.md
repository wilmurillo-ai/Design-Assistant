...
Quick reference for how OpenClaw **tools**, **skills**, **plugins**, and **sandbox** interact—aligned with skill **wordpress-site-ops** and plugin **wordpress-site-tools**. Always check official sources if your OpenClaw version differs.
