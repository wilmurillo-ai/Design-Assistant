...
metadata: {"openclaw":{"requires":{"bins":["python3","pip"]},"install":[{"id":"mcp-install","kind":"exec","command":"bash scripts/install-mcp.sh","label":"Install CMDB Compass MCP server"}]}}
---
