...
program
    ...
    .action(async (colors, options) => {
    const spinner = (0, ora_1.default)("Generating design system...").start();
    try {
        const result = await (0, index_1.generateTheme)(colors, options.format);
