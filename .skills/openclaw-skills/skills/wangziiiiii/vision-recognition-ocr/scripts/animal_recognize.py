...
def animal_recognize(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return call_image_classify("animal", data)


if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 animal_recognize.py '<JSON>'")
        sys.exit(1)
    ...
    try:
        result = animal_recognize(payload)
