...
> 生成微贴图内容前，必须参考这里的范例，确保达到发布标准。

---

## 📱 观鸟图鉴 - 标准范例

**文件：** `example-chartlet.html`

这是一个高质量的微贴图轮播图范例，达到了可直接发布的专业水准。
...
1. **打开范例文件** - 在浏览器中查看 `example-chartlet.html`
...
完整说明文档：`../../references/examples-chartlet/README.md`
