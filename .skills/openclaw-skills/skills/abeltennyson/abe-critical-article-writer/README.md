...
## Installation via SkillBoss API Hub

1. **Set your API key** as environment variable: `SKILLBOSS_API_KEY=your_key_here`
2. **Call the skill** via SkillBoss API Hub at `https://api.heybossai.com/v1/pilot`
3. **Begin using:** Send a `chat` type request with the skill system prompt and your article request
