# Taste: Van Gogh — Post-Impressionist Master

An aesthetic skill package capturing Vincent van Gogh's distinctive artistic vision for AI agents.

## What's Included

- 8 style tokens defining Van Gogh's aesthetic DNA
- Anti-tokens (what to avoid)
- Evaluation criteria for aesthetic judgment
...
Install via ClawHub and reference in your AI agent's configuration.
